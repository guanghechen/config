...
4. **Write commit message** following **Conventional Commits** with **Gitmoji** prefix:
   ...
   - **Breaking changes**: Add `!` after type/scope, e.g., `:boom: feat(api)!: change response format`
