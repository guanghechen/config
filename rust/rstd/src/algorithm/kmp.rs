...
mod tests {
    ...
    #[test]
    fn test_find_all_matched_points_basic() {
    ...
    #[test]
    fn test_find_all_handles_empty_pattern() {
    ...
    #[test]
    fn test_find_all_handles_empty_text() {
        let text: Vec<u8> = vec![];
    ...
    #[test]
    fn test_find_first_matched_point() {
    ...
    #[test]
    fn test_calc_fails_produces_prefix_table() {
    ...
    #[test]
    fn test_find_all_handles_utf8_bytes() {
        let text = "Hello, 世界!";
        let pattern = "世界";
