...
# Args:
#   $1 - source_name: original package name (e.g., nvim_tools, rstd)
#   $2 - target_name: target package name for output (e.g., oxi, rstd)
ghc-rust-build() {
  cd $SCRIPT_DIR
...
ghc-rust-build "nvim_tools" "nvim_tools" "$FORCE"
