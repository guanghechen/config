...
# shellcheck source=setup/nix-remote/setup/bot/config.sh
source "$GHC_CONFIG_ROOT/setup/nix-remote/setup/bot/config.sh"
...
# shellcheck source=setup/nix-remote/setup/env/node.sh
source "$GHC_CONFIG_ROOT/setup/nix-remote/setup/env/node.sh"
...
node "$GHC_CONFIG_ROOT/src/setting.mjs" --set-edition=nix-remote
