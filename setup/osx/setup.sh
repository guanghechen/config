...
source "$GHC_CONFIG_ROOT/osx/setup/bot/font-maple.sh"
# source "$GHC_CONFIG_ROOT/osx/setup/bot/font-roboto.sh"
...
if [ -z "$HOME_HOMEBREW" ] || [ -w "$HOME_HOMEBREW/var/homebrew/locks" ]; then
  ...
  source "$GHC_CONFIG_ROOT/osx/setup/bot/homebrew-patch.sh"
