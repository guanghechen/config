...
source "$GHC_CONFIG_ROOT/setup/osx/setup/bot/font-maple.sh"
# source "$GHC_CONFIG_ROOT/setup/osx/setup/bot/font-roboto.sh"
...
if [ -z "$HOME_HOMEBREW" ] || [ -w "$HOME_HOMEBREW/var/homebrew/locks" ]; then
  ...
  source "$GHC_CONFIG_ROOT/setup/nix/setup/bot/homebrew.sh"
  # shellcheck source=setup/osx/setup/bot/homebrew-patch.sh
  source "$GHC_CONFIG_ROOT/setup/osx/setup/bot/homebrew-patch.sh"
...
source "$GHC_CONFIG_ROOT/setup/nix/setup/bot/fish.sh"
...
source "$GHC_CONFIG_ROOT/setup/nix/setup/env/rust.sh"
