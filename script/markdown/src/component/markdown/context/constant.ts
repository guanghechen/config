...
export const astClasses = {
  ...
  blockquote: 'eureka-blockquote',
  break: 'eureka-break',
  code: 'eureka-code',
  delete: 'eureka-delete',
  emphasis: 'eureka-emphasis',
  heading: 'eureka-heading',
  image: 'eureka-image',
  imageReference: 'eureka-imageReference',
  inlineCode: 'eureka-inlineCode',
  inlineMath: 'eureka-inlineMath',
  link: 'eureka-link',
  linkReference: 'eureka-linkReference',
  list: 'eureka-list',
  listItem: 'eureka-listItem',
  math: 'eureka-math',
  paragraph: 'eureka-paragraph',
