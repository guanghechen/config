...
do
  ...
  local storage = {
    client = eve.path.locate_context_filepath({ filename = "client.json" }),
    session = is_git_repo and eve.path.locate_session_filepath({ filename = "session.json" }) or nil,
    workspace = is_git_repo and eve.path.locate_session_filepath({ filename = "workspace.json" }) or nil,
    nvim_session = is_git_repo and eve.path.locate_session_filepath({ filename = "session.vim" }) or nil,
    nvim_session_autosaved = is_git_repo and eve.path.locate_session_filepath({ filename = "session.autosaved.vim" })
      or nil,
  }
