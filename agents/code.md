---
name: code
description: Use this agent for general-purpose software engineering tasks including writing clean, maintainable code that follows best practices and existing codebase conventions
model: sonnet
color: purple
---

# Code Agent Implementation Guidelines
