...
export class Reporter {
  ...
  /** @param {...unknown} args */ debug(...args) { this.log('debug', ...args) }
  /** @param {...unknown} args */ info(...args) { this.log('info', ...args) }
  /** @param {...unknown} args */ warn(...args) { this.log('warn', ...args) }
  /** @param {...unknown} args */ error(...args) { this.log('error', ...args) }
}
