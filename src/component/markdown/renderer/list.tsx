...
export class ListRenderer extends React.Component<List> {
  ...
  public override render(): React.ReactElement {
    ...
    if (ordered) {
      return (
        <ol
          className="yozora-list yozora-list-order list-outside list-decimal p-0 m-0 mb-4 pl-8"
          type={orderType}
          start={start}
        >
    ...
    return (
      <ul className="yozora-list yozora-list-bullet list-outside list-disc p-0 m-0 mb-4 pl-8">
        <NodesRenderer nodes={children} />
      </ul>
    )
  }
