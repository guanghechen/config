...
export const TextAdaptor: React.FC<IProps> = ({ filepath, filepathDirtyTick, storageKeyScope }) => {
  const fileResult = useFileResult<ITextFileData>(filepath, filepathDirtyTick)
