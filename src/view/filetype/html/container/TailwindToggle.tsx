...
export const TailwindToggle: React.FC<IProps> = ({ topbarVisible }) => {
  const viewmodel = useHtmlViewViewModel()
  const tailwindEnabled: boolean = useStateValue(viewmodel.tailwindEnabled$)
  ...
  return (
    ...
    >
      <button
        className={cn(
          'box-border px-3 py-1 transition-all duration-200 rounded-lg focus:outline-none focus:ring-0',
          tailwindEnabled
        ...
        onClick={() => viewmodel.toggleTailwind()}
      >
...
TailwindToggle.displayName = 'HtmlTailwindToggle'
