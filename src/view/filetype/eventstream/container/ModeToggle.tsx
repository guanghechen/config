...
export const ModeToggle: React.FC<IProps> = ({ topbarVisible }) => {
  ...
  return (
    <div
      className={cn(
        'fixed right-4 z-50 flex select-none rounded-lg bg-white/80 text-sm shadow-lg backdrop-blur-sm transition-all hover:bg-white/90 dark:bg-gray-900/80 dark:hover:bg-gray-900/90',
