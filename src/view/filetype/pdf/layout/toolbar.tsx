...
export const Toolbar: React.FC = () => {
  ...
  return (
    <div className="fixed left-1/2 top-0 z-50 -translate-x-1/2 w-max">
      <div className="flex flex-row items-center gap-3 rounded-lg border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800 px-4 py-1 transform -translate-x-1/2">
