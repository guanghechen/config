...
export const Sidebar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute right-[-8px] top-0 box-content h-full w-[1px] cursor-col-resize border-8 border-solid border-transparent bg-clip-content hover:bg-blue-500 hover:opacity-50"
