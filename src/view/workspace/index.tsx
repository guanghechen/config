...
export const WorkspaceContaienr: React.FC = () => {
  ...
  return (
    <div className="width-screen relative box-border flex min-h-screen bg-gray-50 font-['Maple_Mono_NF_CN','Roboto_Mono',monospace,sans-serif] text-gray-800 shadow-md transition-colors duration-300 ease-in-out dark:bg-gray-900 dark:text-gray-200 [&::-webkit-scrollbar-thumb]:rounded [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:hover:bg-gray-400 dark:[&::-webkit-scrollbar-thumb]:bg-gray-600 dark:[&::-webkit-scrollbar-thumb]:hover:bg-gray-500 [&::-webkit-scrollbar-track]:bg-gray-50 dark:[&::-webkit-scrollbar-track]:bg-gray-900 [&::-webkit-scrollbar]:w-2">
      ...
      <div className="relative box-border flex h-screen flex-auto flex-col">
        <div className="box-border h-11 flex-initial flex-shrink-0 border-b border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-900">
          <Topbar />
        </div>
        <div className={cn('box-border h-full flex-auto overflow-auto', PRESET_CLASSES.scrollbar)}>
