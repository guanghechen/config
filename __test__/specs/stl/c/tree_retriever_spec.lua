--- Run with: nvim -l __test__/run.lua __test__/specs/stl/c/tree_retriever_spec.lua
...
t:test("attach: switches between flat maps and TreeLayout", function()
  ...
  retriever:attach({ "a", "b" }, { a = 1, b = 2 }, { 2, 2 })
  ...
  retriever:attach_layout(layout, { [1] = 2 })
