--- Run with: nvim -l __test__/run.lua __test__/specs/era/m/plugin/loader_spec.lua
...
t:test("a main require failure restores its cache before a later explicit load", function()
  local module_name = "__test__.specs.era.m.plugin.loader.retry_main"
  local attempts = 0
  local setup_runs = 0
...
t:test("a config require failure restores the primary module cache", function()
  local module_name = "__test__.specs.era.m.plugin.loader.retry_config_main"
