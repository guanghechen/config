--- Run with: nvim -l __test__/run.lua __test__/specs/era/m/lsp/init_spec.lua
...
local t = harness.new("era.m.lsp.init")
...
t:test("dressing: enables LSPs for existing and future buffers without re-editing", function()
  ...
  t.assert_eq(1, enabled.biome, "future TypeScript Biome LSP")
  ---@diagnostic disable-next-line: undefined-field
