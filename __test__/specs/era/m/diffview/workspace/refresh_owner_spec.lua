--- Run with: nvim -l __test__/run.lua __test__/specs/era/m/diffview/workspace/refresh_owner_spec.lua
...
local t = harness.new("era.m.diffview.workspace.refresh_owner")
