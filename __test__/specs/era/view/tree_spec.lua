--- Run with: nvim -l __test__/run.lua __test__/specs/era/view/tree_spec.lua
...
---@class __test__.specs.era.view.tree.INodeSpec
---@field public uuid string
---@field public parent? string
---@field public data? table
---@field public state era.view.tree.INodeState

---@param specs __test__.specs.era.view.tree.INodeSpec[]
---@return stl.c.Tree
...
t:test("render: folds depth 10000 without Lua recursion", function()
  local specs = {} ---@type __test__.specs.era.view.tree.INodeSpec[]
...
t:test("render: 5000-node time and heap regression ceiling", function()
  local specs = { { uuid = "root", state = new_state("container") } } ---@type __test__.specs.era.view.tree.INodeSpec[]
  for index = 1, 5000 do
