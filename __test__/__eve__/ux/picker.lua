...
require("plenary.reload").reload_module("eve.ux.picker.composer.tree")
require("plenary.reload").reload_module("eve.ux.picker.retriever.tree")
require("plenary.reload").reload_module("eve.ux.picker.view.tree")
