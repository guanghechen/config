...
fn t_replace_text_preview_advance_2() {
    // Spell out the whitespace-only line so formatters preserve the fixture.
    let text: &str = concat!(
        r#"
### Requirements
...
"#,
        "  \n",
        r#"  https://doc.rust-lang.org/book/ch01-01-installation.html#installing-rustup-on-linux-or-macos
