...
abbr -a cc0 'ANTHROPIC_API_KEY='' ANTHROPIC_BASE_URL="$GHC_ANTHROPIC_BASE_URL" ANTHROPIC_AUTH_TOKEN="$GHC_ANTHROPIC_AUTH_TOKEN" ANTHROPIC_MODEL="claude-opus-4.6-fast" ANTHROPIC_SMALL_FAST_MODEL="claude-sonnet-4.5" claude --dangerously-skip-permissions'
