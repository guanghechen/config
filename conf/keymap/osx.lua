...
function M.setup(config)
	...
	table.insert(keys, { key = "J", mods = "CMD|CTRL|SHIFT", action = act.SplitPane({ direction = "Down", command = { cwd = wezterm.home_dir } }) })
	table.insert(keys, { key = "L", mods = "CMD|CTRL|SHIFT", action = act.SplitPane({ direction = "Right", command = { cwd = wezterm.home_dir } }) })
