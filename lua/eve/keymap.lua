...
--#[g]it--------------------------------------------------------------------------------------------
mk({ "i", "n", "t", "v" }, "<C-a>g", uuids.lazygit_cwd)
mk({ "i", "n", "t", "v" }, "<M-g>", uuids.lazygit_cwd)
mk({ "n", "v" }, "<leader>gf", uuids.git_file_history)
mk({ "n", "v" }, "<leader>gg", uuids.git_diffview)
--------------------------------------------------------------------------------------------#[g]it--
--
--#[q]uit-------------------------------------------------------------------------------------------
mk({ "n", "v" }, "<leader>qq", "<cmd>qa<cr>", "quit: quit all")
mk({ "n", "v" }, "<leader>ql", uuids.session_restore)
mk({ "n", "v" }, "<leader>qs", uuids.session_save)
-------------------------------------------------------------------------------------------#[q]uit--
...
--#[t]erminal---------------------------------------------------------------------------------------
mk({ "i", "n", "t", "v" }, "<C-a>t", uuids.term_cwd)
mk({ "i", "n", "t", "v" }, "<M-t>", uuids.term_cwd)
mk({ "n", "t" }, "<leader>tT", uuids.term_workspace)
mk({ "n", "t" }, "<leader>tt", uuids.term_cwd)
---------------------------------------------------------------------------------------#[t]erminal--
