...
function M.gen_hlgroup_map(context)
  ...
  return {
    ...
    ---hipairs
    f_hipairs_1 = { fg = c.purple, bg = c.bg4, bold = true, italic = true },
    f_hipairs_2 = { fg = c.blue, bg = c.bg4, bold = true, italic = true },
    f_hipairs_3 = { fg = c.yellow, bg = c.bg4, bold = true, italic = true },
    f_hipairs_4 = { fg = c.orange, bg = c.bg4, bold = true, italic = true },
    f_hipairs_5 = { fg = c.aqua, bg = c.bg4, bold = true, italic = true },
    f_hipairs_6 = { fg = c.red, bg = c.bg4, bold = true, italic = true },
    f_hipairs_7 = { fg = c.green, bg = c.bg4, bold = true, italic = true },
    f_matched_pairs_0 = { fg = c.green, bg = c.bg4, bold = true, italic = true },
    f_matched_pairs_1 = { fg = cs.mix(c.bg0, c.purple, 80) },
    f_matched_pairs_2 = { fg = cs.mix(c.bg0, c.blue, 80) },
    f_matched_pairs_3 = { fg = cs.mix(c.bg0, c.yellow, 80) },
    f_matched_pairs_4 = { fg = cs.mix(c.bg0, c.orange, 80) },
    f_matched_pairs_5 = { fg = cs.mix(c.bg0, c.aqua, 80) },
