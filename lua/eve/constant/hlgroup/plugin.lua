...
function M.gen_hlgroup_map(context)
  ...
  return {
    ...
    AvanteStateSpinnerCompacting = { fg = c.bg0, bg = c.purple },
    AvanteStateSpinnerFailed = { fg = c.bg0, bg = c.red },
    AvanteStateSpinnerGenerating = { fg = c.bg0, bg = c.purple },
    AvanteStateSpinnerSearching = { fg = c.bg0, bg = c.purple },
    AvanteStateSpinnerSucceeded = { fg = c.bg0, bg = c.green },
    AvanteStateSpinnerThinking = { fg = c.bg0, bg = c.purple },
    AvanteStateSpinnerToolCalling = { fg = c.bg0, bg = c.blue },
