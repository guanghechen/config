...
function M.gen_hlgroup_map(context)
  ...
  local hlgroup_map = {
    ...
    dir_path_focus_text = { fg = c.blue, bg = "bg_bar", bold = true },
    ...
    lsp_diagnostics_error = { fg = c.red, bg = "bg_bar" },
    lsp_diagnostics_warn = { fg = c.yellow, bg = "bg_bar" },
    lsp_diagnostics_hint = { fg = c.purple, bg = "bg_bar" },
    lsp_diagnostics_info = { fg = c.green, bg = "bg_bar" },
    lsp_symbol_icon = { fg = c.brightPurple, bg = "bg_bar" },
    lsp_symbol_icon_Array = { fg = c.blue, bg = "bg_bar" },
    lsp_symbol_icon_Boolean = { fg = c.orange, bg = "bg_bar" },
    lsp_symbol_icon_Class = { fg = c.brightAqua, bg = "bg_bar" },
    lsp_symbol_icon_Color = { fg = c.fg1, bg = "bg_bar" },
    lsp_symbol_icon_Constant = { fg = c.orange, bg = "bg_bar" },
    lsp_symbol_icon_Constructor = { fg = c.blue, bg = "bg_bar" },
    lsp_symbol_icon_Enum = { fg = c.blue, bg = "bg_bar" },
    lsp_symbol_icon_EnumMember = { fg = c.brightPurple, bg = "bg_bar" },
    lsp_symbol_icon_Event = { fg = c.yellow, bg = "bg_bar" },
    lsp_symbol_icon_Field = { fg = c.red, bg = "bg_bar" },
    lsp_symbol_icon_File = { fg = c.fg1, bg = "bg_bar" },
    lsp_symbol_icon_Folder = { fg = c.fg1, bg = "bg_bar" },
    lsp_symbol_icon_Function = { fg = c.blue, bg = "bg_bar" },
    lsp_symbol_icon_Identifier = { fg = c.red, bg = "bg_bar" },
    lsp_symbol_icon_Interface = { fg = c.green, bg = "bg_bar" },
    lsp_symbol_icon_Key = { fg = c.red, bg = "bg_bar" },
    lsp_symbol_icon_Keyword = { fg = c.fg1, bg = "bg_bar" },
    lsp_symbol_icon_Method = { fg = c.blue, bg = "bg_bar" },
    lsp_symbol_icon_Module = { fg = c.yellow, bg = "bg_bar" },
    lsp_symbol_icon_Namespace = { fg = c.brightAqua, bg = "bg_bar" },
    lsp_symbol_icon_Null = { fg = c.aqua, bg = "bg_bar" },
    lsp_symbol_icon_Number = { fg = c.orange, bg = "bg_bar" },
    lsp_symbol_icon_Object = { fg = c.brightPurple, bg = "bg_bar" },
    lsp_symbol_icon_Operator = { fg = c.fg1, bg = "bg_bar" },
    lsp_symbol_icon_Package = { fg = c.green, bg = "bg_bar" },
    lsp_symbol_icon_Property = { fg = c.red, bg = "bg_bar" },
    lsp_symbol_icon_Reference = { fg = c.fg1, bg = "bg_bar" },
    lsp_symbol_icon_Snippet = { fg = c.red, bg = "bg_bar" },
    lsp_symbol_icon_String = { fg = c.green, bg = "bg_bar" },
    lsp_symbol_icon_Struct = { fg = c.brightPurple, bg = "bg_bar" },
    lsp_symbol_icon_Structure = { fg = c.brightPurple, bg = "bg_bar" },
    lsp_symbol_icon_Text = { fg = c.green, bg = "bg_bar" },
    lsp_symbol_icon_Type = { fg = c.yellow, bg = "bg_bar" },
    lsp_symbol_icon_TypeParameter = { fg = c.red, bg = "bg_bar" },
    lsp_symbol_icon_Unit = { fg = c.brightPurple, bg = "bg_bar" },
    lsp_symbol_icon_Value = { fg = c.aqua, bg = "bg_bar" },
    lsp_symbol_icon_Variable = { fg = c.brightPurple, bg = "bg_bar" },
    lsp_symbol_sep = { fg = c.fg3, bg = "bg_bar" },
    lsp_symbol_text = { fg = c.fg3, bg = "bg_bar" },
