...
function M.gen_hlgroup_map(context)
  ...
  local hlgroup_map = {
    ...
    DiffAdd = { bg = cs.mix(bg, c.green, 30) },
    DiffChange = { bg = cs.mix(bg, c.green, 30) },
    DiffDelete = { bg = cs.mix(bg, c.red, 30) },
    DiffText = { bg = cs.mix(bg, c.green, 60) },
    DiffAdded = { bg = cs.mix(bg, c.green, 30) },
    DiffRemoved = { bg = cs.mix(bg, c.red, 30) },
    DiffChanged = { bg = cs.mix(bg, c.green, 30) },
    DiffFile = { fg = c.peach },
