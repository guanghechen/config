...
function M.gen_hlgroup_map(context)
  ...
  return {
    ...
    ["@lsp.type.keyword.lua"] = { fg = c.mauve },
    ...
    ["@lsp.typemod.property.readonly"] = { fg = c.text, italic = true },
    ...
    ["@lsp.typemod.variable.readonly"] = { fg = c.text, italic = true },
    ["@lsp.typemod.variable.readonly.typescriptreact"] = { fg = c.text, italic = true },
    ["@lsp.typemod.variable.static"] = { fg = c.text, italic = true },
  }
end
