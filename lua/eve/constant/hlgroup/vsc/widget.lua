...
function M.gen_hlgroup_map(context)
  ...
  return {
    ...
    f_ft_text = { fg = c.fg4 },
    f_ft_git_add = { fg = c.brightGreen, bold = true },
    f_ft_git_change = { fg = c.brightYellow, bold = true },
    f_ft_git_delete = { fg = c.brightRed, bold = true },
    f_ft_git_rename = { fg = c.brightBlue, bold = true },
    ...
    f_un_winbar_trace       = { fg = c.fg2,     bg = c.bg0, sp = c.bg2,    bold = true, underline = true },
    f_un_winbar_debug       = { fg = c.green,   bg = c.bg0, sp = c.green,  bold = true, underline = true },
    f_un_winbar_info        = { fg = c.blue,    bg = c.bg0, sp = c.blue,   bold = true, underline = true },
    f_un_winbar_warn        = { fg = c.yellow,  bg = c.bg0, sp = c.yellow, bold = true, underline = true },
    f_un_winbar_error       = { fg = c.red,     bg = c.bg0, sp = c.red,    bold = true, underline = true },
    f_un_winbar_like_trace  = { fg = c.fg2,     bg = c.bg0, sp = c.bg2,    bold = true },
    f_un_winbar_like_debug  = { fg = c.green,   bg = c.bg0, sp = c.green,  bold = true },
    f_un_winbar_like_info   = { fg = c.blue,    bg = c.bg0, sp = c.blue,   bold = true },
    f_un_winbar_like_warn   = { fg = c.yellow,  bg = c.bg0, sp = c.yellow, bold = true },
    f_un_winbar_like_error  = { fg = c.red,     bg = c.bg0, sp = c.red,    bold = true },
    -- stylua: ignore end

    ---render-markdown
    f_md_bullet = { fg = c.textDim },
    f_md_callout_error = { fg = c.accentRed, bold = true },
    f_md_callout_hint = { fg = c.accentAqua },
    f_md_callout_info = { fg = c.accentBlue },
    f_md_callout_progress = { fg = c.accentPurple, bold = true },
    f_md_callout_quote = { fg = c.text, bg = std.color.mix(c.base, c.list_dropBackground, 60) },
    f_md_callout_success = { fg = c.success, bold = true },
    f_md_callout_warn = { fg = c.accentYellow, bold = true },
    f_md_code = { bg = t and c.none or c.editorWidget_background },
    f_md_code_border = { fg = c.accentAqua, bg = t and c.none or c.editorWidget_background },
    f_md_code_fallback = { fg = c.textDim },
    f_md_code_header = { fg = c.accentPurple, bg = t and c.none or c.editorWidget_background },
    f_md_code_inline = { fg = c.accentOrange, bg = t and c.none or c.editor_selectionHighlightBackground },
    f_md_dash = { fg = c.accentOrange },
    f_md_heading_h1 = { fg = c.accentPurple, bold = true },
    f_md_heading_h1_bg = { bg = t and c.none or std.color.mix(c.base, c.accentPurple, 15) },
    f_md_heading_h2 = { fg = c.accentAqua, bold = true },
    f_md_heading_h2_bg = { bg = t and c.none or std.color.mix(c.base, c.accentAqua, 15) },
    f_md_heading_h3 = { fg = c.accentOrange, bold = true },
    f_md_heading_h3_bg = { bg = t and c.none or std.color.mix(c.base, c.accentOrange, 15) },
    f_md_heading_h4 = { fg = c.accentYellow, bold = true },
    f_md_heading_h4_bg = { bg = t and c.none or std.color.mix(c.base, c.accentYellow, 15) },
    f_md_heading_h5 = { fg = c.accentBlue, bold = true },
    f_md_heading_h5_bg = { bg = t and c.none or std.color.mix(c.base, c.accentBlue, 15) },
    f_md_heading_h6 = { fg = c.success, bold = true },
    f_md_heading_h6_bg = { bg = t and c.none or std.color.mix(c.base, c.success, 15) },
    f_md_link = { fg = c.accentAqua, underline = true },
    f_md_link_wiki = { fg = c.accentAqua, italic = true },
    f_md_quote = { fg = c.text, bg = t and c.none or std.color.mix(c.base, c.list_dropBackground, 60) },
    f_md_table_filler = { link = "Conceal" },
    f_md_table_head = { fg = c.accentPurple, bold = true },
    f_md_table_row = { fg = c.accentOrange },
    f_md_task_open = { fg = c.textDim },
    f_md_task_done = { fg = c.success, bold = true },
    f_md_task_question = { fg = c.accentRed, bold = true },
    f_md_task_next = { fg = c.accentBlue, bold = true },
    f_md_task_cancelled = { fg = c.textMuted, italic = true },
    f_md_task_cancelled_text = { fg = c.textMuted, italic = true, strikethrough = true },
    f_md_task_important = { fg = c.accentPurple, bold = true },
    f_md_task_favorite = { fg = cs.mix(c.accentYellow, c.accentOrange, 60), bold = true },
    f_md_text_inline_highlight = {
      fg = c.base,
      bg = t and c.none or std.color.mix(c.base, c.accentYellow, 45),
    },
