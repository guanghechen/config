...
function M.gen_hlgroup_map(context)
  ...
  local hlgroup_map = {
    ...
    DiagnosticVirtualTextHint = { fg = c.hint, bg = diag_bg(c.hint) },
    DiagnosticVirtualTextInfo = { fg = c.info, bg = diag_bg(c.info) },
    ...
    FloatBorder = { fg = c.border_highlight, bg = t and c.none or c.bg_dark },
    ...
    LspInlayHint = { fg = c.dark3, bg = t and c.none or cs.mix(c.bg, c.blue7, 10) },
    ...
    StatusLine = { fg = c.fg_sidebar, bg = t and c.none or c.bg_dark },
    StatusLineNC = { fg = c.fg_gutter, bg = t and c.none or c.bg_dark },
    StorageClass = { fg = c.cyan },
    String = { fg = c.green },
    Structure = { fg = c.blue1 },
    Substitute = { bg = c.red, fg = c.black },
    TabLine = { bg = c.bg_dark, fg = c.fg_gutter },
    TabLineFill = { bg = t and c.none or c.black },
    ...
    VertSplit = { fg = t and c.fg_gutter or c.black },
    ...
    WinSeparator = { fg = t and c.fg_gutter or c.black },
  }
