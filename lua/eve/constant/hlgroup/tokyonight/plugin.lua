...
function M.gen_hlgroup_map(context)
  ...
  local hlgroup_map = {
    ...
    RenderMarkdownCode = { bg = t and c.none or c.bg_dark },
    RenderMarkdownCodeBorder = { fg = c.cyan, bg = t and c.none or c.bg_dark },
    RenderMarkdownCodeFallback = { fg = c.dark5 },
    RenderMarkdownCodeInfo = { fg = c.purple, bg = t and c.none or c.bg_dark },
    ...
    RenderMarkdownH1Bg = { bg = cs.mix(c.bg, c.blue, 10) },
    RenderMarkdownH1Fg = { fg = c.blue, bold = true },
    RenderMarkdownH2 = { fg = c.yellow, bold = true },
    RenderMarkdownH2Bg = { bg = cs.mix(c.bg, c.yellow, 10) },
    RenderMarkdownH2Fg = { fg = c.yellow, bold = true },
    RenderMarkdownH3 = { fg = c.green, bold = true },
    RenderMarkdownH3Bg = { bg = cs.mix(c.bg, c.green, 10) },
    RenderMarkdownH3Fg = { fg = c.green, bold = true },
    RenderMarkdownH4 = { fg = c.teal, bold = true },
    RenderMarkdownH4Bg = { bg = cs.mix(c.bg, c.teal, 10) },
    RenderMarkdownH4Fg = { fg = c.teal, bold = true },
    RenderMarkdownH5 = { fg = c.cyan, bold = true },
    RenderMarkdownH5Bg = { bg = cs.mix(c.bg, c.cyan, 10) },
    RenderMarkdownH5Fg = { fg = c.cyan, bold = true },
    RenderMarkdownH6 = { fg = c.magenta, bold = true },
    RenderMarkdownH6Bg = { bg = cs.mix(c.bg, c.magenta, 10) },
    RenderMarkdownH6Fg = { fg = c.magenta, bold = true },
    ...
    RenderMarkdownQuote = { fg = c.fg, bg = t and c.none or c.bg_dark },
    ...
    RenderMarkdownWikiLink = { fg = c.cyan, italic = true },
