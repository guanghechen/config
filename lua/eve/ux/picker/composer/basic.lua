...
---@field public render_result          eve.ux.picker.result.IDraw
---
...
function M.new(props)
  local uuid = props.uuid or rstd.fn.uuid() ---@type string
  ...
  local render_result = props.render_result ---@type eve.ux.picker.result.IDraw
