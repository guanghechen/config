local __module_name__ = "eve.ux.widget.ai.state" ---@type string

local config = require("eve.ux.widget.ai.config")

---@class eve.ux.widget.ai.state
local M = {}

---@type eve.ux.widget.ai.IAttachedSource[]
...
---@return eve.ux.widget.ai.IAttachedSource[]
...
function M.detach(source_id, close_terminal)
  local new_sources = {} ---@type eve.ux.widget.ai.IAttachedSource[]
  local detached_source ---@type eve.ux.widget.ai.IAttachedSource|nil
