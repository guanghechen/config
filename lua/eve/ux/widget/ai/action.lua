local __module_name__ = "eve.ux.widget.ai.action" ---@type string

local config = require("eve.ux.widget.ai.config")
local state = require("eve.ux.widget.ai.state")
local term = require("eve.ux.widget.ai.term")
local tmux = require("eve.ux.widget.ai.tmux")

---@class eve.ux.widget.ai.action
local M = {}
...
---@param item                          eve.ux.widget.ai.ISelectItem
---@return nil
...
---@param source                        eve.ux.widget.ai.IAttachedSource
---@param text                          string
---@param submit                        boolean
---@return boolean
...
---@protected
---@param sources                       eve.ux.widget.ai.IAttachedSource[]
---@param text                          string
---@param submit                        boolean
---@return nil
