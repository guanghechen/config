local __module_name__ = "eve.ux.widget.ai.tmux" ---@type string

local config = require("eve.ux.widget.ai.config")
local proc = require("eve.ux.widget.ai.proc")

---@class eve.ux.widget.ai.tmux
local M = {}
...
---@param line                          string
---@return eve.ux.widget.ai.ITmuxPaneInfo|nil
...
---@param tool_config                   eve.ux.widget.ai.IToolConfig
---@param cwd                           string
---@return string
...
---@class eve.ux.widget.ai.ITmuxCurrentInfo
---@field public session_name           string
---@field public window_name            string

---@return eve.ux.widget.ai.ITmuxCurrentInfo|nil
...
---@param agent                         eve.ux.widget.ai.AgentName
---@param cwd                           string
---@return string
...
---@return eve.ux.widget.ai.ITmuxPaneInfo[]
function M.list_panes()
  ...
  local panes = {} ---@type eve.ux.widget.ai.ITmuxPaneInfo[]
...
---@return eve.ux.widget.ai.ISource[]
function M.find_running_agents()
  ...
  local sources = {} ---@type eve.ux.widget.ai.ISource[]
...
function M.send_text(pane_id, text)
  local buffer_name = "eve-ai-" .. pane_id
