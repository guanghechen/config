---@class eve.ux.widget.ai.prompt.ICtx
...
---@param lines                         eve.ux.widget.ai.IText
---@return string
...
---@param lines                         string[]
---@param hlname                        ?string
---@return eve.ux.widget.ai.IText
local function plain_lines(lines, hlname)
  local result = {} ---@type eve.ux.widget.ai.IText
  for _, line in ipairs(lines) do
...
local function get_highlighted_lines(bufnr, start_row, end_row)
  ...
  for i, line in ipairs(lines) do
    ...
    local text_line = {} ---@type eve.ux.widget.ai.ITextLine
    local from = 0
...
---@return eve.ux.widget.ai.prompt.ICtx
function M.get_ctx()
  ...
  local start_lnum, start_col, end_lnum, end_col = eve.buf.retrieve_visual_range()
...
---@param ctx                           eve.ux.widget.ai.prompt.ICtx
---@return eve.ux.widget.ai.ITextLine|nil, string|nil
local function get_selection_line(ctx)
  ...
  ---@type eve.ux.widget.ai.ITextLine
  local line = {
    { "@", "f_us_ai_loc_delim" },
...
---@param ctx                           eve.ux.widget.ai.prompt.ICtx
---@return eve.ux.widget.ai.IText|nil, string|nil
...
local function get_diagnostics_lines(ctx)
  ...
  local lines = {} ---@type eve.ux.widget.ai.IText
