...
---@class eve.ux.widget.ai.proc
local M = {}

local have_ps = vim.fn.has("win32") == 0 and vim.fn.executable("ps") == 1

---@class eve.ux.widget.ai.IProcs
---@field protected _procs              table<integer, eve.ux.widget.ai.IProc>
---@field protected _children           table<integer, integer[]>
local Procs = {}
Procs.__index = Procs

---@return eve.ux.widget.ai.IProcs
function Procs.new()
...
---@param pid                           integer
---@return eve.ux.widget.ai.IProc|nil
function Procs:get(pid)
  return self._procs[pid]
end

---@param pid                           integer
---@param callback                      fun(proc: eve.ux.widget.ai.IProc): boolean|nil
---@return nil
...
---@param proc                          eve.ux.widget.ai.IProc
...
---@param procs                         eve.ux.widget.ai.IProcs
---@param pid                           integer
---@param agent                         eve.ux.widget.ai.AgentName
---@return boolean
...
---@param procs                         eve.ux.widget.ai.IProcs
---@param pid                           integer
---@return eve.ux.widget.ai.AgentName|nil
function M.detect_agent(procs, pid)
  local detected = nil ---@type eve.ux.widget.ai.AgentName|nil
  procs:walk(pid, function(proc)
