local __module_name__ = "eve.ux.search2.retriever.tree" ---@type string

---@class eve.ux.search2.ITreeRetrieverProps
---@field public name                   string

---@class eve.ux.search2.TreeRetriever
...
---@param props eve.ux.search2.ITreeRetrieverProps
---@return eve.ux.search2.TreeRetriever
