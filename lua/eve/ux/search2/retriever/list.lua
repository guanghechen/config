local __module_name__ = "eve.ux.search2.retriever.list" ---@type string

---@class eve.ux.search2.IListRetrieverProps
---@field public name                   string

---@class eve.ux.search2.ListRetriever
...
---@param props eve.ux.search2.IListRetrieverProps
---@return eve.ux.search2.ListRetriever
