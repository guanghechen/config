...
local __module_name__ = "eve.ux.search2.composer.tree" ---@type string

---@alias eve.ux.search2.composer.tree.IOnAttached
---| fun(self: eve.ux.search2.TreeComposer, rootuuid: string): nil

---@alias eve.ux.search2.composer.tree.IOnClosed
---| fun(self: eve.ux.search2.TreeComposer): nil

---@alias eve.ux.search2.composer.tree.IOnConfirm
---| fun(self: eve.ux.search2.TreeComposer, uuids: string[]|nil): nil

---@alias eve.ux.search2.composer.tree.IOnDisposed
---| fun(): nil

---@alias eve.ux.search2.composer.tree.IOnFocused
---| fun(self: eve.ux.search2.TreeComposer): nil

---@alias eve.ux.search2.composer.tree.IOnHidden
---| fun(self: eve.ux.search2.TreeComposer): nil
---
---@alias eve.ux.search2.composer.tree.IOnRefresh
---| fun(self: eve.ux.search2.TreeComposer, force: boolean): nil

---@class eve.ux.search2.composer.tree.actions
...
---@class eve.ux.search2.ITreeComposerProps
...
---
---@field public render_preview             ?eve.ux.search2.preview.IDraw
...
---
---@field public on_attached            ?eve.ux.search2.composer.tree.IOnAttached
---@field public on_closed              ?eve.ux.search2.composer.tree.IOnClosed
---@field public on_confirm             ?eve.ux.search2.composer.tree.IOnConfirm
---@field public on_disposed            ?eve.ux.search2.composer.tree.IOnDisposed
---@field public on_focused             ?eve.ux.search2.composer.tree.IOnFocused
---@field public on_hidden              ?eve.ux.search2.composer.tree.IOnHidden
---@field public on_refresh             ?eve.ux.search2.composer.tree.IOnRefresh

---@class eve.ux.search2.TreeComposer
---@field public uuid                   string
...
---
---@field protected _on_attached        eve.ux.search2.composer.tree.IOnAttached
---@field protected _on_confirm         eve.ux.search2.composer.tree.IOnConfirm
---@field protected _on_disposed        eve.ux.search2.composer.tree.IOnDisposed
local M = {}
M.__index = M

---@param props                         eve.ux.search2.ITreeComposerProps
---@return eve.ux.search2.TreeComposer
function M.new(props)
  ...
  local render_preview = props.render_preview ---@type eve.ux.search2.preview.IDraw|nil
  ...
  local on_attached = props.on_attached or std.fn.noop ---@type eve.ux.search2.composer.tree.IOnAttached
  local on_closed = props.on_closed or std.fn.noop ---@type eve.ux.search2.composer.tree.IOnClosed
  local on_confirm = props.on_confirm or std.fn.noop ---@type eve.ux.search2.composer.tree.IOnConfirm
  local on_disposed = props.on_disposed or std.fn.noop ---@type eve.ux.search2.composer.tree.IOnDisposed
  local on_focused = props.on_focused or std.fn.noop ---@type eve.ux.search2.composer.tree.IOnFocused
  local on_hidden = props.on_hidden or std.fn.noop ---@type eve.ux.search2.composer.tree.IOnHidden
  local on_refresh = props.on_refresh or std.fn.noop ---@type eve.ux.search2.composer.tree.IOnRefresh
  ...
  ---@type eve.ux.search2.composer.tree.actions
  local actions = {
...
function M:dispose()
  ...
  local on_dispose = self._on_disposed ---@type eve.ux.search2.composer.tree.IOnDisposed
