...
local __module_name__ = "eve.ux.search2.composer.list" ---@type string

---@alias eve.ux.search2.composer.list.IOnCancel
---| fun(self: eve.ux.search2.ListComposer): nil

---@alias eve.ux.search2.composer.list.IOnClosed
---| fun(self: eve.ux.search2.ListComposer): nil

---@alias eve.ux.search2.composer.list.IOnConfirm
---| fun(self: eve.ux.search2.ListComposer, item: eve.ux.search2.composer.list.IItem|nil): nil

---@alias eve.ux.search2.composer.list.IOnDisposed
---| fun(): nil

---@alias eve.ux.search2.composer.list.IOnFocused
---| fun(self: eve.ux.search2.ListComposer): nil

---@alias eve.ux.search2.composer.list.IOnHidden
---| fun(self: eve.ux.search2.ListComposer): nil

---@alias eve.ux.search2.composer.list.IOnRefresh
---| fun(self: eve.ux.search2.ListComposer, force: boolean): nil

---@alias eve.ux.search2.composer.list.IPreviewRender
---| fun(self: eve.ux.search2.ListComposer, bufnr: integer, force: boolean): eve.ux.search2.preview.IDrawResult

---@alias eve.ux.search2.composer.list.IResultRender
---| fun(self: eve.ux.search2.ListComposer, bufnr: integer, itemmap: table<string, eve.ux.search2.composer.list.IItem>, matches: std.t.IScoredMatch[]): eve.ux.search2.composer.list.IResultRenderData

---@class eve.ux.search2.composer.list.IItem
---@field public uuid                   string
---@field public text                   string
---@field public text_lower             string
---@field public highlights             std.t.IHighlightInline[]

---@class eve.ux.search2.composer.list.IResetData
---@field public items                  eve.ux.search2.composer.list.IItem[]
---@field public uuid_present           string|nil
---@field public uuid_current           string|nil

---@class eve.ux.search2.composer.list.IResultRenderData
---@field public uuids                  string[]

----------------------------------------------------------------------------------------------------

---@class eve.ux.search2.IListComposerProps
---@field public uuid                   ?string
...
---
---@field public result_render          ?eve.ux.search2.composer.list.IResultRender
---@field public preview_render         ?eve.ux.search2.composer.list.IPreviewRender
---
---@field public on_cancel              ?eve.ux.search2.composer.list.IOnCancel
---@field public on_closed              ?eve.ux.search2.composer.list.IOnClosed
---@field public on_confirm             ?eve.ux.search2.composer.list.IOnConfirm
---@field public on_disposed            ?eve.ux.search2.composer.list.IOnDisposed
---@field public on_focused             ?eve.ux.search2.composer.list.IOnFocused
---@field public on_hidden              ?eve.ux.search2.composer.list.IOnHidden
---@field public on_refresh             ?eve.ux.search2.composer.list.IOnRefresh

---@class eve.ux.search2.ListComposer
---@field public uuid                   string
...
---@field protected _retriever          eve.ux.search2.ListRetriever
---@field protected _scheduler_match    std.collection.Scheduler
---
---@field protected _autosort           boolean
---@field protected _items              eve.ux.search2.composer.list.IItem[]
---@field protected _itemmap            table<string, eve.ux.search2.composer.list.IItem>
...
---
---@field protected _on_confirm         eve.ux.search2.composer.list.IOnConfirm|nil
---@field protected _on_disposed        eve.ux.search2.composer.list.IOnDisposed
local M = {}
M.__index = M

---@param props                         eve.ux.search2.IListComposerProps
---@return eve.ux.search2.ListComposer
function M.new(props)
  ...
  local on_cancel = props.on_cancel or std.fn.noop ---@type eve.ux.search2.composer.list.IOnCancel
  local on_closed = props.on_closed or std.fn.noop ---@type eve.ux.search2.composer.list.IOnClosed
  local on_confirm = props.on_confirm ---@type eve.ux.search2.composer.list.IOnConfirm|nil
  local on_disposed = props.on_disposed or std.fn.noop ---@type eve.ux.search2.composer.list.IOnDisposed
  local on_focused = props.on_focused or std.fn.noop ---@type eve.ux.search2.composer.list.IOnFocused
  local on_hidden = props.on_hidden or std.fn.noop ---@type eve.ux.search2.composer.list.IOnHidden
  local on_refresh = props.on_refresh or std.fn.noop ---@type eve.ux.search2.composer.list.IOnRefresh

  ---@type eve.ux.search2.composer.list.IResultRender
  local result_render = props.result_render
    or function(_, bufnr, itemmap, matches)
      ...
      for _, match in ipairs(matches) do
        local item = itemmap[match.uuid] ---@type eve.ux.search2.composer.list.IItem
      ...
      local nsnr_content = eve.var.nsnr.search2_result ---@type integer
      local nsnr_matches = eve.var.nsnr.search2_matches ---@type integer
      ...
      ---@type eve.ux.search2.composer.list.IResultRenderData
      local data = { uuids = uuids }
      return data
    end

  ---@type eve.ux.search2.composer.list.IPreviewRender|nil
  local preview_render = props.preview_render

  local self = setmetatable({}, M)

  ---@type eve.ux.search2.ListRetriever
  local retriever = eve.ux.search2.ListRetriever.new({
    name = fullname,
  })
  ...
  local actions = {
    on_confirm = function()
      if on_confirm ~= nil then
        ...
        local item = uuid and self._itemmap[uuid] or nil ---@type eve.ux.search2.composer.list.IItem|nil
  ...
  do
    ...
    flags[#flags + 1] = {
      ...
      snapshot = function()
        return eve.icon.symbols.flag_fuzzy, flag_fuzzy:snapshot() and "search2_flag_blue" or "search2_flag_grey"
      end,
    }
    flags[#flags + 1] = {
      ...
      snapshot = function()
        return eve.icon.symbols.flag_case_sensitive,
          flag_sensitive:snapshot() and "search2_flag_blue" or "search2_flag_grey"
      end,
    }
    flags[#flags + 1] = {
      ...
      snapshot = function()
        return eve.icon.symbols.flag_regex, flag_regex:snapshot() and "search2_flag_blue" or "search2_flag_grey"
      end,
    }
...
function M:dispose()
  ...
  local on_disposed = self._on_disposed ---@type eve.ux.search2.composer.list.IOnDisposed
  local composer = self._composer
  local retriever = self._retriever ---@type eve.ux.search2.ListRetriever
...
---@param lnum                          integer
---@return eve.ux.search2.composer.list.IItem|nil
...
---@param data                          eve.ux.search2.composer.list.IResetData
---@return eve.ux.search2.ListComposer
function M:reset_data(data)
  self:__health__()

  local items = data.items ---@type eve.ux.search2.composer.list.IItem[]
  local lnum_total = #items ---@type integer
  local itemmap = {} ---@type table<string, eve.ux.search2.composer.list.IItem>
