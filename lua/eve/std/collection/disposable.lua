---@class eve.std.collection.IUnsubscribable
...
---@class eve.std.collection.Disposable : eve.std.collection.IDisposable
---@field private _on_dispose           fun():nil
local M = {}
M.__index = M

---@param props eve.std.collection.disposable.IProps
---@return eve.std.collection.Disposable
...
---@param unsubscribable                eve.std.collection.IUnsubscribable
