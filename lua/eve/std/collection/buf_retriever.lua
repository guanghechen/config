local __module_name__ = "eve.std.collection.buf_retriever" ---@type string

---@class eve.std.collection.IBufRetrieverProps
---@field public name                   string

---@class eve.std.collection.BufRetriever : eve.std.collection.IDisposable
---@field public name                   string
...
---@param props eve.std.collection.IBufRetrieverProps
---@return eve.std.collection.BufRetriever
