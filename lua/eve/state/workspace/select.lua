...
---
---@field public find_buffer_scope      eve.collection.IObservable
---@field public find_file_scope        eve.collection.IObservable
---@field public search_file_scope      eve.collection.IObservable
---
