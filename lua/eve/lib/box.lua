---@class eve.lib.box.IDimension
---@field public row                    integer
---@field public col                    integer
---@field public width                  integer
---@field public height                 integer

---@class eve.lib.box.IRestriction
...
---@param restriction                   eve.lib.box.IRestriction
---@return eve.lib.box.IDimension
