---@class eve.lib.ux.IPrinter
---@field public name                   string
---@field public count_lines            fun(self: eve.lib.ux.IPrinter): integer
---@field public lines                  fun(self: eve.lib.ux.IPrinter, lines: string[], highlights?: eve.t.IHighlight[]): eve.lib.ux.IPrinter
---@field public line                   fun(self: eve.lib.ux.IPrinter, content: string, highlights?: eve.t.IHighlightInline[]): eve.lib.ux.IPrinter
---@field public inline                 fun(self: eve.lib.ux.IPrinter, content: string, highlights?: eve.t.IHighlightInline[]): eve.lib.ux.IPrinter
---@field public lf                     fun(self: eve.lib.ux.IPrinter): eve.lib.ux.IPrinter
---@field public render                 fun(self: eve.lib.ux.IPrinter, bufnr: integer): nil

---@class eve.lib.ux.printer.IProps
---@field public name                   string
---@field public indent                 ?string

---@class eve.lib.ux.Printer : eve.lib.ux.IPrinter
...
---@param props                        eve.lib.ux.printer.IProps
