...
function M.on_attach(client, bufnr)
  ...
  local keymaps = {
    ...
    },
    {
      ...
      callback = function()
        vim.cmd("normal! m'")
        vim.cmd(dot.command.definitions.lsp.goto_definitions.uuid)
      end,
    ...
    },
    {
      ...
      callback = function()
        vim.cmd("normal! m'")
        vim.cmd(dot.command.definitions.lsp.goto_implementations.uuid)
      end,
    ...
    },
    {
      ...
      callback = function()
        vim.cmd("normal! m'")
        vim.cmd(dot.command.definitions.lsp.goto_references.uuid)
      end,
    ...
    },
    {
      ...
      callback = function()
        vim.cmd("normal! m'")
        vim.cmd(dot.command.definitions.lsp.goto_type_definitions.uuid)
      end,
