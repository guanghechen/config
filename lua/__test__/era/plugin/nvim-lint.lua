...
--- Run with: nvim -l lua/__test__/era/plugin/nvim-lint.lua
...
---@class __test__.era.plugin.nvim_lint.ITimer
...
---@field public dispose                fun(self: __test__.era.plugin.nvim_lint.ITimer): nil
---@operator call: nil

---@class __test__.era.plugin.nvim_lint.IContext
...
---@field public timers                 __test__.era.plugin.nvim_lint.ITimer[]
...
---@return __test__.era.plugin.nvim_lint.IContext
local function setup()
  ...
  } ---@type __test__.era.plugin.nvim_lint.IContext
    ...
    timer = {
      debounce = function(callback, delay)
        local timer = {
          ...
          schedule_count = 0,
          dispose_count = 0,
        } ---@type __test__.era.plugin.nvim_lint.ITimer
