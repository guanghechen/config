...
local __module_name__ = "era.m.picker.composer.basic" ---@type string

---@alias era.m.picker.composer.basic.PaneEnum
---| "finder"
---| "preview"
---| "result"

---@alias era.m.picker.composer.basic.IOnCancel
---| fun(): nil

---@alias era.m.picker.composer.basic.IOnClosed
---| fun(self: era.m.picker.BasicComposer): nil

---@alias era.m.picker.composer.basic.IOnDisposed
---| fun(): nil

---@alias era.m.picker.composer.basic.IOnFocused
---| fun(self: era.m.picker.BasicComposer): nil

---@alias era.m.picker.composer.basic.IOnHidden
---| fun(self: era.m.picker.BasicComposer): nil

---@alias era.m.picker.composer.basic.IOnRefresh
---| fun(self: era.m.picker.BasicComposer, force: boolean): nil

---@alias era.m.picker.composer.basic.IOnResultRendered
---| fun(self: era.m.picker.BasicComposer, bufnr: integer): nil

---@alias era.m.picker.composer.basic.IOnPreviewRendered
---| fun(self: era.m.picker.BasicComposer, bufnr: integer): nil

----------------------------------------------------------------------------------------------------

---@class era.m.picker.composer.basic.borders
...
---@class era.m.picker.composer.basic.highlights
---@field public finder                 string
---@field public result                 string
---@field public preview                string
...
---@class era.m.picker.composer.IBasicProps
...
---@field public result_isselected      ?era.m.picker.result.IIsSelected
---
---@field public render_preview         ?era.m.picker.preview.IDraw
---@field public render_result          era.m.picker.result.IDraw
---
---@field public on_cancel              ?era.m.picker.composer.basic.IOnCancel
---@field public on_closed              ?era.m.picker.composer.basic.IOnClosed
---@field public on_disposed            ?era.m.picker.composer.basic.IOnDisposed
---@field public on_focused             ?era.m.picker.composer.basic.IOnFocused
---@field public on_hidden              ?era.m.picker.composer.basic.IOnHidden
---@field public on_refresh             ?era.m.picker.composer.basic.IOnRefresh
---@field public on_preview_rendered    ?era.m.picker.composer.basic.IOnPreviewRendered
---@field public on_result_rendered     ?era.m.picker.composer.basic.IOnResultRendered

---@class era.m.picker.BasicComposer : dot.t.IWidget
---@field public uuid                   string
...
---@field protected _pane_focused       era.m.picker.composer.basic.PaneEnum
...
---
---@field protected _on_cancel          era.m.picker.composer.basic.IOnCancel
---@field protected _on_closed          era.m.picker.composer.basic.IOnClosed
---@field protected _on_disposed        era.m.picker.composer.basic.IOnDisposed
---@field protected _on_focused         era.m.picker.composer.basic.IOnFocused
---@field protected _on_hidden          era.m.picker.composer.basic.IOnHidden
---@field protected _on_refresh         era.m.picker.composer.basic.IOnRefresh
local M = {}
M.__index = M

---@param props                         era.m.picker.composer.IBasicProps
---@return era.m.picker.BasicComposer
function M.new(props)
  ...
  local flags = props.flags ---@type era.m.picker.result.IFlagItemRaw[]
  local flags_start_index = props.flags_start_index == 0 and 0 or 1 ---@type 0|1
  local pane_focused = "finder" ---@type era.m.picker.composer.basic.PaneEnum
  local pane_last_focused = "finder" ---@type era.m.picker.composer.basic.PaneEnum
  ...
  local result_isselected = props.result_isselected ---@type era.m.picker.result.IIsSelected|nil

  local render_preview = props.render_preview ---@type era.m.picker.preview.IDraw|nil
  local render_result = props.render_result ---@type era.m.picker.result.IDraw

  local on_cancel = props.on_cancel or stl.fn.noop ---@type era.m.picker.composer.basic.IOnCancel
  local on_closed = props.on_closed or stl.fn.noop ---@type era.m.picker.composer.basic.IOnClosed
  local on_disposed = props.on_disposed or stl.fn.noop ---@type era.m.picker.composer.basic.IOnDisposed
  local on_focused = props.on_focused or stl.fn.noop ---@type era.m.picker.composer.basic.IOnFocused
  local on_hidden = props.on_hidden or stl.fn.noop ---@type era.m.picker.composer.basic.IOnHidden
  local on_refresh = props.on_refresh or stl.fn.noop ---@type era.m.picker.composer.basic.IOnRefresh
  local on_preview_rendered = props.on_preview_rendered or stl.fn.noop ---@type era.m.picker.composer.basic.IOnPreviewRendered
  local on_result_rendered = props.on_result_rendered or stl.fn.noop ---@type era.m.picker.composer.basic.IOnResultRendered
  ...
  self._on_cancel = on_cancel ---@type era.m.picker.composer.basic.IOnCancel
  self._on_closed = on_closed ---@type era.m.picker.composer.basic.IOnClosed
  self._on_disposed = on_disposed ---@type era.m.picker.composer.basic.IOnDisposed
  self._on_focused = on_focused ---@type era.m.picker.composer.basic.IOnFocused
  self._on_hidden = on_hidden ---@type era.m.picker.composer.basic.IOnHidden
  self._on_refresh = on_refresh ---@type era.m.picker.composer.basic.IOnRefresh

  ---@type era.m.picker.Finder
  local finder = era.m.picker.Finder.new({
    name = name,
...
function M:dispose()
  ...
  local result = self.result ---@type era.m.picker.Result
  local preview = self.preview ---@type era.m.picker.Preview|nil
  local on_disposed = self._on_disposed ---@type era.m.picker.composer.basic.IOnDisposed
...
---@param pane                          era.m.picker.composer.basic.PaneEnum|nil
---@return nil
function M:focus(pane)
  ...
  local pane_focused = self._pane_focused ---@type era.m.picker.composer.basic.PaneEnum
...
function M:resize()
  ...
  if has_new_created then
    ...
    if not current_focused_valid then
      local pane_to_focus = self:__is_pane_valid__(self._pane_last_focused) and self._pane_last_focused or "finder" ---@type era.m.picker.composer.basic.PaneEnum
...
function M:__create_wins__()
  ...
  ---@type era.m.picker.finder.IWinOpts
  ...
  ---@type era.m.picker.result.IWinOpts
  ...
  if preview ~= nil and preview_dimension ~= nil and should_show_preview then
    ---@type era.m.picker.preview.IWinOpts
...
---@protected
---@param pane_focused                  era.m.picker.composer.basic.PaneEnum
---@return nil
...
---@param flags                         era.m.picker.result.IFlagItemRaw[]
    ...
    },
    {
      ...
      callback = function()
        ...
        if preview_layout == "right" then
          local pane_focused = self._pane_last_focused == "result" and "result" or "finder" ---@type era.m.picker.composer.basic.PaneEnum
