...
local __module_name__ = "era.m.picker.composer.tree" ---@type string

---@alias era.m.picker.composer.tree.IOnAttached
---| fun(self: era.m.picker.TreeComposer, rootuuid: string): nil

---@alias era.m.picker.composer.tree.IOnClosed
---| fun(self: era.m.picker.TreeComposer): nil

---@alias era.m.picker.composer.tree.IOnConfirm
---| fun(self: era.m.picker.TreeComposer, uuids: string[]|nil): nil

---@alias era.m.picker.composer.tree.IOnDisposed
---| fun(): nil

---@alias era.m.picker.composer.tree.IOnEnter
---| fun(self: era.m.picker.TreeComposer, nodeuuid: string): boolean

---@alias era.m.picker.composer.tree.IOnFocused
---| fun(self: era.m.picker.TreeComposer): nil

---@alias era.m.picker.composer.tree.IOnHidden
---| fun(self: era.m.picker.TreeComposer): nil
---
---@alias era.m.picker.composer.tree.IOnRefresh
---| fun(self: era.m.picker.TreeComposer, force: boolean): nil

---@class era.m.picker.composer.tree.actions
...
---
---@field public on_attached            ?era.m.picker.composer.tree.IOnAttached
---@field public on_closed              ?era.m.picker.composer.tree.IOnClosed
---@field public on_confirm             ?era.m.picker.composer.tree.IOnConfirm
---@field public on_disposed            ?era.m.picker.composer.tree.IOnDisposed
---@field public on_enter               ?era.m.picker.composer.tree.IOnEnter
---@field public on_focused             ?era.m.picker.composer.tree.IOnFocused
---@field public on_hidden              ?era.m.picker.composer.tree.IOnHidden
---@field public on_refresh             ?era.m.picker.composer.tree.IOnRefresh

---@class era.m.picker.TreeComposer
---@field public uuid                   string
...
---
---@field protected _on_attached        era.m.picker.composer.tree.IOnAttached
---@field protected _on_confirm         era.m.picker.composer.tree.IOnConfirm
---@field protected _on_disposed        era.m.picker.composer.tree.IOnDisposed
---@field protected _on_enter           era.m.picker.composer.tree.IOnEnter|nil
---@field protected _observer_unsubs    stl.c.IUnsubscribable[]|nil
local M = {}
M.__index = M

---@param props                         era.m.picker.ITreeComposerProps
...
function M.new(props)
  ...
  local on_attached = props.on_attached or stl.fn.noop ---@type era.m.picker.composer.tree.IOnAttached
  local on_closed = props.on_closed or stl.fn.noop ---@type era.m.picker.composer.tree.IOnClosed
  local on_confirm = props.on_confirm or stl.fn.noop ---@type era.m.picker.composer.tree.IOnConfirm
  local on_disposed = props.on_disposed or stl.fn.noop ---@type era.m.picker.composer.tree.IOnDisposed
  local on_enter = props.on_enter ---@type era.m.picker.composer.tree.IOnEnter|nil
  local on_focused = props.on_focused or stl.fn.noop ---@type era.m.picker.composer.tree.IOnFocused
  ...
  ---@type era.m.view.Plainfile
  local plainfile = era.m.view.Plainfile.new({
    name = fullname,
  })

  ---@type era.m.picker.TreeView
  local treeview = era.m.picker.TreeView.new({
    name = fullname,
    tree = tree,
  ...
  do
    ...
    flags[#flags + 1] = {
      ...
      callback = function()
        local viewtype = o_flag_viewtype:snapshot() ---@type era.m.view.tree.ViewtypeEnum
        local next_viewtype = viewtype == "tree" and "list" or "tree" ---@type era.m.view.tree.ViewtypeEnum
  ...
  ---@type era.m.picker.composer.tree.actions
  local actions = {
    attach_node = function()
      local nodeuuid = self:__retrieve_nodeuuid__() ---@type string|nil
      if nodeuuid ~= nil then
        local nodestate = treeview:retrieve(nodeuuid) ---@type era.m.view.tree.INodeState|nil
    ...
    toggle_selection = function()
      ...
      for lnum = lnum_from, lnum_to, 1 do
        local nodeuuid = retriever:retrieve_uuid(lnum) ---@type string|nil
        if nodeuuid ~= nil then
          local childstate = treeview:retrieve(nodeuuid) ---@type era.m.view.tree.INodeState|nil
  ...
  local composer = era.m.picker.BasicComposer.new({
    ...
    render_result = function(bufnr)
      local viewtype = o_flag_viewtype:snapshot() ---@type era.m.view.tree.ViewtypeEnum
      local result ---@type era.m.view.tree.IRenderResult
...
function M:dispose()
  ...
  local plainfile = self._plainfile ---@type era.m.view.Plainfile
...
---@return era.m.view.tree.INodeState
function M:__retrieve__(nodeuuid)
  ---@type era.m.view.tree.INodeState|nil
...
function M:__retrieve_lnum_parent__(nodeuuid)
  ...
  local nodestate = self._treeview:retrieve(nodeuuid) ---@type era.m.view.tree.INodeState|nil
  if nodestate == nil then
    return nil
  end
