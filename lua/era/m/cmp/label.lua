...
local cache = {} ---@type table<string, era.dressing.ui_attach.popupmenu.ILabelHighlight[]>
local cache_size = 0
...
---@param label                         string
---@return era.dressing.ui_attach.popupmenu.ILabelHighlight[]
local function collect_semantic(filetype, label)
  ...
  local highlights = {} ---@type era.dressing.ui_attach.popupmenu.ILabelHighlight[]
...
---@param filetype                      string
---@param labels                        string[]
---@return table<string, era.dressing.ui_attach.popupmenu.ILabelHighlight[]>
local function semantics(filetype, labels)
  local values = {} ---@type table<string, era.dressing.ui_attach.popupmenu.ILabelHighlight[]>
...
---@return era.dressing.ui_attach.popupmenu.ILabelHighlight[][] label-relative projections
function M.matches(matched_ranges)
  local projected = {} ---@type era.dressing.ui_attach.popupmenu.ILabelHighlight[][]
...
---@return era.dressing.ui_attach.popupmenu.ILabelHighlight[][] label-relative projections
---@return (fun(indices: integer[]): table<integer, era.dressing.ui_attach.popupmenu.ILabelHighlight[]>)|nil
function M.project(filetype, items, matched_ranges, labels)
  ...
  return projected,
    function(indices)
      ...
      local resolved = {} ---@type table<integer, era.dressing.ui_attach.popupmenu.ILabelHighlight[]>
      for _, index in ipairs(indices) do
        local label = semantic_labels[index]
        if label ~= nil then
