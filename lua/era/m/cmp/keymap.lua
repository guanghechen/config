...
function M.bind(bufnr)
  ...
  local keymaps = {
    ...
    },
    {
      ...
      key = "<C-b>",
      callback = function()
        if not actions.visible(bufnr) or not require("era.dressing.ui_attach.popupmenu").scroll_documentation(-1) then
    ...
    },
    {
      ...
      key = "<C-space>",
      callback = function()
        if not actions.visible(bufnr) or not require("era.dressing.ui_attach.popupmenu").toggle_documentation() then
          actions.show()
        end
      end,
