---@class era.m.plugin.state
---@field public options                era.m.plugin.IConfig
---@field public specs                  era.m.plugin.IPluginSpec[]
---@field public lock                   table<string, era.m.plugin.ILockEntry>
...
function M.update_lock(plugins)
  ...
  for n, name in ipairs(names) do
    local info = plugins[name] ---@type era.m.plugin.ILockEntry
...
---@param name                          string
---@return era.m.plugin.ILockEntry|nil
...
function M.remove_orphan_lock_entries()
  ...
  local new_lock = {} ---@type table<string, era.m.plugin.ILockEntry>
