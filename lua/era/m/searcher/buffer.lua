...
local NSNR_SEARCH = vim.api.nvim_create_namespace("era.m.searcher.buffer") ---@type integer
local NSNR_SEARCH_CURRENT = vim.api.nvim_create_namespace("era.m.searcher.buffer.current") ---@type integer
local NSNR_REPLACE_PREVIEW = vim.api.nvim_create_namespace("era.m.searcher.buffer.replace_preview") ---@type integer
...
---@param title                         string
---@return era.m.searcher.result.IFlagItem[], era.m.searcher.result.IFlagItemRaw[]
local function create_flag_items(o_flag_fuzzy, o_flag_regex, o_flag_case_sensitive, o_flag_replace, title)
  ---@type era.m.searcher.result.IFlagItemRaw[]
  local raw_flags = {
    {
  ...
  local flags = {} ---@type era.m.searcher.result.IFlagItem[]
...
---@class era.m.searcher.buffer.ISearcherProps
...
---@class era.m.searcher.buffer.Searcher : dot.t.IWidget
...
---@param props                         era.m.searcher.buffer.ISearcherProps|nil
---@return era.m.searcher.buffer.Searcher
...
function M:__create_finder_window_as_needed__()
  ...
  vim.api.nvim_set_option_value("winblend", 0, { win = popup_winnr, scope = "local" })
...
---@protected
---@param raw_flags                     era.m.searcher.result.IFlagItemRaw[]
...
function M:__update_replace_preview__()
  ...
  local flag_regex = self.o_flag_regex:snapshot() ---@type boolean
  local flag_case_sensitive = self.o_flag_case_sensitive:snapshot() ---@type boolean
  local replacement_matches = {} ---@type era.m.searcher.buffer.IReplacementMatch[]
...
---@class era.m.searcher.buffer.IReplacementMatch
...
---@protected
---@param bufnr                         integer
---@param replacement_matches           era.m.searcher.buffer.IReplacementMatch[]
---@return nil
