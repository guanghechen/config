...
local __module_name__ = "era.m.searcher.result" ---@type string

local c = require("era.m.nvimbar").component
local Nvimbar = require("era.m.nvimbar").Nvimbar

---@alias era.m.searcher.result.IDraw
---| fun(bufnr: integer): era.m.searcher.result.IDrawResult

---@alias era.m.searcher.result.IIsSelected
...
---@class era.m.searcher.IResultProps
---@field public uuid                   string
---@field public name                   string
---@field public draw                   era.m.searcher.result.IDraw
---@field public isselected             ?era.m.searcher.result.IIsSelected
...
---@field public draw                   era.m.searcher.result.IDraw
---@field public flags                  era.m.searcher.result.IFlagItem[]
---@field public keymaps                stl.t.IKeymap[]
...
---@param props                         era.m.searcher.IResultProps
---@return era.m.searcher.Result
function M.new(props)
  local uuid = props.uuid ---@type string
  local name = props.name ---@type string
  local fullname = string.format("%s -> %s", name, __module_name__) ---@type string
  local draw = props.draw ---@type era.m.searcher.result.IDraw
  ...
  if props.flags ~= nil and #props.flags > 0 then
    for _, flag in ipairs(props.flags) do
      ---@cast flag                     era.m.searcher.result.IFlagItemRaw
      ...
      ---@type era.m.searcher.result.IFlagItem
      local item = {
        desc = flag.desc,
...
---@param winopts                       era.m.searcher.result.IWinOpts
