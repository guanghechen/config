...
---@alias era.m.searcher.composer.basic.IOnCancel
---| fun(): nil

---@alias era.m.searcher.composer.basic.IOnClosed
---| fun(self: era.m.searcher.BasicComposer): nil

---@alias era.m.searcher.composer.basic.IOnDisposed
---| fun(): nil

---@alias era.m.searcher.composer.basic.IOnFocused
---| fun(self: era.m.searcher.BasicComposer): nil

---@alias era.m.searcher.composer.basic.IOnHidden
---| fun(self: era.m.searcher.BasicComposer): nil

---@alias era.m.searcher.composer.basic.IOnRefresh
---| fun(self: era.m.searcher.BasicComposer, force: boolean): nil

---@alias era.m.searcher.composer.basic.IOnResultRendered
---| fun(self: era.m.searcher.BasicComposer, bufnr: integer): nil

---@alias era.m.searcher.composer.basic.IOnPreviewRendered
---| fun(self: era.m.searcher.BasicComposer, bufnr: integer): nil

----------------------------------------------------------------------------------------------------

---@class era.m.searcher.composer.basic.borders
...
---@class era.m.searcher.composer.basic.highlights
---@field public finder                 string
---@field public replacer               string
---@field public result                 string
---@field public preview                string
...
---@class era.m.searcher.composer.IBasicProps
...
---
---@field public on_cancel              ?era.m.searcher.composer.basic.IOnCancel
---@field public on_closed              ?era.m.searcher.composer.basic.IOnClosed
---@field public on_disposed            ?era.m.searcher.composer.basic.IOnDisposed
---@field public on_focused             ?era.m.searcher.composer.basic.IOnFocused
---@field public on_hidden              ?era.m.searcher.composer.basic.IOnHidden
---@field public on_refresh             ?era.m.searcher.composer.basic.IOnRefresh
---@field public on_preview_rendered    ?era.m.searcher.composer.basic.IOnPreviewRendered
---@field public on_result_rendered     ?era.m.searcher.composer.basic.IOnResultRendered

---@class era.m.searcher.BasicComposer : dot.t.IWidget
---@field public uuid                   string
---@field public fullname               string
---@field public permanent              boolean
---
---@field public finder                 era.m.searcher.Finder
---@field public replacer               era.m.searcher.Finder|nil
---@field public result                 era.m.searcher.Result
---@field public preview                era.m.searcher.Preview|nil
---
---@field protected _result_number      boolean
---
---@field protected _disposed           boolean
---@field protected _pane_focused       era.m.searcher.composer.basic.PaneEnum
---@field protected _pane_last_focused  era.m.searcher.composer.basic.PaneEnum
...
---
---@field protected _on_cancel          era.m.searcher.composer.basic.IOnCancel
---@field protected _on_closed          era.m.searcher.composer.basic.IOnClosed
---@field protected _on_disposed        era.m.searcher.composer.basic.IOnDisposed
---@field protected _on_focused         era.m.searcher.composer.basic.IOnFocused
---@field protected _on_hidden          era.m.searcher.composer.basic.IOnHidden
---@field protected _on_refresh         era.m.searcher.composer.basic.IOnRefresh
local M = {}
M.__index = M

---@param props                         era.m.searcher.composer.IBasicProps
---@return era.m.searcher.BasicComposer
function M.new(props)
  ...
  local flags = props.flags ---@type era.m.searcher.result.IFlagItemRaw[]
  local flags_start_index = props.flags_start_index == 0 and 0 or 1 ---@type 0|1
  local pane_focused = "finder" ---@type era.m.searcher.composer.basic.PaneEnum
  local pane_last_focused = "finder" ---@type era.m.searcher.composer.basic.PaneEnum
  ...
  local on_cancel = props.on_cancel or stl.fn.noop ---@type era.m.searcher.composer.basic.IOnCancel
  local on_closed = props.on_closed or stl.fn.noop ---@type era.m.searcher.composer.basic.IOnClosed
  local on_disposed = props.on_disposed or stl.fn.noop ---@type era.m.searcher.composer.basic.IOnDisposed
  local on_focused = props.on_focused or stl.fn.noop ---@type era.m.searcher.composer.basic.IOnFocused
  local on_hidden = props.on_hidden or stl.fn.noop ---@type era.m.searcher.composer.basic.IOnHidden
  local on_refresh = props.on_refresh or stl.fn.noop ---@type era.m.searcher.composer.basic.IOnRefresh
  local on_preview_rendered = props.on_preview_rendered or stl.fn.noop ---@type era.m.searcher.composer.basic.IOnPreviewRendered
  local on_result_rendered = props.on_result_rendered or stl.fn.noop ---@type era.m.searcher.composer.basic.IOnResultRendered
  ...
  self._on_cancel = on_cancel ---@type era.m.searcher.composer.basic.IOnCancel
  self._on_closed = on_closed ---@type era.m.searcher.composer.basic.IOnClosed
  self._on_disposed = on_disposed ---@type era.m.searcher.composer.basic.IOnDisposed
  self._on_focused = on_focused ---@type era.m.searcher.composer.basic.IOnFocused
  self._on_hidden = on_hidden ---@type era.m.searcher.composer.basic.IOnHidden
  self._on_refresh = on_refresh ---@type era.m.searcher.composer.basic.IOnRefresh

  ---@type era.m.searcher.Finder
  ...
  ---@type era.m.searcher.Finder|nil
  local replacer = nil
  if replace_pattern ~= nil then
    replacer = era.m.searcher.Finder.new({
      name = name .. " (replacer)",
  ...
  ---@type era.m.searcher.Preview|nil
  local preview = nil
  if render_preview ~= nil then
    preview = era.m.searcher.Preview.new({
      ...
      ---@type era.m.searcher.preview.IOnDrawed
      on_drawed = function(bufnr)
...
function M:dispose()
  ...
  local finder = self.finder ---@type era.m.searcher.Finder
  local replacer = self.replacer ---@type era.m.searcher.Finder|nil
  local result = self.result ---@type era.m.searcher.Result
  local preview = self.preview ---@type era.m.searcher.Preview|nil
  local on_disposed = self._on_disposed ---@type era.m.searcher.composer.basic.IOnDisposed
...
---@param pane                          era.m.searcher.composer.basic.PaneEnum|nil
---@return nil
function M:focus(pane)
  ...
  local pane_focused = has_new_created and "finder" or self._pane_focused ---@type era.m.searcher.composer.basic.PaneEnum
...
function M:resize()
  ...
  if has_new_created then
    ...
    if not current_focused_exists then
      ...
      local pane_to_focus = "finder" ---@type era.m.searcher.composer.basic.PaneEnum
...
function M:__create_wins__()
  ...
  ---@type era.m.searcher.finder.IWinOpts
  ...
  ---@type era.m.searcher.result.IWinOpts
  ...
  if preview ~= nil and preview_dimension ~= nil and should_show_preview then
    ---@type era.m.searcher.preview.IWinOpts
...
---@protected
---@param pane_focused                  era.m.searcher.composer.basic.PaneEnum
---@return nil
...
---@param flags                         era.m.searcher.result.IFlagItemRaw[]
    ...
    },
    {
      ...
      callback = function()
        ...
        if preview_layout == "right" then
          local pane_focused = self._pane_last_focused == "result" and "result" or "finder" ---@type era.m.searcher.composer.basic.PaneEnum
