...
---| fun(bufnr: integer, force: boolean): era.m.searcher.preview.IDrawResult

---@alias era.m.searcher.preview.IOnDrawed
---| fun(bufnr: integer): nil

---@class era.m.searcher.preview.IDrawResult
...
---@class era.m.searcher.preview.IWinOpts
...
---@class era.m.searcher.IPreviewProps
---@field public name                   string
---@field public draw                   era.m.searcher.preview.IDraw
---@field public keymaps                stl.t.IKeymap[]
---@field public on_drawed              ?era.m.searcher.preview.IOnDrawed

---@class era.m.searcher.Preview
---@field public fullname               string
---@field public keymaps                stl.t.IKeymap[]
---@field protected _disposed           boolean
---@field protected _bufnr              integer|nil
---@field protected _winnr              integer|nil
---@field protected _last_result        era.m.searcher.preview.IDrawResult|nil
---@field protected _scheduler_content  stl.c.Scheduler
local M = {}
M.__index = M

---@param props                         era.m.searcher.IPreviewProps
---@return era.m.searcher.Preview
function M.new(props)
  local name = props.name ---@type string
  local fullname = string.format("%s -> %s", name, __module_name__) ---@type string
  local draw = props.draw ---@type era.m.searcher.preview.IDraw
  local keymaps = props.keymaps ---@type stl.t.IKeymap[]
  local on_drawed = props.on_drawed or stl.fn.noop ---@type era.m.searcher.preview.IOnDrawed
  ...
  local scheduler_content = stl.c.Scheduler.new({
    ...
    task = function()
      ...
      local ok, result = pcall(draw, bufnr, false) ---@type boolean, era.m.searcher.preview.IDrawResult
...
---@param winopts                       era.m.searcher.preview.IWinOpts
...
function M:create_win(winopts, dimension)
  ...
  local result = self._last_result ---@type era.m.searcher.preview.IDrawResult|nil
  ...
  vim.w[winnr].wintype = stl.e.WinTypeEnum.PICKER_PREVIEW
...
function M:__update_winopts__()
  local result = self._last_result ---@type era.m.searcher.preview.IDrawResult
  if result == nil then
    return self
  end
