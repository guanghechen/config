...
---@type era.m.image.terminal.Dim|nil
local _size = nil

vim.api.nvim_create_autocmd("VimResized", {
  group = vim.api.nvim_create_augroup("era.m.image.terminal", { clear = true }),
  callback = function()
    _size = nil
  end,
})

---@return era.m.image.terminal.Dim
function M.size()
  if _size then
    return _size
  end
