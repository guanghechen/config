...
---@return table<integer, era.m.image.Placement>
function M:visible()
  local ret = {} ---@type table<integer, era.m.image.Placement>
...
function M:get(from, to)
  ...
  for _, m in ipairs(marks) do
    local p = self.idx[m[1]] ---@type era.m.image.Placement|nil
