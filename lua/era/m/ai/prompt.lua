...
local function plain_lines(lines, hlname)
  local result = {} ---@type era.m.ai.IText
  for _, line in ipairs(lines) do
...
local function get_highlighted_lines(bufnr, start_row, end_row)
  ...
  for i, line in ipairs(lines) do
    ...
    local text_line = {} ---@type era.m.ai.ITextLine
    local from = 0
...
---@return era.m.ai.ITextLine|nil, string|nil
...
---@param ctx                           era.m.ai.prompt.ICtx
---@return era.m.ai.IText|nil, string|nil
