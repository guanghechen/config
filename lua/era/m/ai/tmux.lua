...
---@param tool_config                   era.m.ai.IToolConfig
---@param cwd                           string
---@return string
...
---@class era.m.ai.ITmuxCurrentInfo
---@field public session_name           string
---@field public window_name            string

---@return era.m.ai.ITmuxCurrentInfo|nil
...
function M.list_panes()
  ...
  local panes = {} ---@type era.m.ai.ITmuxPaneInfo[]
