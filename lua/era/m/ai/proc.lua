...
---@class era.m.ai.IProcs
---@field protected _procs              table<integer, era.m.ai.IProc>
---@field protected _children           table<integer, integer[]>
local Procs = {}
Procs.__index = Procs

---@return era.m.ai.IProcs
function Procs.new()
...
---@param pid                           integer
---@return era.m.ai.IProc|nil
function Procs:get(pid)
  return self._procs[pid]
end

---@param pid                           integer
---@param callback                      fun(proc: era.m.ai.IProc): boolean|nil
---@return nil
