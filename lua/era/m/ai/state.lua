...
---@return era.m.ai.IAttachedSource[]
...
function M.detach(source_id, close_terminal)
  local new_sources = {} ---@type era.m.ai.IAttachedSource[]
  local detached_source ---@type era.m.ai.IAttachedSource|nil
