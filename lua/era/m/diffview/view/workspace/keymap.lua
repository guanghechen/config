...
function M.gen_history(ctx)
  ...
  return {
    ...
    { modes = { "n" }, key = "gh", desc = "diffview(history): Collapse commit / directory", callback = function() commits_action.collapse(history) end },
    { modes = { "n" }, key = "gl", desc = "diffview(history): Expand commit / directory", callback = function() commits_action.expand(history) end },
    { modes = { "n" }, key = "oc", desc = "diffview(history): Copy filepath", callback = function() commits_action.copy_filepath(history) end },
    { modes = { "n" }, key = "oo", desc = "diffview(history): Toggle commit / directory", callback = function() commits_action.toggle_expand(history) end },
    ...
    { modes = { "n" }, key = "za", desc = "diffview(history): Toggle commit / directory", callback = function() commits_action.toggle_expand(history) end },
    { modes = { "n" }, key = "zc", desc = "diffview(history): Collapse commit / directory", callback = function() commits_action.collapse(history) end },
    { modes = { "n" }, key = "zo", desc = "diffview(history): Expand commit / directory", callback = function() commits_action.expand(history) end },
    { modes = { "n" }, key = "<C-a>r", desc = "diffview(workspace): Refresh", callback = function() refresh_workspace(ctx) end, aliases = { "<D-r>", "<M-r>" } },
