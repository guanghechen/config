...
local __module_name__ = "era.m.nvimbar.component.lint" ---@type string
...
---@type string
local fn_open_selector = dot.G.register_anonymous_fn(function()
  local linters = get_available_linters() ---@type string[]
  if #linters == 0 then
    stl.reporter.info({
      from = "era.m.nvimbar.component.lint",
...
---@class era.m.nvimbar.component.lint
local M = {}
