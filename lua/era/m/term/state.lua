...
---@param params                        era.m.term.ICreateParams
...
function M.create(params)
  ...
  local termmeta = metamap[termuuid] ---@type era.m.term.IMeta|nil
...
---@return fun(): era.m.term.IMeta|nil, integer|nil
function M:iterator()
...
function M.pick_next_term(termuuid)
  for index = 1, #termlist, 1 do
    ...
    if uuid ~= termuuid then
      local termmeta = metamap[uuid] ---@type era.m.term.IMeta|nil
...
---@param params                        era.m.term.IUpdateParams
---@return boolean
