...
local ft_to_lsp_map = {
  ...
  javascript = { "vtsls", "denols", "eslint", "biome", "tailwindcss" },
  javascriptreact = { "vtsls", "denols", "eslint", "biome", "tailwindcss", "emmet_language_server" },
  json = { "jsonls", "biome" },
  jsonc = { "jsonls", "biome" },
  ...
  toml = { "taplo" },
  typescript = { "vtsls", "denols", "eslint", "biome", "tailwindcss" },
  typescriptreact = { "vtsls", "denols", "eslint", "biome", "tailwindcss", "emmet_language_server" },
  vue = { "biome" },
  yaml = { "yamlls" },
