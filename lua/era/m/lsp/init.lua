...
local __mods = {
  ...
  fn = "era.m.lsp.fn",
  illuminate = "era.m.lsp.illuminate",
...
---@field public illuminate             era.m.lsp.illuminate
...
local ft_to_lsp_map = {
  astro = { "eslint", "biome", "emmet_language_server" },
  bash = { "bashls" },
  c = { "clangd" },
  ["c.doxygen"] = { "clangd" },
  cpp = { "clangd" },
  ["cpp.doxygen"] = { "clangd" },
  cs = { "roslyn_ls" },
  css = { "cssls", "biome", "tailwindcss", "emmet_language_server" },
  cuda = { "clangd" },
  dart = { "dartls" },
  dockerfile = { "dockerls" },
  ...
  hbs = { "tailwindcss" },
  html = { "html", "biome", "tailwindcss", "emmet_language_server" },
  htmlangular = { "eslint", "emmet_language_server" },
  htmldjango = { "emmet_language_server" },
  javascript = { "vtsls", "tsc", "denols", "eslint", "biome", "tailwindcss" },
  javascriptreact = { "vtsls", "tsc", "denols", "eslint", "biome", "tailwindcss", "emmet_language_server" },
  json = { "jsonls", "biome" },
  jsonc = { "jsonls", "biome" },
  ...
  sh = { "bashls" },
  stylus = { "tailwindcss" },
  svelte = { "eslint", "biome", "tailwindcss", "emmet_language_server" },
  templ = { "html", "tailwindcss" },
  toml = { "taplo" },
  typescript = { "vtsls", "tsc", "denols", "eslint", "biome", "tailwindcss" },
  typescriptreact = { "vtsls", "tsc", "denols", "eslint", "biome", "tailwindcss", "emmet_language_server" },
  vue = { "biome" },
  yaml = { "yamlls" },
