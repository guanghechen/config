...
local __module_name__ = "era.m.lsp.illuminate" ---@type string

---@class era.m.lsp.illuminate.ILspWord
---@field public from                   { [1]: integer, [2]: integer }
---@field public to                     { [1]: integer, [2]: integer }

---@alias era.m.lsp.illuminate.IMode
---| "n"
---| "i"
---| "c"
---| "t"
...
---@class era.m.lsp.illuminate.IConfig
...
---@field public modes                  era.m.lsp.illuminate.IMode[]
...
---@type era.m.lsp.illuminate.IConfig
local config = {
  debounce = 200,
  notify_jump = false,
  notify_end = true,
...
---@return era.m.lsp.illuminate.IMode
