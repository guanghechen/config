local __module_name__ = "era.m.view.textarea" ---@type string
...
---@field public open                   fun(self: era.m.view.ITextarea, params: era.m.view.textarea.IOpenParams): nil
---@field public close                  fun(self: era.m.view.ITextarea): nil

---@class era.m.view.textarea.IOpenParams
...
---@class era.m.view.Textarea : era.m.view.ITextarea
...
---@class era.m.view.textarea.IProps
...
---@param props                         era.m.view.textarea.IProps
---@return era.m.view.Textarea
...
---@param params                        era.m.view.textarea.IOpenParams
---@return nil
function M:open(params)
  ...
  local height = stl.box.flat(params.height or self.height, restriction.rows) ---@type integer
  local rect = stl.box.measure(width, height, restriction) ---@type stl.box.IDimension
