local __module_name__ = "era.m.view.fileinfo" ---@type string

---@class era.m.view.fileinfo.IProps
---@field public filepath               string

---@class era.m.view.fileinfo.IState
...
---@class era.m.view.Fileinfo : era.m.view.fileinfo.IState
local M = {}
M.__index = M
...
---@param props                         era.m.view.fileinfo.IProps
---@return era.m.view.Fileinfo
...
function M:__render__(stat)
  ...
  ---@class era.m.view.fileinfo.IInfoLine
  ---@field public label                  string
  ---@field public value                  string

  local infos = {} ---@type era.m.view.fileinfo.IInfoLine[]
