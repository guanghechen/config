---@alias era.m.view.select.ItemKey
---| "1"
---| "2"
---| "3"
---| "4"
...
---@alias era.m.view.select.PositionEnum
---| "cursor"
---| "center"

---@class era.m.view.select.IItem
---@field public key                    era.m.view.select.ItemKey
---@field public text                   string

---@class era.m.view.select.IProps : vim.api.keyset.win_config
---@field public title                  string|nil
---@field public position               era.m.view.select.PositionEnum|nil
---@field public items                  era.m.view.select.IItem[]
---@field public default_key            era.m.view.select.ItemKey|nil
---@field public on_choice              fun(item: era.m.view.select.IItem|nil): nil

---@class era.m.view.select.IConfirmProps : vim.api.keyset.win_config
---@field public title                  string|nil
---@field public position               era.m.view.select.PositionEnum|nil
...
---@class era.m.view.Select
local M = {}

---@param props                         era.m.view.select.IProps
---@return integer
function M.open(props)
  local parent_winnr = vim.api.nvim_get_current_win() ---@type integer
  local items = props.items ---@type era.m.view.select.IItem[]
  local default_key = props.default_key ---@type era.m.view.select.ItemKey|nil
  local on_choice = props.on_choice ---@type fun(item: era.m.view.select.IItem|nil): nil
  ...
  local position = props.position or "center" ---@type era.m.view.select.PositionEnum
  ...
  ---@param item                        era.m.view.select.IItem|nil
  ---@return nil
  ...
  local action = {
    ...
    confirm = function()
      ...
      local item = items[index] ---@type era.m.view.select.IItem
      dispose(item)
    end,
  }
...
---@param props                         era.m.view.select.IConfirmProps
---@return integer
