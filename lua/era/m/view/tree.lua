local __module_name__ = "era.m.view.treeview" ---@type string

---@alias era.m.view.tree.CollapseActionEnum
---| "collapse"
---| "expand"
---| "toggle"

---@alias era.m.view.tree.NodeTypeEnum
---| "container"
---| "leaf"

---@alias era.m.view.tree.ViewtypeEnum
---| "tree"
---| "list"

---@alias era.m.view.tree.INodeState
---| era.m.view.tree.IContainerNodeState
---| era.m.view.tree.ILeafNodeState
---| era.m.view.tree.ILeafLocationState

---@alias era.m.view.tree.IRenderListviewLeafNode
---| fun(leafnode: stl.c.ITreeNode, leafstate: era.m.view.tree.ILeafNodeState): nil

---@alias era.m.view.tree.IRenderListviewLeafLocations
---| fun(leafnode: stl.c.ITreeNode, leafstate: era.m.view.tree.ILeafNodeState): nil

---@alias era.m.view.tree.IRenderTreeviewContainerNode
---| fun(containernode: stl.c.ITreeNode, containerstate: era.m.view.tree.IContainerNodeState, is_lastchild: boolean, cur: integer, dry: boolean): nil

---@alias era.m.view.tree.IRenderTreeviewLeafNode
---| fun(leafnode: stl.c.ITreeNode, leafstate: era.m.view.tree.ILeafNodeState, is_lastchild: boolean, cur: integer): nil

---@alias era.m.view.tree.IRenderTreeviewLeafLocations
---| fun(leafnode: stl.c.ITreeNode, leafstate: era.m.view.tree.ILeafNodeState, leafindent: string): nil

---@alias era.m.view.tree.IListviewLeafNodeRenderer
---| fun(ctx: era.m.view.tree.IListviewRendererContext, node: stl.c.ITreeNode, nodestate: era.m.view.tree.ILeafNodeState, lnum: integer): era.m.view.tree.INodeRenderResult

---@alias era.m.view.tree.IListviewLeafLocationRenderer
---| fun(ctx: era.m.view.tree.IListviewRendererContext, node: stl.c.ITreeNode, nodestate: era.m.view.tree.ILeafNodeState, location: era.m.view.tree.ILeafLocationState, lnum: integer): era.m.view.tree.INodeRenderResult

---@alias era.m.view.tree.ITreeviewContainerNodeRenderer
---| fun(ctx: era.m.view.tree.ITreeviewRendererContext, node: stl.c.ITreeNode, nodestate: era.m.view.tree.IContainerNodeState, lnum: integer, folded_depth: integer): era.m.view.tree.INodeRenderResult

---@alias era.m.view.tree.ITreeviewLeafNodeRenderer
---| fun(ctx: era.m.view.tree.ITreeviewRendererContext, node: stl.c.ITreeNode, nodestate: era.m.view.tree.ILeafNodeState, lnum: integer): era.m.view.tree.INodeRenderResult

---@alias era.m.view.tree.ITreeviewLeafLocationRenderer
---| fun(ctx: era.m.view.tree.ITreeviewRendererContext, node: stl.c.ITreeNode, nodestate: era.m.view.tree.ILeafNodeState, location: era.m.view.tree.ILeafLocationState, lnum: integer): era.m.view.tree.INodeRenderResult

---@class era.m.view.tree.IListviewRendererContext
---@field public rootnode               stl.c.ITreeNode
---@field public rootstate              era.m.view.tree.IContainerNodeState
---@field public tree                   stl.c.IReadonlyTree
---@field public view                   era.m.view.Tree

---@class era.m.view.tree.ITreeviewRendererContext
---@field public rootnode               stl.c.ITreeNode
---@field public rootstate              era.m.view.tree.INodeState
---@field public tree                   stl.c.IReadonlyTree
---@field public view                   era.m.view.Tree

---@class era.m.view.tree.IContainerNodeState
...
---@field public cache_treeview         era.m.view.tree.INodeTreeviewResultCache|nil

---@class era.m.view.tree.ILeafNodeState
---@field public nodetype               "leaf"
---@field public collapsed              boolean
---@field public locations              era.m.view.tree.ILeafLocationState[]|nil
---@field public tick_invisible         integer
---@field public tick_matched           integer
---@field public tick_selected          integer
---@field public cache_listview         era.m.view.tree.INodeListviewResultCache|nil
---@field public cache_treeview         era.m.view.tree.INodeTreeviewResultCache|nil

---@class era.m.view.tree.ILeafLocationState
...
---@class era.m.view.tree.INodeListviewResultCache
---@field public tick                   integer
---@field public text                   string
---@field public highlights             stl.t.IHighlightInline[]

---@class era.m.view.tree.INodeTreeviewResultCache
---@field public tick                   integer
---@field public text                   string
---@field public highlights             stl.t.IHighlightInline[]

---@class era.m.view.tree.INodeRenderResult
---@field public text                   string
---@field public highlights             stl.t.IHighlightInline[]|nil

---@class era.m.view.tree.IRenderResult
...
---@class era.m.view.tree.IRenderListviewParams
...
---@class era.m.view.tree.IRenderTreeviewParams
---@field public bufnr                  integer
---@field public rootuuid               string|nil
...
---@class era.m.view.ITreeProps
---@field public name                   string
---@field public fullname               ?string
---@field public indent                 ?string
---@field public indent_hln             ?string
---@field public tree                   stl.c.IReadonlyTree
---@field public render_listview_leaf   era.m.view.tree.IListviewLeafNodeRenderer
---@field public render_listview_location   era.m.view.tree.IListviewLeafLocationRenderer
---@field public render_treeview_container  era.m.view.tree.ITreeviewContainerNodeRenderer
---@field public render_treeview_leaf   era.m.view.tree.ITreeviewLeafNodeRenderer
---@field public render_treeview_location   era.m.view.tree.ITreeviewLeafLocationRenderer

---@class era.m.view.Tree
---@field public fullname               string
---@field public statemap               table<string, era.m.view.tree.INodeState>
---
...
---
---@field protected _render_listview_leaf       era.m.view.tree.IListviewLeafNodeRenderer
---@field protected _render_listview_location   era.m.view.tree.IListviewLeafLocationRenderer
---@field protected _render_treeview_container  era.m.view.tree.ITreeviewContainerNodeRenderer
---@field protected _render_treeview_leaf       era.m.view.tree.ITreeviewLeafNodeRenderer
---@field protected _render_treeview_location   era.m.view.tree.ITreeviewLeafLocationRenderer
local M = {}
M.__index = M

---@param props                         era.m.view.ITreeProps
---@return era.m.view.Tree
function M.new(props)
  ...
  local render_listview_leaf = props.render_listview_leaf ---@type era.m.view.tree.IListviewLeafNodeRenderer
  local render_listview_location = props.render_listview_location ---@type era.m.view.tree.IListviewLeafLocationRenderer
  local render_treeview_container = props.render_treeview_container ---@type era.m.view.tree.ITreeviewContainerNodeRenderer
  local render_treeview_leaf = props.render_treeview_leaf ---@type era.m.view.tree.ITreeviewLeafNodeRenderer
  local render_treeview_location = props.render_treeview_location ---@type era.m.view.tree.ITreeviewLeafLocationRenderer

  local statemap = {} ---@type table<string, era.m.view.tree.INodeState>
...
function M:ismatched(uuid)
  local nodestate = self.statemap ~= nil and self.statemap[uuid] or nil ---@type era.m.view.tree.INodeState|nil
...
function M:render_listview(params)
  ...
  local rootstate = statemap[rootuuid] ---@type era.m.view.tree.INodeState|nil
  if rootnode == nil or (rootstate ~= nil and rootstate.tick_invisible == tick_invisible) then
    vim.api.nvim_buf_set_lines(bufnr, 0, -1, false, {})
    local result = { indents = {}, lnum2uuid = {}, uuid2lnum = {} } ---@type era.m.view.tree.IRenderResult
    return result
  end
  ...
  ---@cast rootstate                    era.m.view.tree.IContainerNodeState
  ---@type era.m.view.tree.IListviewRendererContext
  local ctx = {
    rootnode = rootnode,
    rootstate = rootstate,
    tree = tree,
  ...
  local render_listview_leaf = self._render_listview_leaf ---@type era.m.view.tree.IListviewLeafNodeRenderer
  local render_listview_location = self._render_listview_location ---@type era.m.view.tree.IListviewLeafLocationRenderer
  ...
  ---@type era.m.view.tree.IRenderListviewLeafLocations
  local function render_leaf_locations(leafnode, leafstate)
    ...
    for index = N, 1, -1 do
      local location = leafstate.locations[index] ---@type era.m.view.tree.ILeafLocationState
  ...
  ---@type era.m.view.tree.IRenderListviewLeafNode
  local function render_leafnode(leafnode, leafstate)
    ...
    local cache = leafstate.cache_listview ---@type era.m.view.tree.INodeListviewResultCache|nil
    if cache == nil or cache.tick ~= tick_render_listview then
      local result = render_listview_leaf(ctx, leafnode, leafstate, lnum)
      ---@type era.m.view.tree.INodeListviewResultCache
      cache = {
    ...
    if only_matched then
      if only_selected then
        ...
        conditional = function(_, node)
          local nodestate = statemap[node.uuid] ---@type era.m.view.tree.INodeState|nil
          if
            nodestate == nil
    ...
    if only_matched then
      if only_selected then
        for _, uuid in ipairs(orders) do
          ...
          local nodestate = statemap[uuid] ---@type era.m.view.tree.INodeState|nil
          if
            node ~= nil
            and nodestate ~= nil
            and nodestate.nodetype == "leaf"
  ...
  ---@type era.m.view.tree.IRenderResult
...
function M:render_treeview(params)
  ...
  local rootstate = statemap[root] ---@type era.m.view.tree.INodeState|nil
  if rootnode == nil or (rootstate ~= nil and rootstate.tick_invisible == tick_invisible) then
    vim.api.nvim_buf_set_lines(bufnr, 0, -1, false, {})
    local result = { indents = {}, lnum2uuid = {}, uuid2lnum = {} } ---@type era.m.view.tree.IRenderResult
    return result
  ...
  ---@cast rootstate                    era.m.view.tree.IContainerNodeState
  ---@type era.m.view.tree.ITreeviewRendererContext
  local ctx = {
    rootnode = rootnode,
    rootstate = rootstate,
    tree = tree,
  ...
  local nsnr = NSNR_DEFAULT ---@type integer
  local INDENT_COMMON = self._indent ---@type string
  local render_treeview_container = self._render_treeview_container ---@type era.m.view.tree.ITreeviewContainerNodeRenderer
  local render_treeview_leaf = self._render_treeview_leaf ---@type era.m.view.tree.ITreeviewLeafNodeRenderer
  local render_treeview_location = self._render_treeview_location ---@type era.m.view.tree.ITreeviewLeafLocationRenderer
  ...
  ---@type era.m.view.tree.IRenderTreeviewLeafLocations
  ...
  ---@type era.m.view.tree.IRenderTreeviewLeafNode
  local function render_leaf(leafnode, leafstate, is_lastchild, cur)
    ...
    local cache = leafstate.cache_treeview ---@type era.m.view.tree.INodeTreeviewResultCache|nil
    if cache == nil or cache.tick ~= tick_render_treeview then
      local result = render_treeview_leaf(ctx, leafnode, leafstate, lnum) ---@type era.m.view.tree.INodeRenderResult
      ---@type era.m.view.tree.INodeTreeviewResultCache
      cache = {
  ...
  local render_container ---@type era.m.view.tree.IRenderTreeviewContainerNode
  if foldempty then
    ---@type era.m.view.tree.IRenderTreeviewContainerNode
    render_container = function(containernode, containerstate, is_lastchild, cur, dry)
      ...
      local nodestate = statemap[containernode.uuid] ---@type era.m.view.tree.INodeState
      local result ---@type era.m.view.tree.INodeTreeviewResultCache|era.m.view.tree.INodeRenderResult
  ...
  if foldempty then
    ...
    traverse = function(_, node, cur, is_lastchild, onlychild)
      ...
      if onlychild ~= nil then
        local state_onlychild = statemap[onlychild] ---@type era.m.view.tree.INodeState
        if state_onlychild.nodetype == "container" then
          ---@cast nodestate            era.m.view.tree.IContainerNodeState
...
function M:collect_leafs(root)
  ...
  self._tree:quick_traverse(root, function(_, node)
    local state = statemap[node.uuid] ---@type era.m.view.tree.INodeState|nil
...
---@param uuid                          string
---@param state                         era.m.view.tree.INodeState
---@return era.m.view.Tree
function M:insert(uuid, state)
  self:__health__()

  local statemap = self.statemap ---@type table<string, era.m.view.tree.INodeState>
  local oldstate = statemap[uuid] ---@type era.m.view.tree.INodeState|nil
...
---@param leafnodestate                 era.m.view.tree.ILeafNodeState
---@return nil
function M:remove_all_locations(leafnodestate)
  ...
  if leafnodestate.locations ~= nil then
    local statemap = self.statemap ---@type table<string, era.m.view.tree.INodeState>
    local locations = leafnodestate.locations ---@type era.m.view.tree.ILeafLocationState[]
    local L = #locations ---@type integer
    for i = 1, L, 1 do
      local location = locations[i] ---@type era.m.view.tree.ILeafLocationState
      statemap[location.locationuuid] = nil
    end
    leafnodestate.locations = nil ---@type era.m.view.tree.ILeafLocationState[]|nil
  end
end
  ...
  if leafnodestate.locations ~= nil then
    ...
    for i = 1, L, 1 do
      ...
      if location.locationuuid == locationuuid then
        ...
        k = k + 1 ---@type integer
        locations[k] = location ---@type era.m.view.tree.ILeafLocationState
      end
    end
...
---@param uuid                          string
---@return era.m.view.tree.INodeState|nil
function M:retrieve(uuid)
  self:__health__()
  return self.statemap[uuid] ---@type era.m.view.tree.INodeState|nil
end
...
function M:set_selected(nodeuuid, selected)
  ...
  local tick_selected = self._tick_selected ---@type integer
  local nodestate = self.statemap[nodeuuid] ---@type era.m.view.tree.INodeState|nil
  if nodestate ~= nil then
    if selected then
...
---@param uuid                          string
---@param value                         era.m.view.tree.CollapseActionEnum
...
function M:collapse(uuid, value, recursive)
  ...
  local statemap = self.statemap ---@type table<string, era.m.view.tree.INodeState>
  local state = statemap[uuid] ---@type era.m.view.tree.INodeState|nil
  if state == nil then
    stl.reporter.error({
      from = self.fullname,
      subject = "collapse",
  ...
  if recursive then
    tree:quick_traverse(uuid, function(_, node)
      local s = statemap[node.uuid] ---@type era.m.view.tree.INodeState
...
function M:mark_node_invisible(nodeuuid)
  self:__health__()
  local statemap = self.statemap ---@type table<string, era.m.view.tree.INodeState>
  local nodestate = statemap[nodeuuid] ---@type era.m.view.tree.INodeState|nil
  if nodestate ~= nil then
...
function M:__refresh_selected_maximum__()
  ...
  tree:unsafe_traverse(nil, function(ctx)
    ...
    local function recursive(node)
      local childstate = statemap[node.uuid] ---@type era.m.view.tree.INodeState
