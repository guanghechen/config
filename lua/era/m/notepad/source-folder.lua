...
local __module_name__ = "era.m.notepad.source-folder" ---@type string

---@class era.m.notepad.state.source.FolderState : era.m.notepad.state.INotepadSourceState
---Folder-specific state (inherits all fields from INotepadSourceState)

---@class era.m.notepad.state.source.Folder : era.m.notepad.state.INotepadSource
...
---@field protected _state              era.m.notepad.state.source.FolderState|nil Internal state cache
...
---@return era.m.notepad.state.source.Folder
...
---@param force                         boolean
---@return era.m.notepad.state.source.FolderState
...
function M:list()
  local state = self:load(false) ---@type era.m.notepad.state.source.FolderState
...
function M:rename(uuid, new_name)
  ...
  item.name = normalized_name
  item.updated_at = era.m.notepad.state.now_iso_utc()
