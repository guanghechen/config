...
local __module_name__ = "era.action.notepad" ---@type string
...
---@class era.action.notepad.ISourceItem : dot.module.picker.composer.list.IItem
...
local function fetch_source_data()
  ...
  local items = {} ---@type era.action.notepad.ISourceItem[]
...
local source_picker ---@type dot.module.picker.ListComposer|nil
source_picker = dot.picker.ListComposer.new({
  ...
  render_preview = function(composer, bufnr, _)
    ...
    ---@cast item era.action.notepad.ISourceItem|nil
  ...
  on_confirm = function(composer, item)
    ---@cast item era.action.notepad.ISourceItem
    composer:close()
    if item ~= nil then
...
---@class era.action.notepad.INoteItem : dot.module.picker.composer.list.IItem
...
local function fetch_notes_data()
  ...
  local items = {} ---@type era.action.notepad.INoteItem[]
...
local notes_picker ---@type dot.module.picker.ListComposer|nil
notes_picker = dot.picker.ListComposer.new({
  ...
  render_preview = function(composer, bufnr, _)
    local lnum_current = composer.result.lnum_current:snapshot() ---@type integer
    local item = composer:retrieve(lnum_current) ---@type dot.module.picker.composer.list.IItem|nil
    ---@cast item era.action.notepad.INoteItem|nil
  ...
  on_confirm = function(composer, item)
    ---@cast item era.action.notepad.INoteItem
    composer:close()
    if item ~= nil then
...
---@class era.action.notepad.IEngineItem : dot.module.picker.composer.list.IItem
---@field public data                   { engine: 'json'|'folder', description: string }
---@field public text_lower             string

local engine_picker ---@type dot.module.picker.ListComposer|nil
engine_picker = dot.picker.ListComposer.new({
  ...
  render_preview = function(composer, bufnr, _)
    local lnum_current = composer.result.lnum_current:snapshot() ---@type integer
    local item = composer:retrieve(lnum_current) ---@type dot.module.picker.composer.list.IItem|nil
    ---@cast item era.action.notepad.IEngineItem|nil
  ...
  on_confirm = function(composer, item)
    ---@cast item era.action.notepad.IEngineItem
    composer:close()
    if item ~= nil then
...
function M.change_engine()
  ...
  ---@type era.action.notepad.IEngineItem[]
  local items = {
    {
      uuid = "json",
      text = "json",
