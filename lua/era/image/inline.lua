local __module_name__ = "era.image.inline" ---@type string

---@class era.image.inline
---@field public bufnr                    integer
---@field public imgs                     table<integer, era.image.Placement>
---@field public idx                      table<integer, era.image.Placement>
---@field protected __call_debounced__    fun(self: era.image.inline): nil
...
---@return table<integer, era.image.Placement>
function M:visible()
  local ret = {} ---@type table<integer, era.image.Placement>
...
function M:get(from, to)
  ...
  for _, m in ipairs(marks) do
    local p = self.idx[m[1]] ---@type era.image.Placement|nil
...
function M:update()
  ...
  local doc = require("era.image.doc")
  local placement = require("era.image.placement")
  ...
  doc.find_visible(self.bufnr, function(imgs)
    ...
    for _, i in ipairs(imgs) do
      local img ---@type era.image.Placement|nil
