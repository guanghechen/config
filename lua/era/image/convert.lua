local __module_name__ = "era.image.convert" ---@type string

---@class era.image.convert
local M = {}

local uv = vim.uv

---@alias era.image.args        (number|string)[] | fun(): ((number|string)[])

---@class era.image.convert.IConfig
---@field public notify                  boolean
---@field public mermaid                 ?era.image.args
---@field public magick                  ?table<string, era.image.args>
local config = {
  notify = false,
  mermaid = function()
...
---@class era.image.meta
---@field public src                     string
---@field public info                    ?era.image.Info
---@field public pdf                     ?string

---@class era.image.Proc
---@field public cmd                     string
---@field public cwd                     ?string
---@field public args                    era.image.args

---@class era.image.step
---@field public name                    string
---@field public file                    string
---@field public ft                      string
---@field public cmd                     era.image.cmd
---@field public meta                    era.image.meta
---@field public done                    ?boolean
---@field public err                     ?string
---@field public proc                    ?stl.c.Proc

---@class era.image.cmd
---@field public cmd                     (fun(step: era.image.step): (era.image.Proc|era.image.Proc[]))|era.image.Proc|era.image.Proc[]
---@field public ft                      ?string
---@field public file                    ?fun(convert: era.image.Convert, meta: era.image.meta): string
---@field public depends                 ?string[]
---@field public on_done                 ?fun(step: era.image.step)
---@field public on_error                ?fun(step: era.image.step): boolean?
---@field public pipe                    ?boolean

---@type table<string, era.image.cmd>
local commands = {
  icns = {
    ft = "png",
    cmd = {
  ...
  tex = {
    ...
    file = function(convert, ctx)
      local s = require("era.image.state").data
...
---@param step                           era.image.step
---@return era.image.Proc|nil
...
---@class era.image.Convert
---@field public opts                    era.image.convert.Opts
---@field public src                     string
---@field public page                    integer
---@field public file                    string
---@field public prefix                  string
---@field public meta                    era.image.meta
---@field public steps                   era.image.step[]
...
---@class era.image.convert.Opts
---@field public src                     string
---@field public on_done                 ?fun(convert: era.image.Convert)

---@param opts                           era.image.convert.Opts
---@return era.image.Convert
