local __module_name__ = "era.image.placement" ---@type string

---@alias era.image.Extmark      vim.api.keyset.set_extmark|{row: integer, col: integer}

---@class era.image.Opts
---@field public pos                      ?era.image.Pos
...
---@field public on_update                ?fun(placement: era.image.Placement)
---@field public on_update_pre            ?fun(placement: era.image.Placement)
---@field public type                     ?era.image.Type
---@field public auto_resize              ?boolean

---@class era.image.State
---@field public hidden                   boolean
---@field public loc                      era.image.Loc
---@field public wins                     integer[]

---@class era.image.Placement
---@field public img                      era.image.Image
---@field public id                       integer
---@field public ns                       integer
---@field public bufnr                    integer
---@field public opts                     era.image.Opts
---@field public augroup                  integer
---@field public hidden                   ?boolean
---@field public closed                   ?boolean
---@field public type                     ?era.image.Type
---@field public eids                     integer[]
---@field public update                   fun(self: era.image.Placement): nil
---@field protected _loc                  ?era.image.Loc
---@field protected _state                ?era.image.State
---@field protected _extmarks             ?era.image.Extmark[]
...
---@type table<integer, table<integer, era.image.Placement>>
local placements = {}
...
---@param bufnr                          integer
---@param src                            string
---@param opts                           ?era.image.Opts
---@return era.image.Placement
function M.new(bufnr, src, opts)
  local Image = require("era.image.image")
...
function M:render_grid(loc)
  ...
  local extmarks = {} ---@type era.image.Extmark[]
...
---@param extmarks                       era.image.Extmark[]
---@return nil
