---@class era.image.Image
---@field public src                      string
---@field public file                     string
---@field public id                       integer
---@field public sent                     ?boolean
---@field public placements               table<integer, era.image.Placement>
...
---@type table<string, era.image.Image>
local images = {}

---@type {img: era.image.Image, used: integer}[]
local lru = {}

---@type integer
local lru_fsize = 0

---@param img                            era.image.Image
---@return nil
...
---@param placement                      era.image.Placement
---@return nil
function M:place(placement)
  local _pid = require("era.image.placement")._pid
  if not placement.id then
    _pid = _pid + 1
    require("era.image.placement")._pid = _pid
    placement.id = _pid
  end
...
function M:__convert__()
  local convert = require("era.image.convert")
