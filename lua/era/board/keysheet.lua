---@class era.board.keysheet.IProps
---@field public title                  ?string
---@field public keymaps                stl.t.IKeymap[]

---@class era.board.keysheet.IState
...
---@class era.board.Keysheet : era.board.keysheet.IState
local M = {}
M.__index = M
...
---@param props                         era.board.keysheet.IProps
---@return era.board.Keysheet
...
function M:open()
  ...
  local winnr = vim.api.nvim_open_win(bufnr, true, {
    ...
    style = "minimal",
    focusable = true,
    title = string.format(" %s %s ", stl.icon.ui.Keyboard, self._title),
    title_pos = "center",
  })
  self._winnr = winnr
...
function M:__render__(available_width)
  ...
  ---@class era.board.keysheet.IItem
  ---@field public key                    string
  ---@field public modes                  string
  ---@field public desc                   string

  ---@type era.board.keysheet.IItem[]
  local items = {}
  ...
  for row = 1, rows do
    ...
    for col = 1, columns do
      ...
      local item = items[idx] ---@type era.board.keysheet.IItem|nil
      if item == nil then
        break
      end
