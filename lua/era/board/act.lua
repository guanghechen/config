local __module_name__ = "era.board.act" ---@type string

---@alias era.board.act.IRenderPreview
---| fun(bufnr: integer, input: string): nil

---@alias era.board.act.IOnConfirm
---| fun(input: string): nil

---@alias era.board.act.IOnCancel
---| fun(): nil

---@alias era.board.act.IOnInputChange
---| fun(input: string): nil

---@alias era.board.act.IGetWidth
---| fun(): integer

---@class era.board.act.IProps
---@field public name                   string
---@field public title                  string
---@field public initial_input          ?string
---@field public preview_lines          ?integer
---@field public render_preview         era.board.act.IRenderPreview
---@field public on_input_change        ?era.board.act.IOnInputChange
---@field public on_confirm             era.board.act.IOnConfirm
---@field public on_cancel              ?era.board.act.IOnCancel
---@field public keymaps                ?stl.t.IKeymap[]
---@field public width                  ?number
---@field public get_width              ?era.board.act.IGetWidth

---@class era.board.act.IState
...
---@class era.board.Act : era.board.act.IState
...
---@field protected _get_width          era.board.act.IGetWidth|nil
local M = {}
M.__index = M

local MAX_WIDTH = 120 ---@type integer

---@class era.board.act.borders
...
---@class era.board.act.highlights
---@field public input                  string
---@field public preview                string
...
---@param props                         era.board.act.IProps
---@return era.board.Act
function M.new(props)
  ...
  local render_preview = props.render_preview ---@type era.board.act.IRenderPreview
  local on_input_change = props.on_input_change or stl.fn.noop ---@type era.board.act.IOnInputChange
  local on_confirm = props.on_confirm ---@type era.board.act.IOnConfirm
  local on_cancel = props.on_cancel or stl.fn.noop ---@type era.board.act.IOnCancel
  ...
  local get_width = props.get_width ---@type era.board.act.IGetWidth|nil
