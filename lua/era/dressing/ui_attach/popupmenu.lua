...
local render_visible_label_highlights ---@type fun(state: era.dressing.ui_attach.popupmenu.IState)
...
---@param col                           integer
---@param grid                          integer
---@param resolve_highlights            (fun(indices: integer[]): table<integer, era.dressing.ui_attach.popupmenu.ILabelHighlight[]>)|nil
...
function M._format_items(items, width)
  ...
  for index, item in ipairs(items) do
    local word, kind, menu, _, description, kind_hlgroup, label_highlights, source_hlgroup = unpack(item) ---@type string, string, string, string, string, string, era.dressing.ui_attach.popupmenu.ILabelHighlight[], string
...
---@param highlights                    era.dressing.ui_attach.popupmenu.ILabelHighlight[]
