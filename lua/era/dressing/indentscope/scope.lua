...
local __module_name__ = "era.dressing.indentscope.scope" ---@type string

---@class era.dressing.indentscope.scope
local M = {}

---@class era.dressing.indentscope.scope.ICacheEntry
---@field public scope                  era.dressing.indentscope.IScope
...
local cache = nil ---@type era.dressing.indentscope.scope.ICacheEntry|nil
...
---@param border                        era.dressing.indentscope.Border
...
---@param lnum                          integer
---@param line_count                    integer
---@param options                       era.dressing.indentscope.IOptions
...
---@param body                          era.dressing.indentscope.IBody
---@param border                        era.dressing.indentscope.Border
---@param get_indent                    fun(lnum: integer): integer
---@return era.dressing.indentscope.IBorder
...
---@param entry                         era.dressing.indentscope.scope.ICacheEntry
---@param bufnr                         integer
---@param winnr                         integer
...
---@param col                           integer
---@param reference_indent              integer
---@return era.dressing.indentscope.IScope|nil
local function reuse_scope(bufnr, winnr, changedtick, tabstop, vartabstop, options, line, col, reference_indent)
  local entry = cache
  local scope = entry and entry.scope or nil ---@type era.dressing.indentscope.IScope|nil
  if
    entry == nil
    or scope == nil
...
function M.get(line, col, options)
  ...
  local body ---@type era.dressing.indentscope.IBody
  ...
  } ---@type era.dressing.indentscope.IScope
...
---@param left                          era.dressing.indentscope.IScope
---@param right                         era.dressing.indentscope.IScope
---@return boolean
