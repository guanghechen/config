...
command
  .implement({
    uuid = K.ai.edit.uuid,
    action = function()
      require("era.action.ai").edit()
    end,
  })
  .implement({
    uuid = K.ai.attach_agent.uuid,
    action = function()
      require("era.action.ai").attach_agent()
    end,
  })
  .implement({
    uuid = K.ai.detach_agent.uuid,
    action = function()
      require("era.action.ai").detach_agent()
    end,
  })
  .implement({
    uuid = K.ai.submit_buffer.uuid,
    action = function()
      require("era.action.ai").submit_buffer()
    end,
  })
  .implement({
    uuid = K.ai.submit_selection.uuid,
    action = function()
      require("era.action.ai").submit_selection()
    end,
  })
  .implement({
    uuid = K.ai.send_buffer.uuid,
    action = function()
      require("era.action.ai").send_buffer()
    end,
  })
  .implement({
    uuid = K.ai.send_selection.uuid,
    action = function()
      require("era.action.ai").send_selection()
    end,
  })
  .implement({
    uuid = K.ai.send_this.uuid,
    action = function()
      require("era.action.ai").send_this()
    end,
  })
  .implement({
    uuid = K.ai.send_file.uuid,
    action = function()
      require("era.action.ai").send_file()
    end,
  })
  .implement({
    uuid = K.ai.select_prompt.uuid,
    action = function()
      require("era.action.ai").select_prompt()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.buf").close()
    end,
  })
  .implement({
    uuid = K.buf.close_to_leftest.uuid,
    action = function()
      require("era.action.buf").close_to_leftest()
    end,
  })
  .implement({
    uuid = K.buf.close_to_rightest.uuid,
    action = function()
      require("era.action.buf").close_to_rightest()
    end,
  })
  .implement({
    uuid = K.buf.close_others.uuid,
    action = function()
      require("era.action.buf").close_others()
    end,
  })
...
for index = 1, 49, 1 do
  ...
  command.implement({
    ...
    action = function()
      require("era.action.buf").focus(index)
    end,
  })
end
for index = 1, 9, 1 do
  command.implement({
    ...
    action = function()
      require("era.action.buf").focus_left(index)
    end,
  })
  command.implement({
    uuid = K.buf["focus_right_" .. tostring(index)].uuid,
    action = function()
      require("era.action.buf").focus_right(index)
    end,
  })
end
  ...
  .implement({
    ...
    action = function(args)
      ...
      if bufnr ~= nil and vim.api.nvim_buf_is_valid(bufnr) then
        require("era.action.buf").open(bufnr)
      end
    end,
  })
  .implement({
    ...
    action = function(args)
      ...
      if bufid ~= nil then
        require("era.action.buf").focus(bufid)
      end
    end,
  })
  .implement({
    ...
    action = function(args)
      ...
      require("era.action.buf").focus_left(ok and step or nil)
    end,
  })
  .implement({
    ...
    action = function(args)
      local ok, step = pcall(tonumber, args)
      require("era.action.buf").focus_right(ok and step or nil)
    end,
  })
...
command.implement({
  uuid = K.buf.pin.uuid,
  action = function()
    require("era.action.buf").toggle_pin()
  end,
})
...
command
  .implement({
    ...
    action = function(args)
      require("era.action.buf").save(args)
    end,
  })
  .implement({
    uuid = K.buf.save_no_format.uuid,
    action = function()
      require("era.action.buf").save("noformat")
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.buf").swap_left()
    end,
  })
  .implement({
    uuid = K.buf.swap_right.uuid,
    action = function()
      require("era.action.buf").swap_right()
    end,
  })
...
command
  ...
  .implement({
    ...
    action = function()
      local trailspace = require("era.dressing.trailspace")
      trailspace.trim()
...
command
  .implement({
    ...
    action = function(arg)
      require("era.action.copy").copy_filepath(arg)
    end,
  })
  .implement({
    uuid = K.copy.filepath_absolute.uuid,
    action = function()
      require("era.action.copy").copy_filepath_absolute()
    end,
  })
  .implement({
    uuid = K.copy.filepath_relative.uuid,
    action = function()
      require("era.action.copy").copy_filepath_relative()
    end,
  })
...
command.implement({
  ...
  action = function()
    require("era.action.copy").copy_char_under_cursor()
  end,
})
...
command
  .implement({
    ...
    action = function()
      require("era.action.diagnostic").goto_next()
    end,
  })
  .implement({
    uuid = K.diagnostic.goto_next_error.uuid,
    action = function()
      require("era.action.diagnostic").goto_next_error()
    end,
  })
  .implement({
    uuid = K.diagnostic.goto_next_warn.uuid,
    action = function()
      require("era.action.diagnostic").goto_next_warn()
    end,
  })
  .implement({
    uuid = K.diagnostic.goto_next_hint.uuid,
    action = function()
      require("era.action.diagnostic").goto_next_hint()
    end,
  })
  .implement({
    uuid = K.diagnostic.goto_next_quickfix.uuid,
    action = function()
      require("era.action.diagnostic").goto_next_quickfix()
    end,
  })
  .implement({
    uuid = K.diagnostic.goto_prev.uuid,
    action = function()
      require("era.action.diagnostic").goto_prev()
    end,
  })
  .implement({
    uuid = K.diagnostic.goto_prev_error.uuid,
    action = function()
      require("era.action.diagnostic").goto_prev_error()
    end,
  })
  .implement({
    uuid = K.diagnostic.goto_prev_warn.uuid,
    action = function()
      require("era.action.diagnostic").goto_prev_warn()
    end,
  })
  .implement({
    uuid = K.diagnostic.goto_prev_hint.uuid,
    action = function()
      require("era.action.diagnostic").goto_prev_hint()
    end,
  })
  .implement({
    uuid = K.diagnostic.goto_prev_quickfix.uuid,
    action = function()
      require("era.action.diagnostic").goto_prev_quickfix()
    end,
  })
  .implement({
    uuid = K.diagnostic.line.uuid,
    action = function()
      require("era.action.diagnostic").line()
    end,
  })
  .implement({
  ...
  .implement({
    ...
    action = function()
      require("era.action.diagnostic").to_md()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.inspect").inspect_buf()
    end,
  })
  .implement({
    uuid = K.inspect.inspect_pos.uuid,
    action = function()
      require("era.action.inspect").inspect_pos()
    end,
  })
  .implement({
    uuid = K.inspect.inspect_state.uuid,
    action = function()
      require("era.action.inspect").inspect_state()
    end,
  })
  .implement({
    uuid = K.inspect.inspect_state_full.uuid,
    action = function()
      require("era.action.inspect").inspect_state_full()
    end,
  })
  .implement({
    uuid = K.inspect.inspect_tab.uuid,
    action = function()
      require("era.action.inspect").inspect_tab()
    end,
  })
  .implement({
    uuid = K.inspect.inspect_tree.uuid,
    action = function()
      require("era.action.inspect").inspect_tree()
    end,
  })
  .implement({
    uuid = K.inspect.inspect_window.uuid,
    action = function()
      require("era.action.inspect").inspect_window()
    end,
  })
...
command.implement({
  ...
  action = function()
    require("era.action.lint").spellcheck_register()
  end,
})
...
command
  .implement({
    ...
    action = function()
      require("era.action.log").preview_json_normal()
    end,
  })
  .implement({
    uuid = K.log.preview_json_visual.uuid,
    action = function()
      require("era.action.log").preview_json_visual()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.lsp.reference").goto_definitions()
    end,
  })
  .implement({
    uuid = K.lsp.goto_implementations.uuid,
    action = function()
      require("era.action.lsp.reference").goto_implementations()
    end,
  })
  .implement({
    uuid = K.lsp.goto_references.uuid,
    action = function()
      require("era.action.lsp.reference").goto_references()
    end,
  })
  .implement({
    uuid = K.lsp.goto_type_definitions.uuid,
    action = function()
      require("era.action.lsp.reference").goto_type_definitions()
    end,
  })
  .implement({
  ...
  .implement({
    ...
    action = function()
      require("era.action.lsp.server").restart()
    end,
  })
  .implement({
    uuid = K.lsp.select_python_venv.uuid,
    action = function()
      require("era.action.lsp.python_venv").activate_venv()
    end,
  })
  ...
  .implement({
    ...
    action = function(args)
      if type(args) == "string" and #args > 0 then
        require("era.action.notepad").append_content(args)
      end
    end,
  })
  .implement({
    ...
    action = function()
      require("era.action.notepad").toggle()
    end,
  })
  .implement({
    uuid = K.notepad.show.uuid,
    action = function()
      require("era.action.notepad").show()
    end,
  })
  .implement({
    uuid = K.notepad.close.uuid,
    action = function()
      require("era.action.notepad").close()
    end,
  })
  .implement({
    uuid = K.notepad.save.uuid,
    action = function()
      require("era.action.notepad").save()
    end,
  })
  .implement({
    uuid = K.notepad.create.uuid,
    action = function()
      require("era.action.notepad").create()
    end,
  })
  .implement({
    uuid = K.notepad.destroy.uuid,
    action = function()
      require("era.action.notepad").destroy()
    end,
  })
  .implement({
    uuid = K.notepad.rename.uuid,
    action = function()
      require("era.action.notepad").rename()
    end,
  })
...
for index = 1, 9, 1 do
  ...
  command.implement({
    ...
    action = function()
      require("era.action.notepad").focus_index(index)
    end,
  })
end
...
for index = 1, 9, 1 do
  command.implement({
    ...
    action = function()
      require("era.action.notepad").focus_left(tostring(index))
    end,
  })
  command.implement({
    uuid = K.notepad["focus_right_" .. tostring(index)].uuid,
    action = function()
      require("era.action.notepad").focus_right(tostring(index))
    end,
  })
end
...
command
  .implement({
    ...
    action = function(args)
      require("era.action.notepad").focus_left(args)
    end,
  })
  .implement({
    uuid = K.notepad.focus_right.uuid,
    action = function(args)
      require("era.action.notepad").focus_right(args)
    end,
  })
  .implement({
    uuid = K.notepad.swap_left.uuid,
    action = function(args)
      require("era.action.notepad").swap_left(args)
    end,
  })
  .implement({
    uuid = K.notepad.swap_right.uuid,
    action = function(args)
      require("era.action.notepad").swap_right(args)
    end,
  })
  .implement({
    uuid = K.notepad.source_select.uuid,
    action = function()
      require("era.action.notepad").source_select()
    end,
  })
  .implement({
    uuid = K.notepad.note_select.uuid,
    action = function()
      require("era.action.notepad").note_select()
    end,
  })
  .implement({
    uuid = K.notepad.source_prev.uuid,
    action = function()
      require("era.action.notepad").source_prev()
    end,
  })
  .implement({
    uuid = K.notepad.source_next.uuid,
    action = function()
      require("era.action.notepad").source_next()
    end,
  })
  .implement({
    uuid = K.notepad.change_engine.uuid,
    action = function()
      require("era.action.notepad").change_engine()
    end,
  })
  .implement({
    uuid = K.notepad.go_backward.uuid,
    action = function()
      require("era.action.notepad").go_backward()
    end,
  })
  .implement({
    uuid = K.notepad.go_forward.uuid,
    action = function()
      require("era.action.notepad").go_forward()
    end,
  })
  .implement({
    uuid = K.notepad.split_h.uuid,
    action = function()
      require("era.action.notepad").split("h")
    end,
  })
  .implement({
    uuid = K.notepad.split_j.uuid,
    action = function()
      require("era.action.notepad").split("j")
    end,
  })
  .implement({
    uuid = K.notepad.split_k.uuid,
    action = function()
      require("era.action.notepad").split("k")
    end,
  })
  .implement({
    uuid = K.notepad.split_l.uuid,
    action = function()
      require("era.action.notepad").split("l")
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.session").restore()
    end,
  })
  .implement({
    uuid = K.session.restore_autosaved.uuid,
    action = function()
      require("era.action.session").restore_autosaved()
    end,
  })
  .implement({
    uuid = K.session.save.uuid,
    action = function()
      require("era.action.session").save()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.tab").close()
    end,
  })
  .implement({
    uuid = K.tab.close_to_leftest.uuid,
    action = function()
      require("era.action.tab").close_to_leftest()
    end,
  })
  .implement({
    uuid = K.tab.close_to_rightest.uuid,
    action = function()
      require("era.action.tab").close_to_rightest()
    end,
  })
  .implement({
    uuid = K.tab.close_others.uuid,
    action = function()
      require("era.action.tab").close_others()
    end,
  })
...
for i = 1, 10, 1 do
  command.implement({
    ...
    action = function()
      require("era.action.tab").focus(i)
    end,
  })
end
...
command
  .implement({
    ...
    action = function(args)
      ...
      if tabid ~= nil then
        require("era.action.tab").focus(tabid)
      end
    end,
  })
  .implement({
    ...
    action = function(args)
      local ok, step = pcall(tonumber, args)
      require("era.action.tab").focus_left(ok and step or nil)
    end,
  })
  .implement({
    ...
    action = function(args)
      local ok, step = pcall(tonumber, args)
      require("era.action.tab").focus_right(ok and step or nil)
    end,
  })
...
command
  .implement({
    uuid = K.tab.new.uuid,
    action = function()
      require("era.action.tab").new()
    end,
  })
  .implement({
    uuid = K.tab.new_with_buf.uuid,
    action = function()
      require("era.action.tab").new_with_buf()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.toggle.list").list("dressing_dim_flight")
    end,
  })
  .implement({
    uuid = K.toggle.expandtab.uuid,
    action = function()
      require("era.action.toggle.list").list("expandtab_ux")
    end,
  })
  .implement({
    uuid = K.toggle.indent.uuid,
    action = function()
      require("era.action.toggle.list").list("dressing_indent_flight")
    end,
  })
  .implement({
    uuid = K.toggle.list.uuid,
    action = function(arg)
      require("era.action.toggle.list").list(arg)
    end,
  })
  .implement({
    uuid = K.toggle.markdown.uuid,
    action = function()
      require("era.action.toggle.list").list("render_markdown_plugin")
    end,
  })
  .implement({
    uuid = K.toggle.markdown_local.uuid,
    action = function()
      require("era.action.toggle.list").list("markdown_local")
    end,
  })
  .implement({
    uuid = K.toggle.maximize.uuid,
    action = function()
      require("era.action.toggle.maximize").maximize()
    end,
  })
  .implement({
    uuid = K.toggle.number_local.uuid,
    action = function()
      require("era.action.toggle.list").list("number_local")
    end,
  })
  .implement({
    uuid = K.toggle.relativenumber.uuid,
    action = function()
      require("era.action.toggle.list").list("relativenumber_ux")
    end,
  })
  .implement({
    uuid = K.toggle.relativenumber_local.uuid,
    action = function()
      require("era.action.toggle.list").list("relativenumber_local")
    end,
  })
  .implement({
    uuid = K.toggle.scroll.uuid,
    action = function()
      require("era.action.toggle.list").list("dressing_scroll_flight")
    end,
  })
  .implement({
    uuid = K.toggle.signcolumn_local.uuid,
    action = function()
      require("era.action.toggle.list").list("signcolumn_local")
    end,
  })
  .implement({
    uuid = K.toggle.theme.uuid,
    action = function(arg)
      require("era.action.toggle.theme").theme(arg)
    end,
  })
  .implement({
    uuid = K.toggle.theme_variant.uuid,
    action = function()
      require("era.action.toggle.list").list("theme_variant_ux")
    end,
  })
  .implement({
    uuid = K.toggle.trailspace.uuid,
    action = function()
      require("era.action.toggle.list").list("dressing_trailspace_flight")
    end,
  })
  .implement({
    uuid = K.toggle.transparency.uuid,
    action = function()
      require("era.action.toggle.list").list("transparency_ux")
    end,
  })
  .implement({
    uuid = K.toggle.username.uuid,
    action = function()
      require("era.action.toggle.list").list("username_ux")
    end,
  })
  .implement({
    uuid = K.toggle.virtcolumn.uuid,
    action = function()
      require("era.action.toggle.list").list("dressing_virtcolumn_flight")
    end,
  })
  .implement({
    uuid = K.toggle.wrap_local.uuid,
    action = function()
      require("era.action.toggle.list").list("wrap_local")
    end,
  })
...
command
  ...
  .implement({
    ...
    action = function(arg)
      require("era.action.ux").reload_theme(arg)
    end,
  })
  .implement({
    uuid = K.ux.resume_last_widget.uuid,
    action = function()
      require("era.action.ux").resume_last_widget()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.win").close()
    end,
  })
  .implement({
    uuid = K.win.close_others.uuid,
    action = function()
      require("era.action.win").close_others()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.win").focus_top()
    end,
  })
  .implement({
    uuid = K.win.focus_right.uuid,
    action = function()
      require("era.action.win").focus_right()
    end,
  })
  .implement({
    uuid = K.win.focus_bottom.uuid,
    action = function()
      require("era.action.win").focus_bottom()
    end,
  })
  .implement({
    uuid = K.win.focus_left.uuid,
    action = function()
      require("era.action.win").focus_left()
    end,
  })
  .implement({
    uuid = K.win.focus_prev.uuid,
    action = function()
      require("era.action.win").focus_prev()
    end,
  })
  .implement({
    uuid = K.win.focus_next.uuid,
    action = function()
      require("era.action.win").focus_next()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.win_history").history()
    end,
  })
  .implement({
    uuid = K.win.history_backward.uuid,
    action = function()
      require("era.action.win_history").history_backward()
    end,
  })
  .implement({
    uuid = K.win.history_forward.uuid,
    action = function()
      require("era.action.win_history").history_forward()
    end,
  })
...
command.implement({
  ...
  action = function()
    require("era.action.win").mark_sourcefile()
  end,
})
...
command
  .implement({
    ...
    action = function()
      require("era.action.win").picker_focus()
    end,
  })
  .implement({
    uuid = K.win.project.uuid,
    action = function()
      require("era.action.win").picker_project()
    end,
  })
  .implement({
    uuid = K.win.swap.uuid,
    action = function()
      require("era.action.win").picker_swap()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.win").resize_horizontal_minus()
    end,
  })
  .implement({
    uuid = K.win.resize_horizontal_plus.uuid,
    action = function()
      require("era.action.win").resize_horizontal_plus()
    end,
  })
  .implement({
    uuid = K.win.resize_vertical_minus.uuid,
    action = function()
      require("era.action.win").resize_vertical_minus()
    end,
  })
  .implement({
    uuid = K.win.resize_vertical_plus.uuid,
    action = function()
      require("era.action.win").resize_vertical_plus()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.win").split_above()
    end,
  })
  .implement({
    uuid = K.win.split_right.uuid,
    action = function()
      require("era.action.win").split_right()
    end,
  })
  .implement({
    uuid = K.win.split_below.uuid,
    action = function()
      require("era.action.win").split_below()
    end,
  })
  .implement({
    uuid = K.win.split_left.uuid,
    action = function()
      require("era.action.win").split_left()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.plugin.nvim-treesitter").swap_conditional_branches()
    end,
  })
  .implement({
    uuid = K.code.swap_next_parameter.uuid,
    action = function()
      require("era.action.plugin.nvim-treesitter").swap_next_parameter()
    end,
  })
  .implement({
    uuid = K.code.swap_prev_parameter.uuid,
    action = function()
      require("era.action.plugin.nvim-treesitter").swap_prev_parameter()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("era.action.plugin.diffview").diffview()
    end,
  })
  .implement({
    uuid = K.git.history.uuid,
    action = function()
      require("era.action.plugin.diffview").history()
    end,
  })
  .implement({
    uuid = K.git.history_file.uuid,
    action = function()
      require("era.action.plugin.diffview").history_file()
    end,
  })
