...
command
  ...
  .implement({
    uuid = K.explorer.toggle.uuid,
    tabtypes = stl.e.TabTypeSet.DIFFVIEW_WORKSPACE,
    action = function()
      era.m.diffview.fn.toggle_files()
    end,
  })
  .implement({
    uuid = K.explorer.toggle.uuid,
    tabtypes = stl.e.TabTypeSet.DIFFVIEW_COMMITS,
    action = function()
      era.m.diffview.fn.toggle_commits()
    end,
  })
...
command
  ...
  .implement({
    ...
    action = function()
      ...
      era.m.lsp.illuminate.jump(-step, true)
    end,
  })
  .implement({
...
command
  ...
  .implement({
    ...
    tabtypes = stl.e.TabTypeSet.ALL,
    action = function()
      era.keystroke.textobject.swap_parameter(1)
    end,
  })
  .implement({
