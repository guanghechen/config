local __module_name__ = "era.tree" ---@type string

---@alias era.t.ITreeTraverseConditionalEnum
...
---@alias era.t.ITreeNodeSorter
---| fun(left: era.t.ITreeNode, right: era.t.ITreeNode): boolean

---@alias era.t.ITreeTraverseConditional
---| fun(ctx: era.t.ITreeTraverseContext, node: era.t.ITreeNode, cur: integer): era.t.ITreeTraverseConditionalEnum

---@alias era.t.ITreeTraverseHandler
---| fun(ctx: era.t.ITreeTraverseContext, node: era.t.ITreeNode, cur: integer, is_lastchild: boolean, onlychild: string|nil, childcount: integer): nil

---@alias era.t.ITreeTraverseRecursive
---| fun(ctx: era.t.ITreeTraverseContext, node: era.t.ITreeNode, cur: integer, is_lastchild: boolean): nil

---@alias era.t.ITreeQuickTraverseHandler
---| fun(ctx: era.t.ITreeTraverseContext, node: era.t.ITreeNode, cur: integer): nil

---@alias era.t.ITreeQuickTraverseRecursive
---| fun(ctx: era.t.ITreeTraverseContext, node: era.t.ITreeNode, cur: integer): nil

---@alias era.t.ITreeUnsafeTraverseCallback
---| fun(ctx: era.t.ITreeTraverseContext): nil

---@class era.t.ITreeTraverseContext
---@field public nodemap                table<string, era.t.ITreeNode>
---@field public rootnode               era.t.ITreeNode

---@class era.t.ITreeNode
...
---@class era.ITreeProps
---@field public fullname               string|nil
---@field public name                   string
---@field public node_sorter            era.t.ITreeNodeSorter
---@field public rootnodedata           unknown|nil

---@class era.IReadonlyTree
---@field public fullname               string
---@field public root                   string
---@field public isdisposed             fun(self: era.IReadonlyTree): boolean
---@field public isdescendant           fun(self: era.IReadonlyTree, ancestor: string, uuid: string): boolean
---@field public isexistent             fun(self: era.IReadonlyTree, uuid: string): boolean
---@field public retrieve               fun(self: era.IReadonlyTree, uuid: string): era.t.ITreeNode|nil
---@field public quick_traverse         fun(self: era.IReadonlyTree, root: string|nil, fn: era.t.ITreeQuickTraverseHandler, conditional: era.t.ITreeTraverseConditional|nil): era.IReadonlyTree
---@field public traverse               fun(self: era.IReadonlyTree, root: string|nil, fn: era.t.ITreeTraverseHandler, conditional: era.t.ITreeTraverseConditional|nil): era.IReadonlyTree
---@field public unsafe_traverse        fun(self: era.IReadonlyTree, root: string|nil, traverse: era.t.ITreeUnsafeTraverseCallback): era.IReadonlyTree
---@field public calc_include_uuid_set  fun(self: era.IReadonlyTree, uuids: string[]): table<string, boolean>

---@class era.ITree : era.IReadonlyTree
---@field public fullname               string
---@field public root                   string
---@field public clear                  fun(self: era.ITree): era.ITree
---@field public dispose                fun(self: era.ITree): nil
---@field public isdisposed             fun(self: era.ITree): boolean
---@field public isdescendant           fun(self: era.ITree, ancestor: string, uuid: string): boolean
---@field public isexistent             fun(self: era.ITree, uuid: string): boolean
---@field public retrieve               fun(self: era.ITree, uuid: string): era.t.ITreeNode|nil
---@field public quick_traverse         fun(self: era.ITree, root: string|nil, fn: era.t.ITreeQuickTraverseHandler, conditional: era.t.ITreeTraverseConditional|nil): era.ITree
---@field public traverse               fun(self: era.ITree, root: string|nil, fn: era.t.ITreeTraverseHandler, conditional: era.t.ITreeTraverseConditional|nil): era.ITree
---@field public unsafe_traverse        fun(self: era.ITree, root: string|nil, traverse: era.t.ITreeUnsafeTraverseCallback): era.ITree
---@field public calc_include_uuid_set  fun(self: era.ITree, uuids: string[]): table<string, boolean>
---@field public empty                  fun(self: era.ITree, uuid: string): era.ITree
---@field public insert                 fun(self: era.ITree, parent: string, uuid: string, data: table|nil): era.t.ITreeNode
---@field public remove                 fun(self: era.ITree, uuid: string): era.ITree

---@class era.Tree : era.ITree
---@field public fullname               string
---@field public root                   string
---@field public node_sorter            era.t.ITreeNodeSorter
---@field protected _disposed           boolean
---@field protected _nodemap            table<string, era.t.ITreeNode>
---@field protected _rootnode           era.t.ITreeNode
local M = {}
M.__index = M

---@param props                         era.ITreeProps
---@return era.Tree
function M.new(props)
  ...
  ---@type table<string, era.t.ITreeNode>
  local nodemap = {
    [uuid_root] = noderoot,
  }
...
function M:clear()
  ...
  local rootnode = self._rootnode ---@type era.t.ITreeNode
  for _, childuuid in ipairs(rootnode.children) do
    local child = nodemap[childuuid] ---@type era.t.ITreeNode
...
function M:isdescendant(ancestor, uuid)
  ...
  local node = nodemap[uuid] ---@type era.t.ITreeNode|nil
  local node_ancestor = nodemap[ancestor] ---@type era.t.ITreeNode|nil
  ...
  for _ = 1, distance, 1 do
    node = nodemap[node.parent] ---@type era.t.ITreeNode
  end
...
---@param uuid                          string
---@return era.t.ITreeNode|nil
function M:retrieve(uuid)
  self:__health__()
  return self._nodemap[uuid] ---@type era.t.ITreeNode|nil
end

---@param root                          string
---@param fn                            era.t.ITreeQuickTraverseHandler
---@param conditional                   ?era.t.ITreeTraverseConditional
---@return era.Tree
function M:quick_traverse(root, fn, conditional)
  self:__health__()

  local nodemap = self._nodemap ---@type table<string, era.t.ITreeNode>
  local recursive ---@type era.t.ITreeQuickTraverseRecursive
  local rootnode = root and nodemap[root] or self._rootnode ---@type era.t.ITreeNode

  if conditional == nil then
    ---@type era.t.ITreeQuickTraverseRecursive
    ...
    ---@type era.t.ITreeQuickTraverseRecursive
    recursive = function(ctx, node, cur)
      local condition = conditional(ctx, node, cur) ---@type era.t.ITreeTraverseConditionalEnum
  ...
  if rootnode == self._rootnode then
    ...
    for _, childuuid in ipairs(rootnode.children) do
      ...
      local ctx = { nodemap = nodemap, rootnode = childnode } ---@type era.t.ITreeTraverseContext
      recursive(ctx, childnode, 1)
    end
  else
    local ctx = { nodemap = nodemap, rootnode = rootnode } ---@type era.t.ITreeTraverseContext
...
---@param root                          string
---@param fn                            era.t.ITreeTraverseHandler
---@param conditional                   ?era.t.ITreeTraverseConditional
---@return era.Tree
function M:traverse(root, fn, conditional)
  ...
  local nodemap = self._nodemap ---@type table<string, era.t.ITreeNode>
  local recursive ---@type era.t.ITreeTraverseRecursive

  if conditional == nil then
    ---@type era.t.ITreeTraverseRecursive
    ...
    recursive = function(ctx, node, cur, is_lastchild)
      ...
      for index, childuuid in ipairs(node.children) do
        local child = nodemap[childuuid] ---@type era.t.ITreeNode
        local child_condition = conditional(ctx, child, next_cur) ---@type era.t.ITreeTraverseConditionalEnum
  ...
  local rootnode = nodemap[root] or self._rootnode ---@type era.t.ITreeNode
  if rootnode == self._rootnode then
    if rootnode.dirty_co then
      self:__sort_children__(rootnode)
    end
...
---@param traverse                      era.t.ITreeUnsafeTraverseCallback
---@return era.Tree
...
function M:insert(parent, uuid, data)
  ...
  local node_parent = parent ~= uuid and nodemap[parent] or self._rootnode ---@type era.t.ITreeNode
  ...
  if node == nil then
    ...
    local old_node_parent = nodemap[node.parent] ---@type era.t.ITreeNode
...
function M:print(rootuuid)
  ...
  local nodemap = self._nodemap ---@type table<string, era.t.ITreeNode>
  local rootnode = rootuuid and nodemap[rootuuid] or self._rootnode ---@type era.t.ITreeNode
...
function M:remove(nodeuuid)
  ...
  local nodemap = self._nodemap ---@type table<string, era.t.ITreeNode>
  local node = nodemap[nodeuuid] ---@type era.t.ITreeNode|nil
  if node == nil then
    ark.reporter.error({
      from = self.fullname,
      subject = "remove",
  ...
  local node_parent = nodemap[node.parent] ---@type era.t.ITreeNode
...
function M:__remove_recursive__(node)
  local nodemap = self._nodemap ---@type table<string, era.t.ITreeNode>
  for _, childuuid in ipairs(node.children) do
    local child = nodemap[childuuid] ---@type era.t.ITreeNode|nil
    if child ~= nil then
      self:__remove_recursive__(child)
    end
  end
...
function M:__resolve_depth_recursive__(node, depth)
  node.depth = depth
  for _, childuuid in ipairs(node.children) do
    local child = self._nodemap[childuuid] ---@type era.t.ITreeNode
...
function M:__sort_children__(node)
  ...
  if #node.children > 1 then
    local nodemap = self._nodemap ---@type table<string, era.t.ITreeNode>
    local node_sorter = self.node_sorter ---@type era.t.ITreeNodeSorter
    table.sort(node.children, function(left_uuid, right_uuid)
      local left = nodemap[left_uuid] ---@type era.t.ITreeNode
      local right = nodemap[right_uuid] ---@type era.t.ITreeNode
