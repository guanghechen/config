local Git = require("era.plugin.git")
local State = require("era.plugin.state")

---@class era.plugin.action
local M = {}

---@type table<string, era.plugin.ITaskState>
M._tasks = {}
...
---@return table<string, era.plugin.ITaskState>
...
function M.update(on_progress, on_done)
  ...
  local specs = State.specs ---@type era.plugin.IPluginSpec[]
  State.load_lock()
...
---@param callback                      fun(commits: era.plugin.ICommitInfo[]): nil
---@return nil
function M.__fetch_commits__(path, from_commit, to_commit, callback)
  ...
  vim.system({ "git", unpack(args) }, { cwd = path, text = true }, function(result)
    vim.schedule(function()
      local commits = {} ---@type era.plugin.ICommitInfo[]
...
---@param name                          string
---@param callback                      fun(task: era.plugin.ITaskState): nil
---@return boolean
...
function M.__update_plugins__(specs, on_progress, on_done)
  ...
  ---@type table<string, era.plugin.ILockEntry>
  local new_lock = {}
