---@class era.plugin.state
---@field public options                era.plugin.IConfig
---@field public specs                  era.plugin.IPluginSpec[]
---@field public lock                   table<string, era.plugin.ILockEntry>
...
function M.update_lock(plugins)
  ...
  for n, name in ipairs(names) do
    local info = plugins[name] ---@type era.plugin.ILockEntry
...
---@param name                          string
---@return era.plugin.ILockEntry|nil
...
function M.remove_orphan_lock_entries()
  ...
  local new_lock = {} ---@type table<string, era.plugin.ILockEntry>
