...
---@class era.plugin.Widget
---@field public padding                integer
---@field public wrap                   integer
---@field protected _view               era.plugin.View
---@field protected _lines              era.plugin.ITextSegment[][]
---@field protected _required_by        table<string, string[]>
local M = {}
M.__index = M

---@param view                          era.plugin.View
---@return era.plugin.Widget
function M.new(view)
...
function M:update()
  ...
  local mode = self._view.state.mode ---@type era.plugin.ViewModeEnum
...
function M:__build_required_by__()
  self._required_by = {}
  local Loader = require("era.plugin.loader")
  local plugins = Loader.get_all() ---@type table<string, era.plugin.IPluginState>

  for _, state in pairs(plugins) do
    local spec = state.spec ---@type era.plugin.IPluginSpec
...
---@param spec                          era.plugin.IPluginSpec
---@return nil
...
---@param state                         era.plugin.IPluginState
...
---@return era.plugin.IPluginState[], era.plugin.IPluginState[]
function M:__collect_plugins__()
  local Loader = require("era.plugin.loader")
  local plugins = Loader.get_all() ---@type table<string, era.plugin.IPluginState>

  local loaded = {} ---@type era.plugin.IPluginState[]
  local not_loaded = {} ---@type era.plugin.IPluginState[]
...
function M:__update__()
  local Action = require("era.plugin.action")
  local Loader = require("era.plugin.loader")
  local tasks = Action.get_tasks() ---@type table<string, era.plugin.ITaskState>
  ...
  local updated = {} ---@type era.plugin.ITaskState[]
  local unchanged = {} ---@type era.plugin.ITaskState[]
  local errors = {} ---@type era.plugin.ITaskState[]
...
---@param task                          era.plugin.ITaskState
---@return nil
...
---@param task                          era.plugin.ITaskState
---@param plugin_state                  era.plugin.IPluginState|nil
---@return nil
...
---@param commit                        era.plugin.ICommitInfo
---@return nil
