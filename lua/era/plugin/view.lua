...
local Widget = require("era.plugin.widget")

---@class era.plugin.IViewState
---@field public mode                   era.plugin.ViewModeEnum

---@class era.plugin.View : dot.t.IWidget
---@field public name                   string
---@field public bufnr                  integer|nil
---@field public winnr                  integer|nil
---@field public win_opts               vim.api.keyset.win_config
---@field public state                  era.plugin.IViewState
---@field public widget                 era.plugin.Widget
---@field protected _augroup            integer|nil
---@field protected _disposed           boolean
local M = {}
M.__index = M

---@type era.plugin.View|nil
local _instance = nil
