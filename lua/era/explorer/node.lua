---@class era.explorer.Node : era.explorer.resource.INode
---@field public uri                    string
---@field public nodename               string
---@field public nodetype               era.explorer.NodeTypeEnum
---@field public parent                 era.explorer.Node|nil
---@field public children               era.explorer.Node[]
...
---@param nodetype                      era.explorer.NodeTypeEnum
---@return string
...
---@param new_parent                    era.explorer.Node
...
function M.clone(node, new_parent)
  ...
  if node.nodetype == "D" and #node.children > 0 then
    for i, child in ipairs(node.children) do
      local cloned_child = M.clone(child, self) ---@type era.explorer.Node
...
function M.collect_selected(root)
  ...
  local result = {} ---@type era.explorer.Node[]
...
---@param parent                        era.explorer.Node
---@param nodetype                      era.explorer.NodeTypeEnum
---@param nodename                      string
---@return era.explorer.Node
...
function M:is_ancestor_of(node)
  ...
  local o = node.parent ---@type era.explorer.Node|nil
...
function M:is_descendant_of(root)
  ...
  local o = self.parent ---@type era.explorer.Node|nil
  while o ~= nil and o.depth >= depth do
...
function M.sync_ancestors(node)
  ...
  local p = node.parent ---@type era.explorer.Node|nil
...
function M:sync_chidxmap(start_idx)
  local children = self.children ---@type era.explorer.Node[]
  local chidxmap = self.chidxmap ---@type table<string, integer|nil>
  for i = start_idx, #children do
    local child = children[i] ---@type era.explorer.Node
