...
---@class era.colorpicker.mode
---@field public input                  era.colorpicker.mode.input
---@field public output                 era.colorpicker.mode.output
local M = {}

---@class era.colorpicker.mode.input
M.input = {
  ---@type era.colorpicker.IInputMode
  hex = {
    name = "HEX",
    bar_name = { "R", "G", "B" },
    max = { 255, 255, 255 },
...
---@class era.colorpicker.mode.output
M.output = {
  ---@type era.colorpicker.IOutputMode
  hex = {
    name = "HEX",
