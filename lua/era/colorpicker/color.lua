...
local mode = require("era.colorpicker.mode")
...
---@param name                          era.colorpicker.InputModeName|nil
---@return integer
...
---@param name                          era.colorpicker.OutputModeName|nil
---@return integer
...
---@return era.colorpicker.IInputMode
function M:input()
  local name = dot.context.colorpicker.get_input_mode() ---@type era.colorpicker.InputModeName|nil
  local idx = get_input_idx(name) ---@type integer
  return INPUTS[idx]
end

---@return era.colorpicker.IOutputMode
function M:output()
  local name = dot.context.colorpicker.get_output_mode() ---@type era.colorpicker.OutputModeName|nil
