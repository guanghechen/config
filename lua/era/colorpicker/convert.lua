...
function M.rgb2hsl(r, g, b)
  local h, s, l = stl.color.rgb2hsl(r, g, b)
...
function M.hsl2rgb(h, s, l)
  local r, g, b = stl.color.hsl2rgb(h, s / 100, l / 100)
...
function M.hex_stringify(r, g, b)
  return stl.color.rgb2hex(r, g, b)
end
