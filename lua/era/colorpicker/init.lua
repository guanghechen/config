local convert = require("era.colorpicker.convert")
local Color = require("era.colorpicker.color")
local UI = require("era.colorpicker.ui")
local picker = require("era.colorpicker.picker")

local WIN_HIGHLIGHT = "FloatBorder:m_cp_border,Normal:m_cp_normal,EndOfBuffer:m_cp_normal"

---@class era.colorpicker.IProps : era.colorpicker.ui.IProps

---@class era.colorpicker.ColorPicker : dot.t.IWidget
---@field public name                   string
---@field protected _ui                 era.colorpicker.UI
---@field protected _color              era.colorpicker.Color
---@field protected _range              integer[]|nil
---@field protected _source_bufnr       integer|nil
---@field protected _history_index      integer
---@field protected _saved_color        era.colorpicker.Color|nil
...
---@param props                         era.colorpicker.IProps|nil
---@return era.colorpicker.ColorPicker
...
---@type era.colorpicker.ColorPicker|nil
local _instance = nil
...
---@protected
---@param source                        era.colorpicker.Color
---@return nil
...
---@protected
---@param value                         integer
---@param point                         era.colorpicker.IPoint
---@return nil
