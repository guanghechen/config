...
local __module_name__ = "era.picker.composer.filetree" ---@type string

---@alias era.picker.composer.filetree.IOnAttached
---| fun(self: era.picker.FiletreeComposer, rootpath: string): nil

---@alias era.picker.composer.filetree.IOnClosed
---| fun(self: era.picker.FiletreeComposer): nil

---@alias era.picker.composer.filetree.IOnConfirm
---| fun(self: era.picker.FiletreeComposer, selected_filepaths: string[]|nil): nil

---@alias era.picker.composer.filetree.IOnDisposed
---| fun(): nil

---@alias era.picker.composer.filetree.IOnFocused
---| fun(self: era.picker.FiletreeComposer): nil

---@alias era.picker.composer.filetree.IOnHidden
---| fun(self: era.picker.FiletreeComposer): nil
---
---@alias era.picker.composer.filetree.IOnRefresh
---| fun(self: era.picker.FiletreeComposer, force: boolean): nil

---@alias era.picker.composer.filetree.IOnResultRendered
---| fun(self: era.picker.FiletreeComposer, bufnr: integer): nil

---@alias era.picker.composer.filetree.IOnPreviewRendered
---| fun(self: era.picker.FiletreeComposer, bufnr: integer): nil

---@class era.picker.composer.filetree.ISelectedItemLocation
---@field public lnum                   integer
---@field public col                    integer|nil

---@class era.picker.composer.filetree.actions
...
---@class era.picker.IFiletreeComposerProps
...
---@field public flags_append           era.picker.result.IFlagItemRaw[]|nil
---@field public flags_prepend          era.picker.result.IFlagItemRaw[]|nil
...
---
---@field public on_attached            ?era.picker.composer.filetree.IOnAttached
---@field public on_closed              ?era.picker.composer.filetree.IOnClosed
---@field public on_confirm             ?era.picker.composer.filetree.IOnConfirm
---@field public on_disposed            ?era.picker.composer.filetree.IOnDisposed
---@field public on_focused             ?era.picker.composer.filetree.IOnFocused
---@field public on_hidden              ?era.picker.composer.filetree.IOnHidden
---@field public on_refresh             ?era.picker.composer.filetree.IOnRefresh
---@field public on_preview_rendered    ?era.picker.composer.filetree.IOnPreviewRendered
---@field public on_result_rendered     ?era.picker.composer.filetree.IOnResultRendered

---@class era.picker.FiletreeComposer
---@field public uuid                   string
...
---
---@field protected _on_attached        era.picker.composer.filetree.IOnAttached
---@field protected _on_confirm         era.picker.composer.filetree.IOnConfirm|nil
---@field protected _on_disposed        era.picker.composer.filetree.IOnDisposed
---@field protected _observer_unsubs    stl.c.IUnsubscribable[]|nil
local M = {}
M.__index = M

---@param props                         era.picker.IFiletreeComposerProps
---@return era.picker.FiletreeComposer
function M.new(props)
  ...
  local flags_append = props.flags_append ---@type era.picker.result.IFlagItemRaw[]|nil
  local flags_prepend = props.flags_prepend ---@type era.picker.result.IFlagItemRaw[]|nil
  local flags_start_index = props.flags_start_index ---@type 0|1|nil

  local frecency = props.frecency ---@type stl.c.Frecency|nil

  local on_attached = props.on_attached or stl.fn.noop ---@type era.picker.composer.filetree.IOnAttached
  local on_closed = props.on_closed or stl.fn.noop ---@type era.picker.composer.filetree.IOnClosed
  local on_confirm = props.on_confirm ---@type era.picker.composer.filetree.IOnConfirm|nil
  local on_disposed = props.on_disposed or stl.fn.noop ---@type era.picker.composer.filetree.IOnDisposed
  local on_focused = props.on_focused or stl.fn.noop ---@type era.picker.composer.filetree.IOnFocused
  local on_hidden = props.on_hidden or stl.fn.noop ---@type era.picker.composer.filetree.IOnHidden
  local _on_refresh = props.on_refresh or stl.fn.noop ---@type era.picker.composer.filetree.IOnRefresh
  local on_result_rendered = props.on_result_rendered or stl.fn.noop ---@type era.picker.composer.filetree.IOnResultRendered
  local on_preview_rendered = props.on_preview_rendered or stl.fn.noop ---@type era.picker.composer.filetree.IOnPreviewRendered
  ...
  ---@type era.picker.FiletreeView
  local treeview = era.picker.FiletreeView.new({
    name = fullname,
    tree = filetree,
  ...
  ---@type era.picker.composer.filetree.IOnRefresh
  ...
  local flags = {} ---@type era.picker.result.IFlagItemRaw[]
  do
  ...
  ---@type era.picker.composer.filetree.actions
  local actions = {
    attach_node = function()
      ...
      local nodestate = treeview:retrieve(nodeuuid) ---@type era.picker.view.filetree.INodeState|nil
      ...
      for lnum = 1, linecount, 1 do
        ...
        if uuid ~= nil then
          ...
          if node ~= nil and node.data.filetype == "file" then
            ...
            local nodestate = treeview:retrieve(uuid) ---@type era.picker.view.filetree.INodeState|nil
            local locations = nodestate and nodestate.locations or nil ---@type era.picker.view.filetree.ILocationNodeState[]|nil
    ...
    toggle_selection = function()
      ...
      for lnum = lnum_from, lnum_to, 1 do
        local nodeuuid = retriever:retrieve_uuid(lnum) ---@type string|nil
        if nodeuuid ~= nil then
          local childstate = treeview:retrieve(nodeuuid) ---@type era.picker.view.filetree.INodeState|nil
  ...
  if preview and render_preview == nil then
    ---@type era.picker.preview.IDraw|nil
    render_preview = function(bufnr, force)
      return self:render_preview(bufnr, force)
    end
  end

  local composer = era.picker.BasicComposer.new({
    uuid = picker_uuid,
    name = fullname,
    permanent = permanent,
    ...
    ---@type era.picker.result.IIsSelected
    ...
    render_result = function(bufnr)
      ...
      local ret = { lnum_current = lnum_current } ---@type era.picker.result.IDrawResult
      return ret
    end,
...
---@param bufnr                         integer
---@param force                         boolean
---@return era.picker.preview.IDrawResult
function M:render_preview(bufnr, force)
  ...
  if nodestate.nodetype == "container" then
    ...
    ---@cast nodestate          era.picker.view.filetree.IDirectoryNodeState
    ---@type era.picker.preview.IDrawResult
    local result = {
      cursorline = true,
      number = true,
  ...
  ---@cast nodestate          era.picker.view.filetree.IFileNodeState|era.picker.view.filetree.ILocationNodeState
...
function M:__match__(input)
  ...
  if frecency ~= nil then
    table.sort(uuids_order, function(a, b)
      ...
      ---@cast na                       era.picker.view.filetree.IFileNodeState
      ---@cast nb                       era.picker.view.filetree.IFileNodeState
...
function M:__open_node__(nodeuuid)
  ...
  if self:__has_selected_node__() then
    local linecount = retriever:linecount() ---@type integer
    local last_nodestate = nil ---@type era.picker.view.filetree.IFileNodeState|nil
      ...
      if uuid ~= nil then
        ...
        if isselected then
          ...
          if o ~= nil and o.data.filetype == "file" then
            ...
            local s = treeview:retrieve(nodeuuid) ---@type era.picker.view.filetree.INodeState|nil
            if s ~= nil then
              ---@cast s                      era.picker.view.filetree.IFileNodeState
              last_nodestate = s
            end
          end
        end
    ...
    if #filepaths > 0 then
      ---@cast last_nodestate             era.picker.view.filetree.IFileNodeState
      local locations = last_nodestate.locations
      local first_location = locations ~= nil and locations[1] or nil ---@type era.picker.view.filetree.ILocationNodeState|nil
...
---@return era.picker.view.filetree.INodeState
function M:__retrieve__(nodeuuid)
  ---@type era.picker.view.filetree.INodeState|nil
...
function M:__retrieve_filenode__()
  ...
  local nodestate = self._treeview:retrieve(nodeuuid) ---@type era.picker.view.filetree.INodeState|nil
  if nodestate == nil then
    return
  end
