...
local __module_name__ = "era.picker.composer.list" ---@type string

---@alias era.picker.composer.list.IOnCancel
---| fun(self: era.picker.ListComposer): nil

---@alias era.picker.composer.list.IOnClosed
---| fun(self: era.picker.ListComposer): nil

---@alias era.picker.composer.list.IOnConfirm
---| fun(self: era.picker.ListComposer, item: era.picker.composer.list.IItem|nil): nil

---@alias era.picker.composer.list.IOnDisposed
---| fun(): nil

---@alias era.picker.composer.list.IOnFocused
---| fun(self: era.picker.ListComposer): nil

---@alias era.picker.composer.list.IOnHidden
---| fun(self: era.picker.ListComposer): nil

---@alias era.picker.composer.list.IOnRefresh
---| fun(self: era.picker.ListComposer, force: boolean): nil

---@alias era.picker.composer.list.IRenderPreview
---| fun(self: era.picker.ListComposer, bufnr: integer, force: boolean): era.picker.preview.IDrawResult

---@alias era.picker.composer.list.IRenderResult
---| fun(self: era.picker.ListComposer, bufnr: integer, itemmap: table<string, era.picker.composer.list.IItem>, matches: dot.t.IScoredMatch[]): era.picker.composer.list.IRenderResultData

---@class era.picker.composer.list.IItem
---@field public uuid                   string
---@field public text                   string
---@field public text_lower             string
---@field public highlights             stl.t.IHighlightInline[]

---@class era.picker.composer.list.IResetData
---@field public items                  era.picker.composer.list.IItem[]
---@field public uuid_present           string|nil
---@field public uuid_current           string|nil

---@class era.picker.composer.list.IRenderResultData
---@field public uuids                  string[]

----------------------------------------------------------------------------------------------------

---@class era.picker.IListComposerProps
---@field public uuid                   ?string
...
---
---@field public render_preview         ?era.picker.composer.list.IRenderPreview
---@field public render_result          ?era.picker.composer.list.IRenderResult
---
---@field public on_cancel              ?era.picker.composer.list.IOnCancel
---@field public on_closed              ?era.picker.composer.list.IOnClosed
---@field public on_confirm             ?era.picker.composer.list.IOnConfirm
---@field public on_disposed            ?era.picker.composer.list.IOnDisposed
---@field public on_focused             ?era.picker.composer.list.IOnFocused
---@field public on_hidden              ?era.picker.composer.list.IOnHidden
---@field public on_refresh             ?era.picker.composer.list.IOnRefresh

---@class era.picker.ListComposer
---@field public uuid                   string
...
---@field protected _items              era.picker.composer.list.IItem[]
---@field protected _itemmap            table<string, era.picker.composer.list.IItem>
...
---
---@field protected _on_confirm         era.picker.composer.list.IOnConfirm|nil
---@field protected _on_disposed        era.picker.composer.list.IOnDisposed
---@field protected _observer_unsubs    stl.c.IUnsubscribable[]|nil
local M = {}
M.__index = M
---@param props                         era.picker.IListComposerProps
...
function M.new(props)
  ...
  local on_cancel = props.on_cancel or stl.fn.noop ---@type era.picker.composer.list.IOnCancel
  local on_closed = props.on_closed or stl.fn.noop ---@type era.picker.composer.list.IOnClosed
  local on_confirm = props.on_confirm ---@type era.picker.composer.list.IOnConfirm|nil
  local on_disposed = props.on_disposed or stl.fn.noop ---@type era.picker.composer.list.IOnDisposed
  local on_focused = props.on_focused or stl.fn.noop ---@type era.picker.composer.list.IOnFocused
  local on_hidden = props.on_hidden or stl.fn.noop ---@type era.picker.composer.list.IOnHidden
  local on_refresh = props.on_refresh or stl.fn.noop ---@type era.picker.composer.list.IOnRefresh
  ...
  ---@type era.picker.composer.list.IRenderPreview|nil
  ...
  local actions = {
    on_confirm = function()
      if on_confirm ~= nil then
        ...
        local item = uuid and self._itemmap[uuid] or nil ---@type era.picker.composer.list.IItem|nil
...
function M:dispose()
  ...
  local on_disposed = self._on_disposed ---@type era.picker.composer.list.IOnDisposed
...
---@param lnum                          integer
---@return era.picker.composer.list.IItem|nil
...
---@param data                          era.picker.composer.list.IResetData
---@return era.picker.ListComposer
function M:reset_data(data)
  self:__health__()

  local items = data.items ---@type era.picker.composer.list.IItem[]
  local lnum_total = #items ---@type integer
  local itemmap = {} ---@type table<string, era.picker.composer.list.IItem>
