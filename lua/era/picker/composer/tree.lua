...
local __module_name__ = "era.picker.composer.tree" ---@type string

---@alias era.picker.composer.tree.IOnAttached
---| fun(self: era.picker.TreeComposer, rootuuid: string): nil

---@alias era.picker.composer.tree.IOnClosed
---| fun(self: era.picker.TreeComposer): nil

---@alias era.picker.composer.tree.IOnConfirm
---| fun(self: era.picker.TreeComposer, uuids: string[]|nil): nil

---@alias era.picker.composer.tree.IOnDisposed
---| fun(): nil

---@alias era.picker.composer.tree.IOnEnter
---| fun(self: era.picker.TreeComposer, nodeuuid: string): boolean

---@alias era.picker.composer.tree.IOnFocused
---| fun(self: era.picker.TreeComposer): nil

---@alias era.picker.composer.tree.IOnHidden
---| fun(self: era.picker.TreeComposer): nil
---
---@alias era.picker.composer.tree.IOnRefresh
---| fun(self: era.picker.TreeComposer, force: boolean): nil

---@class era.picker.composer.tree.actions
...
---@class era.picker.ITreeComposerProps
...
---@field public render_listview_leaf   era.picker.view.tree.IListviewLeafNodeRenderer
---@field public render_listview_location   era.picker.view.tree.IListviewLeafLocationRenderer
---@field public render_treeview_container  era.picker.view.tree.ITreeviewContainerNodeRenderer
---@field public render_treeview_leaf   era.picker.view.tree.ITreeviewLeafNodeRenderer
---@field public render_treeview_location   era.picker.view.tree.ITreeviewLeafLocationRenderer
---
---@field public on_attached            ?era.picker.composer.tree.IOnAttached
---@field public on_closed              ?era.picker.composer.tree.IOnClosed
---@field public on_confirm             ?era.picker.composer.tree.IOnConfirm
---@field public on_disposed            ?era.picker.composer.tree.IOnDisposed
---@field public on_enter               ?era.picker.composer.tree.IOnEnter
---@field public on_focused             ?era.picker.composer.tree.IOnFocused
---@field public on_hidden              ?era.picker.composer.tree.IOnHidden
---@field public on_refresh             ?era.picker.composer.tree.IOnRefresh

---@class era.picker.TreeComposer
---@field public uuid                   string
...
---@field protected _treeview           era.picker.TreeView
---
...
---
---@field protected _on_attached        era.picker.composer.tree.IOnAttached
---@field protected _on_confirm         era.picker.composer.tree.IOnConfirm
---@field protected _on_disposed        era.picker.composer.tree.IOnDisposed
---@field protected _on_enter           era.picker.composer.tree.IOnEnter|nil
---@field protected _observer_unsubs    stl.c.IUnsubscribable[]|nil
local M = {}
M.__index = M

---@param props                         era.picker.ITreeComposerProps
---@return era.picker.TreeComposer
function M.new(props)
  ...
  local render_listview_leaf = props.render_listview_leaf ---@type era.picker.view.tree.IListviewLeafNodeRenderer
  local render_listview_location = props.render_listview_location ---@type era.picker.view.tree.IListviewLeafLocationRenderer
  local render_treeview_container = props.render_treeview_container ---@type era.picker.view.tree.ITreeviewContainerNodeRenderer
  local render_treeview_leaf = props.render_treeview_leaf ---@type era.picker.view.tree.ITreeviewLeafNodeRenderer
  local render_treeview_location = props.render_treeview_location ---@type era.picker.view.tree.ITreeviewLeafLocationRenderer

  local on_attached = props.on_attached or stl.fn.noop ---@type era.picker.composer.tree.IOnAttached
  local on_closed = props.on_closed or stl.fn.noop ---@type era.picker.composer.tree.IOnClosed
  local on_confirm = props.on_confirm or stl.fn.noop ---@type era.picker.composer.tree.IOnConfirm
  local on_disposed = props.on_disposed or stl.fn.noop ---@type era.picker.composer.tree.IOnDisposed
  local on_enter = props.on_enter ---@type era.picker.composer.tree.IOnEnter|nil
  local on_focused = props.on_focused or stl.fn.noop ---@type era.picker.composer.tree.IOnFocused
  local on_hidden = props.on_hidden or stl.fn.noop ---@type era.picker.composer.tree.IOnHidden
  local on_refresh = props.on_refresh or stl.fn.noop ---@type era.picker.composer.tree.IOnRefresh
  ...
  ---@type era.picker.TreeView
  local treeview = era.picker.TreeView.new({
    name = fullname,
    tree = tree,
  ...
  ---@type era.picker.composer.tree.actions
  local actions = {
    attach_node = function()
      local nodeuuid = self:__retrieve_nodeuuid__() ---@type string|nil
      if nodeuuid ~= nil then
        local nodestate = treeview:retrieve(nodeuuid) ---@type stl.view.tree.INodeState|nil
    ...
    toggle_selection = function()
      ...
      for lnum = lnum_from, lnum_to, 1 do
        local nodeuuid = retriever:retrieve_uuid(lnum) ---@type string|nil
        if nodeuuid ~= nil then
          local childstate = treeview:retrieve(nodeuuid) ---@type stl.view.tree.INodeState|nil
...
function M:dispose()
  ...
  local on_dispose = self._on_disposed ---@type era.picker.composer.tree.IOnDisposed
  ...
  local treeview = self._treeview ---@type era.picker.TreeView
...
---@return stl.view.tree.INodeState
function M:__retrieve__(nodeuuid)
  ---@type stl.view.tree.INodeState|nil
...
function M:__retrieve_lnum_parent__(nodeuuid)
  ...
  local nodestate = self._treeview:retrieve(nodeuuid) ---@type stl.view.tree.INodeState|nil
  if nodestate == nil then
    return nil
  end
