...
local __module_name__ = "era.picker.view.filetree" ---@type string

---@alias era.picker.view.filetree.INodeState
---| era.picker.view.filetree.IDirectoryNodeState
---| era.picker.view.filetree.IFileNodeState
---| era.picker.view.filetree.ILocationNodeState

---@alias era.picker.view.filetree.IListviewFileRenderer
---| fun(ctx: era.picker.view.filetree.IListviewRendererContext, node: stl.c.IFiletreeNode, nodestate: era.picker.view.filetree.IFileNodeState, lnum: integer): stl.view.tree.INodeRenderResult

---@alias era.picker.view.filetree.IListviewLocationRenderer
---| fun(ctx: era.picker.view.filetree.IListviewRendererContext, node: stl.c.IFiletreeNode, nodestate: era.picker.view.filetree.IFileNodeState, locationstate: era.picker.view.filetree.ILocationNodeState, lnum: integer): stl.view.tree.INodeRenderResult

---@alias era.picker.view.filetree.ITreeviewDirectoryRenderer
---| fun(ctx: era.picker.view.filetree.ITreeviewRendererContext, node: stl.c.IFiletreeNode, nodestate: era.picker.view.filetree.IDirectoryNodeState, lnum: integer, folded_depth: integer): stl.view.tree.INodeRenderResult

---@alias era.picker.view.filetree.ITreeviewFileRenderer
---| fun(ctx: era.picker.view.filetree.ITreeviewRendererContext, node: stl.c.IFiletreeNode, nodestate: era.picker.view.filetree.IFileNodeState, lnum: integer): stl.view.tree.INodeRenderResult

---@alias era.picker.view.filetree.ITreeviewLocationRenderer
---| fun(ctx: era.picker.view.filetree.ITreeviewRendererContext, node: stl.c.IFiletreeNode, nodestate: era.picker.view.filetree.IFileNodeState, locationstate: era.picker.view.filetree.ILocationNodeState, lnum: integer): stl.view.tree.INodeRenderResult

---@class era.picker.view.filetree.IDirectoryNodeState : stl.view.tree.IContainerNodeState

---@class era.picker.view.filetree.IFileNodeState : stl.view.tree.ILeafNodeState
---@field public locations              era.picker.view.filetree.ILocationNodeState|nil
---@field public cache_match            era.picker.view.filetree.INodeMatchResultCache|nil

---@class era.picker.view.filetree.ILocationNodeState : stl.view.tree.ILeafLocationState
...
---@class era.picker.view.filetree.IListviewRendererContext : stl.view.tree.IListviewRendererContext
---@field public rootnode               stl.c.IFiletreeNode
---@field public rootstate              era.picker.view.filetree.IDirectoryNodeState
---@field public tree                   stl.c.IReadonlyFiletree
---@field public view                   era.picker.FiletreeView

---@class era.picker.view.filetree.ITreeviewRendererContext : stl.view.tree.IListviewRendererContext
---@field public rootnode               stl.c.IFiletreeNode
---@field public rootstate              era.picker.view.filetree.IDirectoryNodeState
---@field public tree                   stl.c.IReadonlyFiletree
---@field public view                   era.picker.FiletreeView

---@class era.picker.view.filetree.INodeMatchContext
...
---@class era.picker.view.filetree.INodeMatchResult
---@field public context                era.picker.view.filetree.INodeMatchContext
---@field public uuids                  string[]

---@class era.picker.view.filetree.INodeMatchResultCache
---@field public score                  integer
---@field public matches                dot.t.IMatchPoint[]

---@class era.picker.view.filetree.IMatchParams
...
---@class era.picker.view.IFiletreeProps
---@field public name                   string
---@field public tree                   stl.c.IFiletree
---@field public indent                 ?string
---@field public indent_hln             ?string
---
---@field public render_listview_leaf   ?era.picker.view.filetree.IListviewFileRenderer
---@field public render_listview_location   ?era.picker.view.filetree.IListviewLocationRenderer
---@field public render_treeview_container  ?era.picker.view.filetree.ITreeviewDirectoryRenderer
---@field public render_treeview_leaf   ?era.picker.view.filetree.ITreeviewFileRenderer
---@field public render_treeview_location   ?era.picker.view.filetree.ITreeviewLocationRenderer

local P = stl.view.Tree ---@type stl.view.Tree

---@class era.picker.FiletreeView : stl.view.Tree
---@field protected _tree               stl.c.IFiletree
---@field protected _last_match_result  era.picker.view.filetree.INodeMatchResult
---@field public insert                 fun(self: era.picker.FiletreeView, uuid: string, state: stl.view.tree.INodeState): era.picker.FiletreeView
local M = {}
M.__index = M
setmetatable(M, P)

---@param props                         era.picker.view.IFiletreeProps
---@return era.picker.FiletreeView
function M.new(props)
  ...
  local render_listview_leaf = props.render_listview_leaf or M.default_render_listview_leaf ---@type era.picker.view.filetree.IListviewFileRenderer
  local render_listview_location = props.render_listview_location or M.default_render_listview_location ---@type era.picker.view.filetree.IListviewLocationRenderer
  local render_treeview_container = props.render_treeview_container or M.default_render_treeview_container ---@type era.picker.view.filetree.ITreeviewDirectoryRenderer
  local render_treeview_leaf = props.render_treeview_leaf or M.default_render_treeview_leaf ---@type era.picker.view.filetree.ITreeviewFileRenderer
  local render_treeview_location = props.render_treeview_location or M.default_render_treeview_location ---@type era.picker.view.filetree.ITreeviewLocationRenderer
  ...
  ---@cast self                         era.picker.FiletreeView
...
function M:mark_cache_match_dirty()
  self:__health__()
  self._last_match_result = nil ---@type era.picker.view.filetree.INodeMatchResult|nil
  return self
end

---@param uuid                          string
---@return era.picker.view.filetree.INodeState|nil
function M:retrieve(uuid)
  ...
  local nodestate = statemap[uuid] ---@type era.picker.view.filetree.INodeState|nil
  return nodestate
end
...
---@param params                        era.picker.view.filetree.IMatchParams
---@return string[]
function M:match(params)
  ...
  ---@type era.picker.view.filetree.INodeMatchContext
  local context = {
    rootuuid = root,
    pattern = pattern,
  ...
  local last_match_result = self._last_match_result ---@type era.picker.view.filetree.INodeMatchResult|nil
  local last_match_context = last_match_result and last_match_result.context or nil ---@type era.picker.view.filetree.INodeMatchContext|nil
  ...
  if search_result ~= nil and search_result.lines ~= nil then
    ...
    for _, line_match in ipairs(line_matches) do
      ...
      state.cache_match = { score = line_match.score, matches = matches } ---@type era.picker.view.filetree.INodeMatchResultCache
    end
  ...
  ---@type era.picker.view.filetree.INodeMatchResult
  local match_result = {
    context = context,
    uuids = uuids,
  }
...
function M:insert_dirpath(dirpath)
  ...
  local filestate = statemap[fileuuid] ---@type era.picker.view.filetree.INodeState|nil
  ...
  if filestate == nil or filestate.nodetype ~= "container" then
    ...
    while node ~= nil and node.uuid ~= node.parent do
      local nodestate = statemap[filenode.uuid] ---@type era.picker.view.filetree.INodeState|nil
      if nodestate ~= nil and nodestate.nodetype == "container" then
        break
      end

      ---@type era.picker.view.filetree.IDirectoryNodeState
      nodestate = {
        nodetype = "container",
        collapsed = false,
        tick_invisible = 0,
...
function M:insert_filepath(filepath, with_locations)
  ...
  if filestate == nil or filestate.nodetype ~= "leaf" then
    ...
    ---@type era.picker.view.filetree.IFileNodeState
    filestate = {
      nodetype = "leaf",
      collapsed = false,
      tick_invisible = 0,
  ...
  if lnum ~= nil then
    ...
    ---@type era.picker.view.filetree.ILocationNodeState
    local location = {
      nodetype = "location",
      leafuuid = fileuuid,
    ...
    local locations = filestate.locations or {} ---@type era.picker.view.filetree.ILocationNodeState[]
    locations[#locations + 1] = location ---@type era.picker.view.filetree.ILocationNodeState
    filestate.locations = locations ---@type era.picker.view.filetree.ILocationNodeState[]
  end
      ...
      for _, p in ipairs(filepaths) do
        ...
        if lnum ~= nil then
          ...
          if filenode ~= nil and nodestate ~= nil then
            ...
            local locations = nodestate.locations or {} ---@type era.picker.view.filetree.ILocationNodeState[]
            locations[#locations + 1] = location ---@type era.picker.view.filetree.ILocationNodeState
            nodestate.locations = locations ---@type era.picker.view.filetree.ILocationNodeState[]
          end
        end
      end
    end
...
---@param root                          string|nil
---@param handle                        fun(node: stl.c.IFiletreeNode, nodestate: era.picker.view.filetree.IFileNodeState): nil
---@return string[]
function M:traverse_filenode(root, handle)
  ...
  self._tree:quick_traverse(root, function(_, node)
    ...
    if nodestate ~= nil and nodestate.nodetype == "leaf" then
      ---@cast nodestate                era.picker.view.filetree.IFileNodeState
...
---@type era.picker.view.filetree.IListviewFileRenderer
function M.default_render_listview_leaf(ctx, node)
  ...
  local git_text, git_name_highlight =
    era.git.status.calc_info(node.data.filepath, node.data.filetype, #text, highlights)
  if git_name_highlight ~= nil then
    highlights[highlight_index].hlname = git_name_highlight
  end
  text = text .. git_text ---@type string

  local diagnostic_text = era.lsp.diagnostic.render(node.data.filepath, #text, highlights) ---@type string
  text = text .. diagnostic_text ---@type string
  return { text = text, highlights = highlights }
end

---@type era.picker.view.filetree.IListviewLocationRenderer
...
---@type era.picker.view.filetree.ITreeviewDirectoryRenderer
...
---@type era.picker.view.filetree.ITreeviewFileRenderer
...
---@type era.picker.view.filetree.ITreeviewLocationRenderer
