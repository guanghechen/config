...
local __module_name__ = "era.picker.result" ---@type string

---@alias era.picker.result.IDraw
---| fun(bufnr: integer): era.picker.result.IDrawResult

---@alias era.picker.result.IIsSelected
---| fun(bufnr: integer, lnum: integer): boolean

---@alias era.picker.result.IOnDrawed
---| fun(bufnr: integer): nil

---@class era.picker.result.IDrawResult
---@field public lnum_current           integer|nil
---@field public lnum_present           integer|nil

---@class era.picker.result.IFlagItemRaw
---@field public desc                   string
---@field public callback               fun(): nil
---@field public disabled               (fun(): boolean)|boolean|nil
---@field public snapshot               fun(): string, string

---@class era.picker.result.IFlagItem
---@field public desc                   string
---@field public callback               string
---@field public disabled               fun(): boolean
---@field public snapshot               fun(): string, string

---@class era.picker.result.IWinOpts
...
---@class era.picker.IResultProps
---@field public uuid                   string
---@field public name                   string
---@field public draw                   era.picker.result.IDraw
---@field public isselected             ?era.picker.result.IIsSelected
---@field public keymaps                stl.t.IKeymap[]
---@field public flags                  era.picker.result.IFlagItemRaw[]
---@field public flags_start_index      ?0|1
---@field public on_drawed              ?era.picker.result.IOnDrawed

---@class era.picker.Result
---@field public uuid                   string
---@field public fullname               string
---@field public draw                   era.picker.result.IDraw
---@field public flags                  era.picker.result.IFlagItem[]
---@field public keymaps                stl.t.IKeymap[]
...
---@param props                         era.picker.IResultProps
---@return era.picker.Result
function M.new(props)
  local uuid = props.uuid ---@type string
  local name = props.name ---@type string
  local fullname = string.format("%s -> %s", name, __module_name__) ---@type string
  local draw = props.draw ---@type era.picker.result.IDraw
  local isselected = props.isselected or stl.fn.falsy ---@type era.picker.result.IIsSelected
  local keymaps = props.keymaps ---@type stl.t.IKeymap[]
  local flags_start_index = props.flags_start_index == 0 and 0 or 1 ---@type 0|1

  local on_drawed = props.on_drawed or stl.fn.noop ---@type era.picker.result.IOnDrawed
  ...
  local flags = {} ---@type era.picker.result.IFlagItem[]
  if props.flags ~= nil and #props.flags > 0 then
    for _, flag in ipairs(props.flags) do
      ---@cast flag                     era.picker.result.IFlagItemRaw
      ...
      ---@type era.picker.result.IFlagItem
      local item = {
        desc = flag.desc,
  ...
  local scheduler_content = stl.c.Scheduler.new({
    ...
    task = function()
      ...
      local ok, result = pcall(draw, bufnr) ---@type boolean, era.picker.result.IDrawResult
...
---@param winopts                       era.picker.result.IWinOpts
