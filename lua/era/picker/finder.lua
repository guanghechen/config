...
local __module_name__ = "era.picker.finder" ---@type string

---@class era.picker.finder.IWinOpts
...
---@param props                         era.picker.IFinderProps
---@return era.picker.Finder
...
---@param winopts                       era.picker.finder.IWinOpts
