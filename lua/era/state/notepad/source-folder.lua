...
---@class era.state.notepad.source.FolderState : era.t.INotepadSourceState
---Folder-specific state (inherits all fields from INotepadSourceState)

---@class era.state.notepad.source.Folder : era.t.INotepadSource
...
function M:flush()
  ...
  local ok, err = pcall(function()
    era.fs.write_json(self._metadata_path, save_data, true)
  end)
