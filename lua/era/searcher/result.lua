...
---@class era.searcher.IResultProps
---@field public uuid                   string
---@field public name                   string
---@field public draw                   era.searcher.result.IDraw
---@field public isselected             ?era.searcher.result.IIsSelected
---@field public keymaps                stl.t.IKeymap[]
---@field public flags                  era.searcher.result.IFlagItemRaw[]
---@field public flags_start_index      ?0|1
---@field public on_drawed              ?era.searcher.result.IOnDrawed

---@class era.searcher.Result
---@field public uuid                   string
---@field public fullname               string
---@field public draw                   era.searcher.result.IDraw
---@field public flags                  era.searcher.result.IFlagItem[]
---@field public keymaps                stl.t.IKeymap[]
...
---@param props                         era.searcher.IResultProps
---@return era.searcher.Result
function M.new(props)
  local uuid = props.uuid ---@type string
  local name = props.name ---@type string
  local fullname = string.format("%s -> %s", name, __module_name__) ---@type string
  local draw = props.draw ---@type era.searcher.result.IDraw
  local isselected = props.isselected or stl.fn.falsy ---@type era.searcher.result.IIsSelected
  local keymaps = props.keymaps ---@type stl.t.IKeymap[]
  local flags_start_index = props.flags_start_index == 0 and 0 or 1 ---@type 0|1

  local on_drawed = props.on_drawed or stl.fn.noop ---@type era.searcher.result.IOnDrawed
  ...
  local flags = {} ---@type era.searcher.result.IFlagItem[]
  if props.flags ~= nil and #props.flags > 0 then
    for _, flag in ipairs(props.flags) do
      ---@cast flag                     era.searcher.result.IFlagItemRaw
      ...
      ---@type era.searcher.result.IFlagItem
      local item = {
        desc = flag.desc,
  ...
  local scheduler_content = stl.c.Scheduler.new({
    ...
    task = function()
      ...
      local ok, result = pcall(draw, bufnr) ---@type boolean, era.searcher.result.IDrawResult
...
function M:dispose()
  ...
  local nvimbar = self._nvimbar ---@type era.nvimbar.Nvimbar
...
---@param winopts                       era.searcher.result.IWinOpts
