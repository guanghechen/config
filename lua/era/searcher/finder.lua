...
local __module_name__ = "era.searcher.finder" ---@type string

---@class era.searcher.finder.IWinOpts
...
---@class era.searcher.IFinderProps
...
---@param props                         era.searcher.IFinderProps
---@return era.searcher.Finder
...
---@param winopts                       era.searcher.finder.IWinOpts
