local __module_name__ = "era.searcher.view.plainfile" ---@type string

---@class era.searcher.IPlainfileViewContext
...
---@class era.searcher.IPlainfileViewHighlight : stl.t.IHighlight
---@field public offset                 integer

---@class era.searcher.IPlainfileViewData
---@field public filepath               string
---@field public filetype               string|nil
---@field public lines                  string[]
---@field public highlights             era.searcher.IPlainfileViewHighlight[]
---@field public title                  string

---@class era.searcher.IPlainfileViewProps
---@field public name                   string

---@class era.searcher.PlainfileView
---@field public fullname               string
---@field public nsnr                   integer
---@field protected _disposed           boolean
---@field protected _last_bufnr         integer|nil
---@field protected _last_data          era.searcher.IPlainfileViewData|nil
local M = {}
M.__index = M

---@param props                         era.searcher.IPlainfileViewProps
---@return era.searcher.PlainfileView
...
---@param context                       era.searcher.IPlainfileViewContext
---@return era.searcher.IPlainfileViewData
function M:calc_preview_data(context)
  ...
  if not stl.filetype.is_printable_file(filename) then
    ...
    ---@type era.searcher.IPlainfileViewHighlight[]
    local highlights = { { offset = -1, lnum = 1, coll = 0, colr = -1, hlname = "m_sr_error" } }

    ---@type era.searcher.IPlainfileViewData
    local result = {
  ...
  local highlights = {} ---@type era.searcher.IPlainfileViewHighlight[]
  ...
  if flag_replace then
    ...
    highlights = {} ---@type era.searcher.IPlainfileViewHighlight[]
...
---@param context                       era.searcher.IPlainfileViewContext
---@param data                          era.searcher.IPlainfileViewData
...
function M:render(context, bufnr, filepath, force)
  ...
  local data = self._last_data ---@type era.searcher.IPlainfileViewData|nil
  if force or data == nil or data.filepath ~= filepath then
    data = self:calc_preview_data(context) ---@type era.searcher.IPlainfileViewData
