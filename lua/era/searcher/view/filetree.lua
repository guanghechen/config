...
local __module_name__ = "era.searcher.view.filetree" ---@type string

---@alias era.searcher.view.filetree.INodeState
---| era.searcher.view.filetree.IDirectoryNodeState
---| era.searcher.view.filetree.IFileNodeState
...
---
---@field public match                  era.searcher.view.filetree.ISearchedItem

---@class era.searcher.view.filetree.IResolvedFileMatch
...
---@class era.searcher.view.filetree.ISearchParams
...
---@class era.searcher.view.filetree.ISearchResult
---@field public items                  era.searcher.view.filetree.ISearchedItem[]
---@field public filematch_map          table<string, era.searcher.view.filetree.IResolvedFileMatch>

---@class era.searcher.view.filetree.ISearchedPreviewItem
---@field public offset                 integer
---@field public lnum                   integer
---@field public col                    integer
---@field public content                string

---@class era.searcher.view.filetree.ISearchedItem
---@field public filepath               string
...
---@field public highlights             stl.t.IHighlightInline[]
---
---@field public preview                era.searcher.view.filetree.ISearchedPreviewItem
...
---@class era.searcher.view.IFiletreeProps
---@field public name                   string
---@field public tree                   stl.c.IFiletree
---@field public indent                 ?string
---@field public indent_hln             ?string
---
---@field public render_listview_leaf   ?era.searcher.view.filetree.IListviewFileRenderer
---@field public render_listview_location   ?era.searcher.view.filetree.IListviewLocationRenderer
---@field public render_treeview_container  ?era.searcher.view.filetree.ITreeviewDirectoryRenderer
...
---@param props                         era.searcher.view.IFiletreeProps
---@return era.searcher.FiletreeView
function M.new(props)
  ...
  local render_listview_leaf = props.render_listview_leaf or M.default_render_listview_leaf ---@type era.searcher.view.filetree.IListviewFileRenderer
  local render_listview_location = props.render_listview_location or M.default_render_listview_location ---@type era.searcher.view.filetree.IListviewLocationRenderer
  local render_treeview_container = props.render_treeview_container or M.default_render_treeview_container ---@type era.searcher.view.filetree.ITreeviewDirectoryRenderer
  ...
  ---@cast self                         era.searcher.FiletreeView
...
---@param params                        era.searcher.view.filetree.ISearchParams
---@return era.searcher.view.filetree.ISearchResult|nil
function M:search(params)
  ...
  local items = {} ---@type era.searcher.view.filetree.ISearchedItem[]
  local filematch_map = {} ---@type table<string, era.searcher.view.filetree.IResolvedFileMatch>
  ...
  for _, filematch in ipairs(results.items) do
    ...
    for _, match in ipairs(filematch.matches or {}) do
      ...
      ---@type era.searcher.view.filetree.ISearchedItem
      local item = {
        filepath = filepath,
        uuid = uuid,
        lnum = match.lx,
  ...
  ---@type era.searcher.view.filetree.ISearchResult
  local result = {
    items = items,
  ...
  filetree:unsafe_traverse(filetree.root, function(ctx)
    ...
    local function traverse(node)
      if node.data.filetype == "directory" then
        ---@type era.searcher.view.filetree.IDirectoryNodeState
        local nodestate = {
          nodetype = "container",
          collapsed = false,
          tick_invisible = 0,
      ...
      if node.data.filetype == "file" then
        ---@type era.searcher.view.filetree.IFileNodeState
        local nodestate = {
          nodetype = "leaf",
          collapsed = false,
          tick_invisible = 0,
...
---@type era.searcher.view.filetree.IListviewFileRenderer
...
---@type era.searcher.view.filetree.IListviewLocationRenderer
...
---@type era.searcher.view.filetree.ITreeviewDirectoryRenderer
...
---@type era.searcher.view.filetree.ITreeviewFileRenderer
...
---@type era.searcher.view.filetree.ITreeviewLocationRenderer
