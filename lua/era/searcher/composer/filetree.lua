...
local __module_name__ = "era.searcher.composer.filetree" ---@type string

---@alias era.searcher.composer.filetree.IOnAttached
---| fun(self: era.searcher.FiletreeComposer, rootpath: string): nil

---@alias era.searcher.composer.filetree.IOnClosed
---| fun(self: era.searcher.FiletreeComposer): nil

---@alias era.searcher.composer.filetree.IOnConfirm
---| fun(self: era.searcher.FiletreeComposer, selected_filepaths: string[]|nil): nil

---@alias era.searcher.composer.filetree.IOnDisposed
---| fun(): nil

---@alias era.searcher.composer.filetree.IOnFocused
---| fun(self: era.searcher.FiletreeComposer): nil

---@alias era.searcher.composer.filetree.IOnHidden
---| fun(self: era.searcher.FiletreeComposer): nil
---
---@alias era.searcher.composer.filetree.IOnRefresh
---| fun(self: era.searcher.FiletreeComposer, force: boolean): nil

---@class era.searcher.composer.filetree.actions
...
---@class era.searcher.IFiletreeComposerProps
...
---
---@field public flags_append           era.searcher.result.IFlagItemRaw[]|nil
---@field public flags_prepend          era.searcher.result.IFlagItemRaw[]|nil
...
---
---@field public on_attached            ?era.searcher.composer.filetree.IOnAttached
---@field public on_closed              ?era.searcher.composer.filetree.IOnClosed
---@field public on_confirm             ?era.searcher.composer.filetree.IOnConfirm
---@field public on_disposed            ?era.searcher.composer.filetree.IOnDisposed
---@field public on_focused             ?era.searcher.composer.filetree.IOnFocused
---@field public on_hidden              ?era.searcher.composer.filetree.IOnHidden
---@field public on_refresh             ?era.searcher.composer.filetree.IOnRefresh

---@class era.searcher.FiletreeComposer
---@field public uuid                   string
...
---@field protected _composer           era.searcher.BasicComposer
---@field protected _plainfile          era.searcher.PlainfileView
...
---@field protected _treeview           era.searcher.FiletreeView
---
...
---
---@field protected _on_attached        era.searcher.composer.filetree.IOnAttached
---@field protected _on_confirm         era.searcher.composer.filetree.IOnConfirm|nil
---@field protected _on_disposed        era.searcher.composer.filetree.IOnDisposed
---@field protected _observer_unsubs    stl.c.IUnsubscribable[]|nil
local M = {}
M.__index = M

---@param props                         era.searcher.IFiletreeComposerProps
---@return era.searcher.FiletreeComposer
function M.new(props)
  ...
  local flags_append = props.flags_append ---@type era.searcher.result.IFlagItemRaw[]|nil
  local flags_prepend = props.flags_prepend ---@type era.searcher.result.IFlagItemRaw[]|nil
  local flags_start_index = props.flags_start_index ---@type 0|1|nil

  local frecency = props.frecency ---@type stl.c.Frecency|nil

  local on_attached = props.on_attached or stl.fn.noop ---@type era.searcher.composer.filetree.IOnAttached
  local on_closed = props.on_closed or stl.fn.noop ---@type era.searcher.composer.filetree.IOnClosed
  local on_confirm = props.on_confirm ---@type era.searcher.composer.filetree.IOnConfirm|nil
  local on_disposed = props.on_disposed or stl.fn.noop ---@type era.searcher.composer.filetree.IOnDisposed
  local on_focused = props.on_focused or stl.fn.noop ---@type era.searcher.composer.filetree.IOnFocused
  local on_hidden = props.on_hidden or stl.fn.noop ---@type era.searcher.composer.filetree.IOnHidden
  local _on_refresh = props.on_refresh or stl.fn.noop ---@type era.searcher.composer.filetree.IOnRefresh
  ...
  ---@type era.searcher.FiletreeView
  local treeview = era.searcher.FiletreeView.new({
    name = fullname,
    tree = filetree,
  ...
  ---@type era.searcher.composer.filetree.IOnRefresh
  ...
  ---@return era.searcher.view.filetree.INodeState|nil
  local function retrieve_node_and_state(nodeuuid)
    local nodestate = treeview:retrieve(nodeuuid) ---@type era.searcher.view.filetree.INodeState|nil
    local baseuuid = nodeuuid ---@type string

    if nodestate ~= nil and nodestate.nodetype == "location" then
      ---@cast nodestate                    era.searcher.view.filetree.ILeafLocationState
  ...
  ---@param locationstate               era.searcher.view.filetree.ILeafLocationState
  ...
  ---@param nodestate                   era.searcher.view.filetree.INodeState|nil
  ...
  ---@type era.searcher.PlainfileView
  local plainfile = era.searcher.PlainfileView.new({
    name = fullname,
  })
  ...
  local flags = {} ---@type era.searcher.result.IFlagItemRaw[]
  do
  ...
  ---@type era.searcher.composer.filetree.actions
  local actions = {
    ...
    replace_all = function()
      ...
      for lnum = 1, lnum_total, 1 do
        ...
        if leafuuid ~= nil then
          local leafnode = filetree:retrieve(leafuuid) ---@type stl.c.IFiletreeNode|nil
          local leafnodestate = treeview:retrieve(leafuuid) ---@type era.searcher.view.filetree.INodeState|nil
          if leafnode ~= nil and leafnodestate ~= nil and leafnodestate.nodetype == "leaf" then
            ---@cast leafnode         stl.c.IFiletreeNode
            ---@cast leafnodestate    era.searcher.view.filetree.IFileNodeState
    ...
    replace_in_node = function()
      ...
      if nodestate.nodetype == "location" then
        ...
        local leafnodestate = treeview:retrieve(nodestate.leafuuid) ---@type era.searcher.view.filetree.INodeState|nil
        ...
        local locations = leafnodestate.locations ---@type era.searcher.view.filetree.ILeafLocationState[]|nil
        ...
        for i = st + 1, L, 1 do
          local location = locations[i] ---@type era.searcher.view.filetree.ILeafLocationState
      ...
      if nodestate.nodetype == "leaf" then
        ---@cast nodestate              era.searcher.view.filetree.IFileNodeState
      ...
      for lnum = 1, linecount, 1 do
        ...
        if uuid ~= nil then
          ...
          if node ~= nil and node.data.filetype == "file" then
            ...
            local nodestate = treeview:retrieve(uuid) ---@type era.searcher.view.filetree.INodeState|nil
            local locations = nodestate and nodestate.locations or nil ---@type era.searcher.view.filetree.ILeafLocationState[]|nil
    ...
    toggle_selection = function()
      ...
      for lnum = lnum_from, lnum_to, 1 do
        local nodeuuid = retriever:retrieve_uuid(lnum) ---@type string|nil
        if nodeuuid ~= nil then
          local childstate = treeview:retrieve(nodeuuid) ---@type era.searcher.view.filetree.INodeState|nil
  ...
  local composer = era.searcher.BasicComposer.new({
    uuid = searcher_uuid,
    name = fullname,
    permanent = permanent,
    ...
    render_result = function(bufnr)
      ...
      local ret = { lnum_current = lnum_current } ---@type era.searcher.result.IDrawResult
      return ret
    end,

    ---@type era.searcher.preview.IDraw|nil
    render_preview = preview
        and function(bufnr)
          ...
          if nodeuuid == nil then
            ...
            ---@type era.searcher.preview.IDrawResult
            local result = {
              cursorline = true,
              number = true,
          ...
          if nodestate.nodetype == "container" then
            ...
            ---@cast nodestate          era.searcher.view.filetree.IDirectoryNodeState
            ---@type era.searcher.preview.IDrawResult
            local result = {
              cursorline = true,
              number = true,
          ...
          ---@cast nodestate            era.searcher.view.filetree.IFileNodeState|era.searcher.view.filetree.ILeafLocationState

          local leafnode = nodestate.nodetype == "location" and treeview:retrieve(nodestate.leafuuid) or nodestate
          ---@cast leafnode             era.searcher.view.filetree.IFileNodeState

          local locations = leafnode and leafnode.locations or nil ---@type era.searcher.view.filetree.ILeafLocationState[]|nil
          ...
          local location_current ---@type era.searcher.view.filetree.ILeafLocationState
          if nodestate.nodetype == "location" then
            ---@cast nodestate          era.searcher.view.filetree.ILeafLocationState
            location_current = nodestate
          else
            if locations ~= nil and #locations > 0 then
              location_current = locations[1] ---@type era.searcher.view.filetree.ILeafLocationState
            end
          end

          ---@type era.searcher.IPlainfileViewContext
...
function M:dispose()
  ...
  local on_dispose = self._on_disposed ---@type era.searcher.composer.filetree.IOnDisposed
  local composer = self._composer ---@type era.searcher.BasicComposer
  local plainfile = self._plainfile ---@type era.searcher.PlainfileView
  ...
  local treeview = self._treeview ---@type era.searcher.FiletreeView
...
---@param leafnodestate                 era.searcher.view.filetree.IFileNodeState
---@return integer[]
...
function M:__search_internal__()
  ...
  ---@type era.searcher.view.filetree.ISearchResult|nil
  ...
  local items = result.items ---@type era.searcher.view.filetree.ISearchedItem[]
  local filematch_map = result.filematch_map ---@type table<string, era.searcher.view.filetree.IResolvedFileMatch>
  ...
  do
    ...
    while i <= N do
      local item = items[i] ---@type era.searcher.view.filetree.ISearchedItem
  ...
  local statemap = treeview.statemap ---@type table<string, era.searcher.view.filetree.INodeState>
  ...
  do
    ...
    while i <= N do
      ...
      local leafnode = statemap[nodeuuid] ---@type era.searcher.view.filetree.INodeState|nil
      if leafnode == nil then
        stl.reporter.error({
          from = self.fullname,
          subject = "__search__",
        ...
        local locations = leafnode.locations or {} ---@type era.searcher.view.filetree.ILeafLocationState[]
        for k = i, j - 1, 1 do
          local item = items[k] ---@type era.searcher.view.filetree.ISearchedItem

          ---@type era.searcher.view.filetree.ILeafLocationState
          local location = {
            nodetype = "location",
            leafuuid = nodeuuid,
...
function M:__open_node__(nodeuuid)
  ...
  if self:__has_selected_node__() then
    local linecount = retriever:linecount() ---@type integer
    local last_nodestate = nil ---@type era.searcher.view.filetree.IFileNodeState|nil
    local filepaths = {} ---@type string[]
      ...
      if uuid ~= nil then
        ...
        if isselected then
          ...
          if o ~= nil and o.data.filetype == "file" then
            ...
            local s = treeview:retrieve(nodeuuid) ---@type era.searcher.view.filetree.INodeState|nil
            if s ~= nil then
              ---@cast s                      era.searcher.view.filetree.IFileNodeState
              last_nodestate = s
            end
          end
        end
    ...
    if #filepaths > 0 then
      ---@cast last_nodestate             era.searcher.view.filetree.IFileNodeState
      local locations = last_nodestate.locations
      local first_location = locations ~= nil and locations[1] or nil ---@type era.searcher.view.filetree.ILeafLocationState|nil
  ...
  if nodestate.nodetype == "location" then
    ...
    if nodestate.locations ~= nil and #nodestate.locations > 0 then
      local first_location = nodestate.locations[1] ---@type era.picker.view.filetree.ILocationNodeState
...
---@param nodestate                     era.searcher.view.filetree.IFileNodeState
---@return boolean
function M:__replace_file__(cwd, node, nodestate)
  local locations = nodestate.locations ---@type era.searcher.view.filetree.ILeafLocationState[]|nil
  if locations == nil then
    return false
  end
  ...
  if succeed == true then
    ...
    for i = 1, L, 1 do
      ...
      if treeview:isvisible(location.locationuuid) then
        ...
        k = k + 1 ---@type integer
        locations[k] = location ---@type era.searcher.view.filetree.ILeafLocationState
      end
    end
...
---@return era.searcher.view.filetree.INodeState
function M:__retrieve__(nodeuuid)
  ---@type era.searcher.view.filetree.INodeState|nil
...
function M:__retrieve_filenode__()
  ...
  local nodestate = self._treeview:retrieve(nodeuuid) ---@type era.searcher.view.filetree.INodeState|nil
  if nodestate == nil then
    return
  end
