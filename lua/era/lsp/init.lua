local __module_name__ = "era.lsp" ---@type string

---! Check if cursor is within range
---@param cursor                        era.lsp.ISymbolPos
---@param range                         { start: era.lsp.ISymbolPos, end: era.lsp.ISymbolPos }
---@return boolean
local function is_within_range(cursor, range)
  local start = range.start ---@type era.lsp.ISymbolPos
  local finish = range["end"] ---@type era.lsp.ISymbolPos
...
---@class era.lsp
---@field public diagnostic             era.lsp.diagnostic
---@field public event                  era.lsp.event
local M = {
  diagnostic = require("era.lsp.diagnostic"),
  event = require("era.lsp.event"),
}
