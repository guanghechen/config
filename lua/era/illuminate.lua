...
local __module_name__ = "era.illuminate" ---@type string

---@class era.illuminate.ILspWord
---@field public from                   { [1]: integer, [2]: integer }
---@field public to                     { [1]: integer, [2]: integer }

---@alias era.illuminate.IMode
---| "n"
---| "i"
---| "c"
---| "t"
...
---@field public modes                  era.illuminate.IMode[]
