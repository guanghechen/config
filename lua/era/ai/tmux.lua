local __module_name__ = "era.ai.tmux" ---@type string

local config = require("era.ai.config")
local proc = require("era.ai.proc")
...
---@param line                          string
---@return era.ai.ITmuxPaneInfo|nil
...
---@param tool_config                   era.ai.IToolConfig
---@param cwd                           string
---@return string
...
---@class era.ai.ITmuxCurrentInfo
---@field public session_name           string
---@field public window_name            string

---@return era.ai.ITmuxCurrentInfo|nil
...
function M.list_panes()
  ...
  local panes = {} ---@type era.ai.ITmuxPaneInfo[]
...
function M.find_running_agents()
  ...
  local sources = {} ---@type era.ai.ISource[]
