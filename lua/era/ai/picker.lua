local __module_name__ = "era.ai.picker" ---@type string

local config = require("era.ai.config")
local state = require("era.ai.state")

---@class era.ai.picker.IItem : era.picker.composer.list.IItem
...
---@param items                         era.picker.composer.list.IItem[]
---@param width                         integer
...
---@class era.ai.picker.IAttachItemInfo
---@field public item                   era.ai.ISelectItem
---@field public category               era.ai.ItemCategory
---@field public agent_label            string
---@field public identifier             string|nil
---@field public pane_cwd               string|nil
---@field public uuid                   string

---@param info                          era.ai.picker.IAttachItemInfo
---@return string
...
---@param a                             era.ai.picker.IAttachItemInfo
---@param b                             era.ai.picker.IAttachItemInfo
---@return boolean
...
---@param items                         era.ai.ISelectItem[]
---@return era.ai.picker.IItem[], integer
local function build_attach_picker_items(items)
  local action = require("era.ai.action")
  local tmux = require("era.ai.tmux")
  ...
  local attached_infos = {} ---@type era.ai.picker.IAttachItemInfo[]
  local same_window_infos = {} ---@type era.ai.picker.IAttachItemInfo[]
  local agent_session_infos = {} ---@type era.ai.picker.IAttachItemInfo[]
  local new_agent_infos = {} ---@type era.ai.picker.IAttachItemInfo[]
  local same_session_infos = {} ---@type era.ai.picker.IAttachItemInfo[]
  local other_tmux_infos = {} ---@type era.ai.picker.IAttachItemInfo[]
  ...
  for _, item in ipairs(items) do
    ...
    local category ---@type era.ai.ItemCategory
    ...
    ---@type era.ai.picker.IAttachItemInfo
    local info = {
      item = item,
      category = category,
  ...
  local sorted_infos = {} ---@type era.ai.picker.IAttachItemInfo[]
  ...
  local picker_items = {} ---@type era.ai.picker.IItem[]
...
---@param attached                      era.ai.IAttachedSource[]
---@return era.ai.picker.IItem[], integer
local function build_attached_picker_items(attached)
  ...
  ---@class era.ai.picker.IAttachedItemInfo
  ---@field public source               era.ai.IAttachedSource
  ---@field public agent_label          string
  ---@field public identifier           string|nil
  ---@field public pane_cwd             string|nil

  local item_infos = {} ---@type era.ai.picker.IAttachedItemInfo[]
...
---@class era.ai.picker.IShowAttachParams
---@field public on_select              fun(item: era.ai.ISelectItem): nil
---@field public on_toggle              ?fun(item: era.ai.ISelectItem): nil

---@param params                        era.ai.picker.IShowAttachParams
---@return nil
...
---@param attached                      era.ai.IAttachedSource[]
---@param on_select                     fun(item: era.ai.IAttachedSource): nil
---@return nil
...
---@param attached                      era.ai.IAttachedSource[]
---@param on_select                     fun(items: era.ai.IAttachedSource[]): nil
---@return nil
function M.show_send_target(attached, on_select)
  ...
  local source_map = {} ---@type table<string, era.ai.IAttachedSource>
  ...
  local function confirm_selection()
    ...
    local results = {} ---@type era.ai.IAttachedSource[]
...
---@param on_select                     fun(prompt: era.ai.IPrompt, result: era.ai.IPromptRenderResult): nil
---@return nil
function M.show_prompt(on_select)
  local prompt_mod = require("era.ai.prompt")
  local ctx = prompt_mod.get_ctx()

  local picker_items = {} ---@type era.ai.picker.IItem[]
  local itemmap = {} ---@type table<string, era.ai.IPrompt>
  local result_map = {} ---@type table<string, era.ai.IPromptRenderResult>
