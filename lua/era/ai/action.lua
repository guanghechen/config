local __module_name__ = "era.ai.action" ---@type string

local config = require("era.ai.config")
local state = require("era.ai.state")
local term = require("era.ai.term")
local tmux = require("era.ai.tmux")

---@class era.ai.action
local M = {}

---@param agent                         era.ai.AgentName
---@return boolean
...
---@return era.ai.ISelectItem[]
function M.collect_items()
  local items = {} ---@type era.ai.ISelectItem[]
  local seen_ids = {} ---@type table<string, boolean>
  local cwd = dot.path.cwd()
  local has_agent_pane = {} ---@type table<era.ai.AgentName, boolean>
...
function M.send_to_attached(text, submit)
  local picker = require("era.ai.picker")
...
---@param source                        era.ai.IAttachedSource
---@param text                          string
---@param submit                        boolean
---@return boolean
...
---@protected
---@param sources                       era.ai.IAttachedSource[]
---@param text                          string
---@param submit                        boolean
---@return nil
