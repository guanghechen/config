...
---@class era.ai.IProcs
---@field protected _procs              table<integer, era.ai.IProc>
---@field protected _children           table<integer, integer[]>
local Procs = {}
Procs.__index = Procs

---@return era.ai.IProcs
function Procs.new()
...
---@param pid                           integer
---@return era.ai.IProc|nil
function Procs:get(pid)
  return self._procs[pid]
end

---@param pid                           integer
---@param callback                      fun(proc: era.ai.IProc): boolean|nil
---@return nil
...
---@param procs                         era.ai.IProcs
---@param pid                           integer
---@return era.ai.AgentName|nil
function M.detect_agent(procs, pid)
  local detected = nil ---@type era.ai.AgentName|nil
  procs:walk(pid, function(proc)
