local __module_name__ = "era.ai.term" ---@type string

---@class era.ai.term.IMeta
...
local _metamap = {} ---@type table<string, era.ai.term.IMeta>
...
---@param uuid                          string
---@return era.ai.term.IMeta|nil
function M.get(uuid)
  return _metamap[uuid]
end

---@param termmeta                      era.ai.term.IMeta
---@return integer
...
---@param params                        era.ai.term.IOpenParams
---@return era.ai.term.IMeta
