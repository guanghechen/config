local __module_name__ = "era.ai.state" ---@type string
...
function M.detach(source_id, close_terminal)
  local new_sources = {} ---@type era.ai.IAttachedSource[]
  local detached_source ---@type era.ai.IAttachedSource|nil
