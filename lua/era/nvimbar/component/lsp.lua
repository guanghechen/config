local __module_name__ = "era.nvimbar.component.lsp" ---@type string
...
local fn_show_error = dot.G.register_anonymous_fn(function(bufnr)
  local data = era.lsp.diagnostic.get_by_bufnr(bufnr) ---@type era.lsp.diagnostic.IBufferDiagnostics
  stl.reporter.info({
...
---@class era.nvimbar.component.lsp.ILspIcon
---@field public icon                   string
---@field public hl                     string

---@return                              string[]
---@return                              era.nvimbar.component.lsp.ILspIcon[]
...
local function get_lsp_clients(position)
  ...
  local client_icons = {} ---@type era.nvimbar.component.lsp.ILspIcon[]
...
---@class era.nvimbar.component.lsp
local M = {}
...
function M.client(position)
  ...
  local component = {
    ...
    atomic = true,
    render = function()
      local client_names, client_icons = get_lsp_clients(position) ---@type string[], era.nvimbar.component.lsp.ILspIcon[]
...
function M.diagnostics(position)
  ...
  local component = {
    ...
    render = function(context)
      local diag_data = era.lsp.diagnostic.get_by_bufnr(context.bufnr) ---@type era.lsp.diagnostic.IBufferDiagnostics
