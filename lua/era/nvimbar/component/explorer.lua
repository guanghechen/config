...
---@class era.nvimbar.component.explorer.IFlagItem
...
---@class era.nvimbar.component.explorer
local M = {}

---@param position                      stl.e.NvimbarPositionEnum
---@param flags                         era.nvimbar.component.explorer.IFlagItem[]
...
function M.tabline(position)
  ...
  local cb_flag_hidden = dot.G.register_anonymous_fn(function()
    if dot.widget.explorer.widget ~= nil then
      local tree = dot.widget.explorer.widget:get_tree() ---@type era.explorer.Tree
