local __module_name__ = "era.nvimbar.component.copilot" ---@type string
...
local function get_status()
  ...
  if #clients > 0 then
    ...
    local client_status = dot.state.status.copilots[client.id]
...
---@class era.nvimbar.component.copilot
local M = {}
