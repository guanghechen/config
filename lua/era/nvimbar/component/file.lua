...
local __module_name__ = "era.nvimbar.component.file" ---@type string
...
---@class era.nvimbar.component.file
local M = {}
...
function M.status(position)
  ...
  local function get_filestatus(bufnr)
    local summary = era.git.hunk.get_summary(bufnr) ---@type era.git.HunkSummary
