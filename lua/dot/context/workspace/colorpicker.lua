...
---@field public input_mode             era.m.colorpicker.InputModeName|nil
---@field public output_mode            era.m.colorpicker.OutputModeName|nil
...
---@field public set_input_mode         fun(mode: era.m.colorpicker.InputModeName): nil
---@field public get_input_mode         fun(): era.m.colorpicker.InputModeName|nil
---@field public set_output_mode        fun(mode: era.m.colorpicker.OutputModeName): nil
---@field public get_output_mode        fun(): era.m.colorpicker.OutputModeName|nil
...
---@param mode                          era.m.colorpicker.InputModeName
---@return nil
function M.set_input_mode(mode)
  M.input_mode:next(mode)
end

---@return era.m.colorpicker.InputModeName|nil
function M.get_input_mode()
  return M.input_mode:snapshot()
end

---@param mode                          era.m.colorpicker.OutputModeName
---@return nil
function M.set_output_mode(mode)
  M.output_mode:next(mode)
end

---@return era.m.colorpicker.OutputModeName|nil
