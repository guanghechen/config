---@class dot.ux.ISelectItem
---@field public uuid                   string
---@field public text                   string
---@field public highlights             ark.t.IHighlightInline[]|nil

---@class dot.ux.ISelectProps
---@field public wincfg                 vim.api.keyset.win_config|nil
---@field public keymaps                ark.t.IKeymap[]|nil
---@field public items                  dot.ux.ISelectItem[]
---@field public item_present_uuid      string|nil
---@field public on_select              fun(widget: dot.ux.ISelect, item: dot.ux.ISelectItem|nil): nil

---@class dot.ux.ISelect
---@field public create_buf_as_needed   fun(self: dot.ux.ISelect): integer
---@field public destroy                fun(self: dot.ux.ISelect): nil
---@field public focus                  fun(self: dot.ux.ISelect): integer

---@class dot.ux.Select : dot.ux.ISelect
---@field protected _bufnr              integer|nil
---@field protected _winnr              integer|nil
---@field protected _wincfg             vim.api.keyset.win_config
---@field protected _keymaps            ark.t.IKeymap[]
---@field protected _items              dot.ux.ISelectItem[]
---@field protected _item_index_present integer
---@field protected _on_select          fun(widget: dot.ux.ISelect, item: dot.ux.ISelectItem)
local M = {}
M.__index = M

---@class dot.ux.select.config
local config = {
...
---@param props                         dot.ux.ISelectProps
---@return dot.ux.Select
function M.new(props)
  local self = setmetatable({}, M)

  local items = props.items ---@type dot.ux.ISelectItem[]
  local item_present_uuid = props.item_present_uuid ---@type string|nil
  local on_select = props.on_select ---@type fun(widget: dot.ux.ISelect, item: dot.ux.ISelectItem|nil): nil
  ...
  local keymaps = vim.list_extend({
    ...
    },
    {
      ...
      callback = function()
        ...
        local item = items[index] ---@type dot.ux.ISelectItem
  ...
  self._items = items ---@type dot.ux.ISelectItem[]
  self._item_index_present = item_present_index ---@type integer
  self._on_select = on_select ---@type fun(item: dot.ux.ISelectItem|nil): nil
  return self
end
