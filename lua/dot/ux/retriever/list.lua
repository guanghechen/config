local __module_name__ = "dot.ux.retriever.list" ---@type string

---@class dot.ux.retriever.IListRetrieverProps
---@field public name                   string

---@class dot.ux.retriever.ListRetriever
...
---@param props                         dot.ux.retriever.IListRetrieverProps
---@return dot.ux.retriever.ListRetriever
