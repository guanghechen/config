local __module_name__ = "dot.ux.view.treeview" ---@type string

---@alias dot.ux.view.tree.CollapseActionEnum
---| "collapse"
---| "expand"
---| "toggle"

---@alias dot.ux.view.tree.NodeTypeEnum
---| "container"
---| "leaf"

---@alias dot.ux.view.tree.ViewtypeEnum
---| "tree"
---| "list"

---@alias dot.ux.view.tree.INodeState
---| dot.ux.view.tree.IContainerNodeState
---| dot.ux.view.tree.ILeafNodeState
---| dot.ux.view.tree.ILeafLocationState

---@alias dot.ux.view.tree.IRenderListviewLeafNode
---| fun(leafnode: dot.t.ITreeNode, leafstate: dot.ux.view.tree.ILeafNodeState): nil

---@alias dot.ux.view.tree.IRenderListviewLeafLocations
---| fun(leafnode: dot.t.ITreeNode, leafstate: dot.ux.view.tree.ILeafNodeState): nil

---@alias dot.ux.view.tree.IRenderTreeviewContainerNode
---| fun(containernode: dot.t.ITreeNode, containerstate: dot.ux.view.tree.IContainerNodeState, is_lastchild: boolean, cur: integer, dry: boolean): nil

---@alias dot.ux.view.tree.IRenderTreeviewLeafNode
---| fun(leafnode: dot.t.ITreeNode, leafstate: dot.ux.view.tree.ILeafNodeState, is_lastchild: boolean, cur: integer): nil

---@alias dot.ux.view.tree.IRenderTreeviewLeafLocations
---| fun(leafnode: dot.t.ITreeNode, leafstate: dot.ux.view.tree.ILeafNodeState, leafindent: string): nil

---@alias dot.ux.view.tree.IListviewLeafNodeRenderer
---| fun(ctx: dot.ux.view.tree.IListviewRendererContext, node: dot.t.ITreeNode, nodestate: dot.ux.view.tree.ILeafNodeState, lnum: integer): dot.ux.view.tree.INodeRenderResult

---@alias dot.ux.view.tree.IListviewLeafLocationRenderer
---| fun(ctx: dot.ux.view.tree.IListviewRendererContext, node: dot.t.ITreeNode, nodestate: dot.ux.view.tree.ILeafNodeState, location: dot.ux.view.tree.ILeafLocationState, lnum: integer): dot.ux.view.tree.INodeRenderResult

---@alias dot.ux.view.tree.ITreeviewContainerNodeRenderer
---| fun(ctx: dot.ux.view.tree.ITreeviewRendererContext, node: dot.t.ITreeNode, nodestate: dot.ux.view.tree.IContainerNodeState, lnum: integer, folded_depth: integer): dot.ux.view.tree.INodeRenderResult

---@alias dot.ux.view.tree.ITreeviewLeafNodeRenderer
---| fun(ctx: dot.ux.view.tree.ITreeviewRendererContext, node: dot.t.ITreeNode, nodestate: dot.ux.view.tree.ILeafNodeState, lnum: integer): dot.ux.view.tree.INodeRenderResult

---@alias dot.ux.view.tree.ITreeviewLeafLocationRenderer
---| fun(ctx: dot.ux.view.tree.ITreeviewRendererContext, node: dot.t.ITreeNode, nodestate: dot.ux.view.tree.ILeafNodeState, location: dot.ux.view.tree.ILeafLocationState, lnum: integer): dot.ux.view.tree.INodeRenderResult

---@class dot.ux.view.tree.IListviewRendererContext
---@field public rootnode               dot.t.ITreeNode
---@field public rootstate              dot.ux.view.tree.IContainerNodeState
---@field public tree                   dot.IReadonlyTree
---@field public view                   dot.ux.view.Tree

---@class dot.ux.view.tree.ITreeviewRendererContext
---@field public rootnode               dot.t.ITreeNode
---@field public rootstate              dot.ux.view.tree.INodeState
---@field public tree                   dot.IReadonlyTree
---@field public view                   dot.ux.view.Tree

---@class dot.ux.view.tree.IContainerNodeState
...
---@field public cache_treeview         dot.ux.view.tree.INodeTreeviewResultCache|nil

---@class dot.ux.view.tree.ILeafNodeState
---@field public nodetype               "leaf"
---@field public collapsed              boolean
---@field public locations              dot.ux.view.tree.ILeafLocationState[]|nil
---@field public tick_invisible         integer
---@field public tick_matched           integer
---@field public tick_selected          integer
---@field public cache_listview         dot.ux.view.tree.INodeListviewResultCache|nil
---@field public cache_treeview         dot.ux.view.tree.INodeTreeviewResultCache|nil

---@class dot.ux.view.tree.ILeafLocationState
...
---@class dot.ux.view.tree.INodeListviewResultCache
---@field public tick                   integer
---@field public text                   string
---@field public highlights             ark.t.IHighlightInline[]

---@class dot.ux.view.tree.INodeTreeviewResultCache
---@field public tick                   integer
---@field public text                   string
---@field public highlights             ark.t.IHighlightInline[]

---@class dot.ux.view.tree.INodeRenderResult
---@field public text                   string
---@field public highlights             ark.t.IHighlightInline[]|nil

---@class dot.ux.view.tree.IRenderResult
...
---@class dot.ux.view.tree.IRenderListviewParams
...
---@class dot.ux.view.tree.IRenderTreeviewParams
---@field public bufnr                  integer
---@field public rootuuid               string|nil
...
---@class dot.ux.view.ITreeProps
---@field public name                   string
---@field public fullname               ?string
---@field public indent                 ?string
---@field public indent_hln             ?string
---@field public tree                   dot.IReadonlyTree
---@field public render_listview_leaf   dot.ux.view.tree.IListviewLeafNodeRenderer
---@field public render_listview_location   dot.ux.view.tree.IListviewLeafLocationRenderer
---@field public render_treeview_container  dot.ux.view.tree.ITreeviewContainerNodeRenderer
---@field public render_treeview_leaf   dot.ux.view.tree.ITreeviewLeafNodeRenderer
---@field public render_treeview_location   dot.ux.view.tree.ITreeviewLeafLocationRenderer

---@class dot.ux.view.Tree
---@field public fullname               string
---@field public statemap               table<string, dot.ux.view.tree.INodeState>
---
...
---
---@field protected _render_listview_leaf       dot.ux.view.tree.IListviewLeafNodeRenderer
---@field protected _render_listview_location   dot.ux.view.tree.IListviewLeafLocationRenderer
---@field protected _render_treeview_container  dot.ux.view.tree.ITreeviewContainerNodeRenderer
---@field protected _render_treeview_leaf       dot.ux.view.tree.ITreeviewLeafNodeRenderer
---@field protected _render_treeview_location   dot.ux.view.tree.ITreeviewLeafLocationRenderer
local M = {}
M.__index = M

---@param props                         dot.ux.view.ITreeProps
---@return dot.ux.view.Tree
function M.new(props)
  ...
  local render_listview_leaf = props.render_listview_leaf ---@type dot.ux.view.tree.IListviewLeafNodeRenderer
  local render_listview_location = props.render_listview_location ---@type dot.ux.view.tree.IListviewLeafLocationRenderer
  local render_treeview_container = props.render_treeview_container ---@type dot.ux.view.tree.ITreeviewContainerNodeRenderer
  local render_treeview_leaf = props.render_treeview_leaf ---@type dot.ux.view.tree.ITreeviewLeafNodeRenderer
  local render_treeview_location = props.render_treeview_location ---@type dot.ux.view.tree.ITreeviewLeafLocationRenderer

  local statemap = {} ---@type table<string, dot.ux.view.tree.INodeState>
...
function M:ismatched(uuid)
  local nodestate = self.statemap ~= nil and self.statemap[uuid] or nil ---@type dot.ux.view.tree.INodeState|nil
...
function M:render_listview(params)
  ...
  local rootstate = statemap[rootuuid] ---@type dot.ux.view.tree.INodeState|nil
  if rootnode == nil or (rootstate ~= nil and rootstate.tick_invisible == tick_invisible) then
    vim.api.nvim_buf_set_lines(bufnr, 0, -1, false, {})
    local result = { indents = {}, lnum2uuid = {}, uuid2lnum = {} } ---@type dot.ux.view.tree.IRenderResult
    return result
  end
  ...
  ---@cast rootstate                    dot.ux.view.tree.IContainerNodeState
  ---@type dot.ux.view.tree.IListviewRendererContext
  local ctx = {
    rootnode = rootnode,
    rootstate = rootstate,
    tree = tree,
  ...
  local render_listview_leaf = self._render_listview_leaf ---@type dot.ux.view.tree.IListviewLeafNodeRenderer
  local render_listview_location = self._render_listview_location ---@type dot.ux.view.tree.IListviewLeafLocationRenderer
  ...
  ---@type dot.ux.view.tree.IRenderListviewLeafLocations
  local function render_leaf_locations(leafnode, leafstate)
    ...
    for index = N, 1, -1 do
      local location = leafstate.locations[index] ---@type dot.ux.view.tree.ILeafLocationState
  ...
  ---@type dot.ux.view.tree.IRenderListviewLeafNode
  local function render_leafnode(leafnode, leafstate)
    ...
    local cache = leafstate.cache_listview ---@type dot.ux.view.tree.INodeListviewResultCache|nil
    if cache == nil or cache.tick ~= tick_render_listview then
      local result = render_listview_leaf(ctx, leafnode, leafstate, lnum)
      ---@type dot.ux.view.tree.INodeListviewResultCache
      cache = {
    ...
    if only_matched then
      if only_selected then
        for _, uuid in ipairs(orders) do
          ...
          local nodestate = statemap[uuid] ---@type dot.ux.view.tree.INodeState|nil
          if
            node ~= nil
            and nodestate ~= nil
            and nodestate.nodetype == "leaf"
  ...
  ---@type dot.ux.view.tree.IRenderResult
...
function M:render_treeview(params)
  ...
  local rootstate = statemap[root] ---@type dot.ux.view.tree.INodeState|nil
  if rootnode == nil or (rootstate ~= nil and rootstate.tick_invisible == tick_invisible) then
    vim.api.nvim_buf_set_lines(bufnr, 0, -1, false, {})
    local result = { indents = {}, lnum2uuid = {}, uuid2lnum = {} } ---@type dot.ux.view.tree.IRenderResult
    return result
  ...
  ---@cast rootstate                    dot.ux.view.tree.IContainerNodeState
  ---@type dot.ux.view.tree.ITreeviewRendererContext
  local ctx = {
    rootnode = rootnode,
    rootstate = rootstate,
    tree = tree,
  ...
  local nsnr = NSNR_DEFAULT ---@type integer
  local INDENT_COMMON = self._indent ---@type string
  local render_treeview_container = self._render_treeview_container ---@type dot.ux.view.tree.ITreeviewContainerNodeRenderer
  local render_treeview_leaf = self._render_treeview_leaf ---@type dot.ux.view.tree.ITreeviewLeafNodeRenderer
  local render_treeview_location = self._render_treeview_location ---@type dot.ux.view.tree.ITreeviewLeafLocationRenderer
  ...
  ---@type dot.ux.view.tree.IRenderTreeviewLeafLocations
  ...
  ---@type dot.ux.view.tree.IRenderTreeviewLeafNode
  local function render_leaf(leafnode, leafstate, is_lastchild, cur)
    ...
    local cache = leafstate.cache_treeview ---@type dot.ux.view.tree.INodeTreeviewResultCache|nil
    if cache == nil or cache.tick ~= tick_render_treeview then
      local result = render_treeview_leaf(ctx, leafnode, leafstate, lnum) ---@type dot.ux.view.tree.INodeRenderResult
      ---@type dot.ux.view.tree.INodeTreeviewResultCache
      cache = {
  ...
  local render_container ---@type dot.ux.view.tree.IRenderTreeviewContainerNode
  if foldempty then
    ---@type dot.ux.view.tree.IRenderTreeviewContainerNode
    render_container = function(containernode, containerstate, is_lastchild, cur, dry)
      ...
      local nodestate = statemap[containernode.uuid] ---@type dot.ux.view.tree.INodeState
      local result ---@type dot.ux.view.tree.INodeTreeviewResultCache|dot.ux.view.tree.INodeRenderResult
  ...
  if foldempty then
    ...
    traverse = function(_, node, cur, is_lastchild, onlychild)
      ...
      if onlychild ~= nil then
        local state_onlychild = statemap[onlychild] ---@type dot.ux.view.tree.INodeState
        if state_onlychild.nodetype == "container" then
          ---@cast nodestate            dot.ux.view.tree.IContainerNodeState
...
function M:collect_leafs(root)
  ...
  self._tree:quick_traverse(root, function(_, node)
    local state = statemap[node.uuid] ---@type dot.ux.view.tree.INodeState|nil
...
---@param uuid                          string
---@param state                         dot.ux.view.tree.INodeState
---@return dot.ux.view.Tree
function M:insert(uuid, state)
  self:__health__()

  local statemap = self.statemap ---@type table<string, dot.ux.view.tree.INodeState>
  local oldstate = statemap[uuid] ---@type dot.ux.view.tree.INodeState|nil
...
---@param leafnodestate                 dot.ux.view.tree.ILeafNodeState
---@return nil
function M:remove_all_locations(leafnodestate)
  ...
  if leafnodestate.locations ~= nil then
    local statemap = self.statemap ---@type table<string, dot.ux.view.tree.INodeState>
    local locations = leafnodestate.locations ---@type dot.ux.view.tree.ILeafLocationState[]
    local L = #locations ---@type integer
    for i = 1, L, 1 do
      local location = locations[i] ---@type dot.ux.view.tree.ILeafLocationState
      statemap[location.locationuuid] = nil
    end
    leafnodestate.locations = nil ---@type dot.ux.view.tree.ILeafLocationState[]|nil
  end
end
  ...
  if leafnodestate.locations ~= nil then
    ...
    for i = 1, L, 1 do
      ...
      if location.locationuuid == locationuuid then
        ...
        k = k + 1 ---@type integer
        locations[k] = location ---@type dot.ux.view.tree.ILeafLocationState
      end
    end
...
---@param uuid                          string
---@return dot.ux.view.tree.INodeState|nil
function M:retrieve(uuid)
  self:__health__()
  return self.statemap[uuid] ---@type dot.ux.view.tree.INodeState|nil
end
...
function M:set_selected(nodeuuid, selected)
  ...
  local tick_selected = self._tick_selected ---@type integer
  local nodestate = self.statemap[nodeuuid] ---@type dot.ux.view.tree.INodeState|nil
  if nodestate ~= nil then
    if selected then
...
---@param uuid                          string
---@param value                         dot.ux.view.tree.CollapseActionEnum
...
function M:collapse(uuid, value, recursive)
  ...
  local statemap = self.statemap ---@type table<string, dot.ux.view.tree.INodeState>
  local state = statemap[uuid] ---@type dot.ux.view.tree.INodeState|nil
  if state == nil then
    ark.reporter.error({
      from = self.fullname,
      subject = "collapse",
  ...
  if recursive then
    tree:quick_traverse(uuid, function(_, node)
      local s = statemap[node.uuid] ---@type dot.ux.view.tree.INodeState
...
function M:mark_node_invisible(nodeuuid)
  self:__health__()
  local statemap = self.statemap ---@type table<string, dot.ux.view.tree.INodeState>
  local nodestate = statemap[nodeuuid] ---@type dot.ux.view.tree.INodeState|nil
  if nodestate ~= nil then
...
function M:__refresh_selected_maximum__()
  ...
  tree:unsafe_traverse(nil, function(ctx)
    ...
    local function recursive(node)
      local childstate = statemap[node.uuid] ---@type dot.ux.view.tree.INodeState
