...
---@class dot.module.searcher.view.filetree.IFileNodeState : ark.view.tree.ILeafNodeState
...
---@class dot.module.searcher.view.filetree.ILeafLocationState : ark.view.tree.ILeafLocationState
