...
local __module_name__ = "dot.module.searcher.finder" ---@type string

---@class dot.module.searcher.finder.IWinOpts
...
---@param props                         dot.module.searcher.IFinderProps
---@return dot.module.searcher.Finder
function M.new(props)
  ...
  if prompt_sign ~= nil then
    ...
    self.prompt_sign_group = ark.var.sign.GROUP_PICKER_FINDER_PROMPT
    self.prompt_sign_name = ark.var.sign.PICKER_FINDER_PROMPT
  end
...
---@param winopts                       dot.module.searcher.finder.IWinOpts
