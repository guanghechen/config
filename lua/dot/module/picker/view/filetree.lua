...
---| fun(ctx: dot.module.picker.view.filetree.IListviewRendererContext, node: ark.c.IFiletreeNode, nodestate: dot.module.picker.view.filetree.IFileNodeState, lnum: integer): ark.view.tree.INodeRenderResult

---@alias dot.module.picker.view.filetree.IListviewLocationRenderer
---| fun(ctx: dot.module.picker.view.filetree.IListviewRendererContext, node: ark.c.IFiletreeNode, nodestate: dot.module.picker.view.filetree.IFileNodeState, locationstate: dot.module.picker.view.filetree.ILocationNodeState, lnum: integer): ark.view.tree.INodeRenderResult

---@alias dot.module.picker.view.filetree.ITreeviewDirectoryRenderer
---| fun(ctx: dot.module.picker.view.filetree.ITreeviewRendererContext, node: ark.c.IFiletreeNode, nodestate: dot.module.picker.view.filetree.IDirectoryNodeState, lnum: integer, folded_depth: integer): ark.view.tree.INodeRenderResult

---@alias dot.module.picker.view.filetree.ITreeviewFileRenderer
---| fun(ctx: dot.module.picker.view.filetree.ITreeviewRendererContext, node: ark.c.IFiletreeNode, nodestate: dot.module.picker.view.filetree.IFileNodeState, lnum: integer): ark.view.tree.INodeRenderResult

---@alias dot.module.picker.view.filetree.ITreeviewLocationRenderer
---| fun(ctx: dot.module.picker.view.filetree.ITreeviewRendererContext, node: ark.c.IFiletreeNode, nodestate: dot.module.picker.view.filetree.IFileNodeState, locationstate: dot.module.picker.view.filetree.ILocationNodeState, lnum: integer): ark.view.tree.INodeRenderResult
