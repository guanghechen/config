  ...
  local actions = {
    attach_node = function()
      ...
      if nodeuuid ~= nil then
        local nodestate = treeview:retrieve(nodeuuid) ---@type dot.ux.view.tree.INodeState|nil
    ...
    toggle_selection = function()
      ...
      for lnum = lnum_from, lnum_to, 1 do
        local nodeuuid = retriever:retrieve_uuid(lnum) ---@type string|nil
        if nodeuuid ~= nil then
          local childstate = treeview:retrieve(nodeuuid) ---@type dot.ux.view.tree.INodeState|nil
...
---@return dot.ux.view.tree.INodeState
function M:__retrieve__(nodeuuid)
  ---@type dot.ux.view.tree.INodeState|nil
...
function M:__retrieve_lnum_parent__(nodeuuid)
  ...
  local nodestate = self._treeview:retrieve(nodeuuid) ---@type dot.ux.view.tree.INodeState|nil
  if nodestate == nil then
    return nil
  end
