...
function M:dispose()
  ...
  local ok6, error6 = pcall(dot.buf.close, preview_bufnr)
...
function M:__create_wins__()
  ...
  dot.win.set_type(input_winnr, dot.win.Types.BOARD)
  ...
  dot.win.set_type(preview_winnr, dot.win.Types.BOARD)
...
function M:__create_input_buf__()
  ...
  vim.bo[bufnr].filetype = dot.filetype.BOARD
...
function M:__layout__()
  ...
  local win_row = vim.fn.screenpos(0, cursor_row, 1).row ---@type integer
