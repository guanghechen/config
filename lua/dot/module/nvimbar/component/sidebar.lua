...
function M.of(position, filetype, get_title)
  ...
  local component = {
    ...
    render = function(context, remain_width)
      ...
      text_title = ark.icon.symbols.sep_left .. text_title ---@type string
      hl_text_title = txt(ark.icon.symbols.sep_left, hln_sep) .. hl_text_title ---@type string

      text_title = text_title .. ark.icon.symbols.sep_right ---@type string
      hl_text_title = hl_text_title .. txt(ark.icon.symbols.sep_right, hln_sep) ---@type string
