local Widget = require("dot.module.explorer.widget")
...
---@type dot.module.explorer.Widget|nil
M.widget = nil
    ...
    },
    {
      ...
      snapshot = function()
        ...
        if viewtype == "tree" then
          return dot.icon.symbols.flag_tree, "picker_flag_blue"
        else
          return dot.icon.symbols.flag_list, "picker_flag_blue"
        end
      end,
    },
    {
