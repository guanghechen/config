---@class dot.theme.hlgroup.vsc.widget
local M = {}
...
function M.gen_hlgroup_map(context)
  ...
  return {
    ...
    f_acp_plan_high = { fg = u.red, bold = true },
    ...
    f_acp_diff_delete = { fg = u.fg1, bg = cs.mix(u.bg0, u.red, 20) },
    f_acp_diff_change = { fg = u.fg1, bg = cs.mix(u.bg0, u.yellow, 20) },
    f_acp_diff_add_inline = { fg = u.bg0, bg = u.green },
    f_acp_diff_delete_inline = { fg = u.bg0, bg = u.red },
    f_acp_diff_header = { fg = u.purple, bold = true },
    f_acp_diff_hunk = { fg = u.aqua, bold = true },
    f_acp_diff_stat_add = { fg = u.green, bold = true },
    f_acp_diff_stat_del = { fg = u.red, bold = true },
