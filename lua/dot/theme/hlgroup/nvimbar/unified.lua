...
local __module_name__ = "dot.theme.hlgroup.nvimbar.unified" ---@type string

---@class dot.theme.hlgroup.nvimbar.unified
local M = {}
...
function M.gen_hlgroup_map(context)
  ...
  local hlgroup_map = {
    ...
    lsp_icon_biome = { fg = c.brightBlue, bg = "bg_bar" },
    ...
    lsp_icon_tsc = { fg = c.brightBlue, bg = "bg_bar" },
