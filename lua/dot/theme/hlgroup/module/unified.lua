...
local __module_name__ = "dot.theme.hlgroup.module.unified" ---@type string

---@class dot.theme.hlgroup.module.unified
local M = {}
...
function M.gen_hlgroup_map(context)
  ...
  return {
    ...
    m_pl_normal = { bg = t and u.none or cs.mix(u.bg0, u.bg1, 80) },
    ...
    ---module/term
    m_term_bg = { bg = t and u.none or u.bg0 },
