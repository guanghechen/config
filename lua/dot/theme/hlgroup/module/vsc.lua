...
local __module_name__ = "dot.theme.hlgroup.module.vsc" ---@type string

---@class dot.theme.hlgroup.module.vsc
local M = {}
...
function M.gen_hlgroup_map(context)
  ...
  return {
    ...
    m_pk_search_spinner_aqua = { fg = c.accentAqua, bg = bg_pane, bold = true },
    m_pk_search_spinner_blue = { fg = c.accentBlue, bg = bg_pane, bold = true },
    m_pk_search_spinner_pink = { fg = c.accentPink, bg = bg_pane, bold = true },
    m_pk_search_spinner_purple = { fg = c.accentPurple, bg = bg_pane, bold = true },
