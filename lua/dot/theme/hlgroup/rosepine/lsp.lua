...
local __module_name__ = "dot.theme.hlgroup.rosepine.lsp" ---@type string

---@class dot.theme.hlgroup.rosepine.lsp
local M = {}
...
function M.gen_hlgroup_map(context)
  ...
  return {
    ...
    ["@lsp.type.unresolvedReference"] = { undercurl = true, sp = c.love },
    ["@lsp.type.variable"] = { link = "@variable" },
    ["@lsp.typemod.class.declaration"] = { link = "@type.definition" },
    ["@lsp.typemod.class.declaration.lua"] = { link = "@type.definition" },
    ...
    ["@lsp.typemod.keyword.documentation.lua"] = { fg = c.rose },
    ...
    ["@lsp.typemod.parameter.documentation"] = { fg = c.text, italic = true },
