...
local __module_name__ = "dot.theme.hlgroup.lsp.tokyonight" ---@type string

---@class dot.theme.hlgroup.lsp.tokyonight
local M = {}
...
function M.gen_hlgroup_map(context)
  ...
  return {
    ["@lsp.mod.declaration"] = {},
    ["@lsp.mod.definition"] = {},
    ["@lsp.mod.deprecated"] = { fg = u.fg3, strikethrough = true },
    ...
    ["@lsp.type.interface"] = { fg = cs.mix(u.brightBlue, u.fg1, 70) },
    ...
    ["@lsp.type.unresolvedReference"] = { undercurl = true, sp = u.red },
    ["@lsp.type.variable"] = {},
    ["@lsp.typemod.class.declaration"] = { link = "@type.definition" },
    ["@lsp.typemod.class.declaration.lua"] = { fg = cs.mix(u.brightBlue, u.fg1, 60), italic = true },
    ...
    ["@lsp.typemod.keyword.documentation.lua"] = { fg = u.brightBlue, italic = true },
    ...
    ["@lsp.typemod.parameter.documentation"] = { fg = u.brightBlue, italic = true },
    ...
    ["@lsp.typemod.type.defaultLibrary"] = { fg = u.brightBlue },
    ["@lsp.typemod.typeAlias.defaultLibrary"] = { fg = u.brightBlue },
