...
function M.default_gen_hlgroup_map(context)
  ...
  local pair_surfaces = context.scheme.theme == "kanagawa" or context.scheme.theme == "tokyonight"
  ...
  return {
    ...
    ---matched pairs
    f_matched_pairs_0 = { fg = u.green, bg = pair_surfaces and u.bg3 or u.bg4, bold = true, italic = true },
    ...
    f_md_code_fallback = { fg = pair_surfaces and u.fg1 or u.fg4 },
    f_md_code_header = { fg = u.purple, bg = u.bg2 },
    f_md_code_inline = { fg = u.orange, bg = pair_surfaces and u.bg2 or u.bg4 },
    ...
    f_md_text_inline_highlight = { fg = u.bg0, bg = pair_surfaces and u.yellow or cs.mix(u.bg0, u.yellow, 45) },
