...
local __module_name__ = "dot.theme.hlgroup.basic.gruvbox" ---@type string

---@class dot.theme.hlgroup.basic.gruvbox
local M = {}
...
function M.gen_hlgroup_map(context)
  ...
  local hlgroup_map = {
    ...
    Exception = { fg = c.red },
    FloatActiveBorder = { link = t and "ms_b_none" or "ms_b_bg0" },
    FloatActiveTitle = { link = t and "ms_b_none" or "ms_b_bg0" },
    FloatBorder = { fg = c.bg2, bg = t and c.none or c.bg0, bold = true },
    ...
    NormalNC = { fg = c.fg1, bg = t and c.none or c.bg1 },
