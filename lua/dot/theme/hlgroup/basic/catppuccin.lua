...
function M.gen_hlgroup_map(context)
  ...
  local hlgroup_map = {
    ...
    FloatBorder = { fg = c.blue, bg = t and c.mantle or c.none, blend = t and 50 or 0 },
    FloatNormal = { fg = c.text, bg = t and c.mantle or c.none },
    FloatTitle = { fg = c.subtext0, bg = t and c.mantle or c.none },
