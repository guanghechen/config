...
local __module_name__ = "dot.theme.hlgroup.basic.catppuccin" ---@type string

---@class dot.theme.hlgroup.basic.catppuccin
local M = {}
...
function M.gen_hlgroup_map(context)
  ...
  local hlgroup_map = {
    ...
    FloatNormal = { fg = c.text, bg = t and c.none or c.mantle },
    FloatTitle = { fg = c.subtext0, bg = t and c.none or c.mantle },
    ...
    LspReferenceRead = { bg = c.surface1, bold = true, underline = true },
    LspReferenceText = { bg = c.surface1, bold = true, underline = true },
    LspReferenceWrite = { bg = c.surface1, bold = true, underline = true },
    ...
    Normal = { fg = c.text, bg = t and u.none or u.bg0 },
    NormalFloat = { fg = c.text, bg = t and c.none or c.mantle },
    NormalNC = { fg = c.text, bg = t and u.none or u.bg1 },
    Number = { fg = c.peach },
