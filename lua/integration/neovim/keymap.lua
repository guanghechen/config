...
ms({ "i", "n", "t", "v" }, { "<C-a>`", "<D-`>", "<M-`>" }, K.ux.resume_last_widget)
...
--#[c]lipboard------------------------------------------------------------------------------------
ms({ "n", "v" }, "<leader>cp", K.clipboard.paste)
------------------------------------------------------------------------------------#[c]lipboard--
...
--#[t]ab--------------------------------------------------------------------------------------------
ms({ "i", "n", "t", "v" }, "<C-S-,>", K.tab.focus_left)
ms({ "i", "n", "t", "v" }, "<C-S-.>", K.tab.focus_right)
ms({ "i", "n", "t", "v" }, "<C-,>", K.tab.focus_left)
ms({ "i", "n", "t", "v" }, "<C-.>", K.tab.focus_right)
...
ms({ "i", "n", "t", "v" }, { "<C-a>t", "<D-t>", "<M-t>" }, K.term.toggle)
...
ms({ "i", "n", "t", "v" }, "<C-S-h>", K.win.split_left)
ms({ "i", "n", "t", "v" }, "<C-S-j>", K.win.split_below)
ms({ "i", "n", "t", "v" }, "<C-S-k>", K.win.split_above)
ms({ "i", "n", "t", "v" }, "<C-S-l>", K.win.split_right)
ms({ "n", "v" }, "<leader>wH", K.win.history)
ms({ "n", "v" }, "<leader>wd", K.win.close)
ms({ "n", "v" }, "<leader>wh", K.win.split_left)
...
ms({ "n", "v" }, "<leader>wr", K.win.mark_sourcefile)
