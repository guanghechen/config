...
--#[d]ebug------------------------------------------------------------------------------------------
ms({ "n", "v" }, "<leader>ii", K.debug.inspect_pos)
ms({ "n", "v" }, "<leader>is", K.debug.inspect_state)
ms({ "n", "v" }, "<leader>it", K.debug.inspect_tree)
ms({ "n", "v" }, "<leader>iw", K.debug.inspect_window)
------------------------------------------------------------------------------------------#[d]ebug--
...
--#[p] clipboard------------------------------------------------------------------------------------
ms({ "i", "n", "v" }, "<leader>pp", K.clipboard.paste)
------------------------------------------------------------------------------------#[p] clipboard--
