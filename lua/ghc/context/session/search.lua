...
local M = require("ghc.context.session.mod")
  :register("search_exclude_patterns", search_exclude_patterns, true, false)
  :register("search_flag_case_sensitive", search_flag_case_sensitive, true, false)
  :register("search_flag_gitignore", search_flag_gitignore, true, false)
  :register("search_flag_regex", search_flag_regex, true, false)
  :register("search_flag_replace", search_flag_replace, true, false)
  :register("search_include_patterns", search_include_patterns, true, false)
  :register("search_max_filesize", search_max_filesize, true, false)
  :register("search_max_matches", search_max_matches, true, false)
  :register("search_paths", search_paths, true, false)
  :register("search_pattern", search_pattern, true, false)
  :register("search_replace_pattern", search_replace_pattern, true, false)
  :register("search_scope", search_scope, true, false)
