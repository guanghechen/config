...
local function render_buf(bufnr, is_current, is_first)
  ...
  local text_indicator = is_current and "▎" or (is_first and " " or "▏") ---@type string
  ...
  local hl_indicator = is_current and "f_tl_buf_indicator_cur" or "f_tl_buf_indicator" ---@type string
  ...
  local hl_text_indicator = eve.nvimbar.txt(text_indicator, hl_indicator)
  ...
  local width = vim.api.nvim_strwidth(text_indicator .. text_icon .. text_title .. text_mod) ---@type integer
