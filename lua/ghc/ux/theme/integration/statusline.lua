...
local function gen_hlgroup_map(params)
  local mode = params.scheme.mode ---@type t.eve.e.ThemeMode
  ...
  local hlgroup_map = {
    ...
    f_sl_pos = { fg = mode == "dark" and c.black or c.white, bg = c.bg_blue },
    ...
    f_sl_username = { fg = mode == "dark" and c.black or c.white, bg = c.bg_cyan },
  }
  return hlgroup_map
end
