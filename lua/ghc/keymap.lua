...
mapkey({ "i", "n", "v" }, "<C-C>", actions.enhance.copy_current_buffer_filepath, "copy: current buffer filepath")
...
mapkey(
  "n",
  "<leader>me",
  actions.bookmark.edit_bookmark_annotation_on_current_line,
  "bookmark: edit bookmark (current line)"
)
mapkey(
  "n",
  "<leader>mc",
  actions.bookmark.clear_bookmark_on_current_buffer,
  "bookmark: clear bookmark (current buffer)"
)
mapkey(
  "n",
  "<leader>m[",
  actions.bookmark.goto_prev_bookmark_on_current_buffer,
  "bookmark: goto prev bookmark (current buffer)"
)
mapkey(
  "n",
  "<leader>m]",
  actions.bookmark.goto_next_bookmark_on_current_buffer,
  "bookmark: goto next bookmark (current buffer)"
)
...
mapkey(
  ...
  "window: resize -(v:count) horizontally.",
  true
)
