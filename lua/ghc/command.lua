...
command
  .implement({
    ...
    action = function()
      require("ghc.action.buf.close").close()
    end,
  })
  .implement({
    uuid = command.definitions.buf.close_to_leftest.uuid,
    action = function()
      require("ghc.action.buf.close").close_to_leftest()
    end,
  })
  .implement({
    uuid = command.definitions.buf.close_to_rightest.uuid,
    action = function()
      require("ghc.action.buf.close").close_to_rightest()
    end,
  })
  .implement({
    uuid = command.definitions.buf.close_others.uuid,
    action = function()
      require("ghc.action.buf.close").close_others()
    end,
  })
...
for i = 1, 10, 1 do
  command.implement({
    ...
    action = function()
      require("ghc.action.buf.focus").focus(i)
    end,
  })
end
  ...
  .implement({
    ...
    action = function(args)
      ...
      if bufnr ~= nil and vim.api.nvim_buf_is_valid(bufnr) then
        require("ghc.action.buf.focus").open(bufnr)
      end
    end,
  })
  .implement({
    ...
    action = function(args)
      ...
      if bufid ~= nil then
        require("ghc.action.buf.focus").focus(bufid)
      end
    end,
  })
  .implement({
    ...
    action = function(args)
      ...
      require("ghc.action.buf.focus").focus_left(ok and step or nil)
    end,
  })
  .implement({
    ...
    action = function(args)
      local ok, step = pcall(tonumber, args)
      require("ghc.action.buf.focus").focus_right(ok and step or nil)
    end,
  })
...
command.implement({
  ...
  action = function()
    require("ghc.action.buf.new").new()
  end,
})
...
command.implement({
  ...
  action = function()
    require("ghc.action.buf.pin").toggle_pin()
  end,
})
...
command.implement({
  ...
  action = function()
    require("ghc.action.buf.save").save()
  end,
})
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.buf.swap").swap_left()
    end,
  })
  .implement({
    uuid = command.definitions.buf.swap_right.uuid,
    action = function()
      require("ghc.action.buf.swap").swap_right()
    end,
  })
...
command.implement({
  ...
  action = function()
    ...
    require("ghc.action.code.run").run(filepath)
  end,
})
...
command
  .implement({
    ...
    action = function(arg)
      local filepath = path.current_filepath() ---@type string
      require("ghc.action.copy").copy_filepath(filepath, arg)
    end,
  })
  .implement({
    ...
    action = function()
      local filepath = path.current_filepath() ---@type string
      require("ghc.action.copy").copy_filepath_absolute(filepath)
    end,
  })
  .implement({
    ...
    action = function()
      local filepath = path.current_filepath() ---@type string
      require("ghc.action.copy").copy_filepath_relative(filepath)
    end,
  })
...
command.implement({
  ...
  action = function()
    require("ghc.action.copy").copy_char_under_cursor()
  end,
})
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.find.buffers").find_buffers()
    end,
  })
  .implement({
    uuid = command.definitions.find.explorer.uuid,
    action = function()
      require("ghc.action.find.explorer").find_explorer()
    end,
  })
  .implement({
    uuid = command.definitions.find.files.uuid,
    action = function()
      require("ghc.action.find.files").find_files()
    end,
  })
  .implement({
    uuid = command.definitions.find.files_cwd.uuid,
    action = function()
      require("ghc.action.find.files").find_files_cwd()
    end,
  })
  .implement({
    uuid = command.definitions.find.files_directory.uuid,
    action = function()
      require("ghc.action.find.files").find_files_directory()
    end,
  })
  .implement({
    uuid = command.definitions.find.files_workspace.uuid,
    action = function()
      require("ghc.action.find.files").find_files_workspace()
    end,
  })
  .implement({
    uuid = command.definitions.find.git_not_committed.uuid,
    action = function()
      require("ghc.action.find.git").find_git_not_committed()
    end,
  })
  .implement({
    uuid = command.definitions.find.highlights.uuid,
    action = function()
      require("ghc.action.find.highlights").find_highlights()
    end,
  })
  .implement({
    uuid = command.definitions.find.pinned_files.uuid,
    action = function()
      require("ghc.action.find.pinned_files").find_pinned_files()
    end,
  })
  .implement({
    uuid = command.definitions.find.vim_options.uuid,
    action = function()
      require("ghc.action.find.vim_options").find_vim_options()
    end,
  })
...
command.implement({
  ...
  action = function()
    require("ghc.action.git.browse").browse()
  end,
})
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.lsp.reference").goto_definitions()
    end,
  })
  .implement({
    uuid = command.definitions.lsp.goto_implementations.uuid,
    action = function()
      require("ghc.action.lsp.reference").goto_implementations()
    end,
  })
  .implement({
    uuid = command.definitions.lsp.goto_references.uuid,
    action = function()
      require("ghc.action.lsp.reference").goto_references()
    end,
  })
  .implement({
    uuid = command.definitions.lsp.goto_type_definitions.uuid,
    action = function()
      require("ghc.action.lsp.reference").goto_type_definitions()
    end,
  })
...
command.implement({
  ...
  action = function()
    require("ghc.action.refresh").refresh_all()
  end,
})
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.search.files").replace_files()
    end,
  })
  .implement({
    uuid = command.definitions.replace.files_in_buffer.uuid,
    action = function()
      require("ghc.action.search.files").replace_files_in_buffer()
    end,
  })
  .implement({
    uuid = command.definitions.replace.files_in_cwd.uuid,
    action = function()
      require("ghc.action.search.files").replace_files_in_cwd()
    end,
  })
  .implement({
    uuid = command.definitions.replace.files_in_directory.uuid,
    action = function()
      require("ghc.action.search.files").replace_files_in_directory()
    end,
  })
  .implement({
    uuid = command.definitions.replace.files_in_workspace.uuid,
    action = function()
      require("ghc.action.search.files").replace_files_in_workspace()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.search.files").search_files()
    end,
  })
  .implement({
    uuid = command.definitions.search.files_in_buffer.uuid,
    action = function()
      require("ghc.action.search.files").search_files_in_buffer()
    end,
  })
  .implement({
    uuid = command.definitions.search.files_in_cwd.uuid,
    action = function()
      require("ghc.action.search.files").search_files_in_cwd()
    end,
  })
  .implement({
    uuid = command.definitions.search.files_in_directory.uuid,
    action = function()
      require("ghc.action.search.files").search_files_in_directory()
    end,
  })
  .implement({
    uuid = command.definitions.search.files_in_workspace.uuid,
    action = function()
      require("ghc.action.search.files").search_files_in_workspace()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.session").restore()
    end,
  })
  .implement({
    uuid = command.definitions.session.restore_autosaved.uuid,
    action = function()
      require("ghc.action.session").restore_autosaved()
    end,
  })
  .implement({
    uuid = command.definitions.session.save.uuid,
    action = function()
      require("ghc.action.session").save()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.tab.close").close()
    end,
  })
  .implement({
    uuid = command.definitions.tab.close_to_leftest.uuid,
    action = function()
      require("ghc.action.tab.close").close_to_leftest()
    end,
  })
  .implement({
    uuid = command.definitions.tab.close_to_rightest.uuid,
    action = function()
      require("ghc.action.tab.close").close_to_rightest()
    end,
  })
  .implement({
    uuid = command.definitions.tab.close_others.uuid,
    action = function()
      require("ghc.action.tab.close").close_others()
    end,
  })
...
for i = 1, 10, 1 do
  command.implement({
    ...
    action = function()
      require("ghc.action.tab.focus").focus(i)
    end,
  })
end
...
command
  .implement({
    ...
    action = function(args)
      ...
      if tabid ~= nil then
        require("ghc.action.tab.focus").focus(tabid)
      end
    end,
  })
  .implement({
    ...
    action = function(args)
      local ok, step = pcall(tonumber, args)
      require("ghc.action.tab.focus").focus_left(ok and step or nil)
    end,
  })
  .implement({
    ...
    action = function(args)
      local ok, step = pcall(tonumber, args)
      require("ghc.action.tab.focus").focus_right(ok and step or nil)
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.tab.new").new()
    end,
  })
  .implement({
    ...
    action = function()
      ...
      require("ghc.action.tab.new").new(bufnr)
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.term.toggle").toggle_cwd()
    end,
  })
  .implement({
    uuid = command.definitions.term.toggle_directory.uuid,
    action = function()
      require("ghc.action.term.toggle").toggle_directory()
    end,
  })
  .implement({
    uuid = command.definitions.term.toggle_workspace.uuid,
    action = function()
      require("ghc.action.term.toggle").toggle_workspace()
    end,
  })
  .implement({
    uuid = command.definitions.term.lazygit_cwd.uuid,
    action = function()
      require("ghc.action.term.lazygit").lazygit_cwd()
    end,
  })
  .implement({
    uuid = command.definitions.term.lazygit_workspace.uuid,
    action = function()
      require("ghc.action.term.lazygit").lazygit_workspace()
    end,
  })
  .implement({
    uuid = command.definitions.term.lazygit_file_history.uuid,
    action = function()
      require("ghc.action.term.lazygit").lazygit_file_history()
    end,
  })
...
command
  .implement({
    ...
    action = function(arg)
      require("ghc.action.toggle").list(arg)
    end,
  })
  .implement({
    uuid = command.definitions.toggle.flight.uuid,
    action = function(arg)
      require("ghc.action.toggle").toggle_flight(arg)
    end,
  })
  .implement({
    uuid = command.definitions.toggle.relativenumber.uuid,
    action = function()
      require("ghc.action.toggle").toggle_relativenumber()
    end,
  })
  .implement({
    uuid = command.definitions.toggle.theme.uuid,
    action = function(arg)
      require("ghc.action.toggle").toggle_theme(arg)
    end,
  })
  .implement({
    uuid = command.definitions.toggle.theme_variant.uuid,
    action = function()
      require("ghc.action.toggle").toggle_theme_variant()
    end,
  })
  .implement({
    uuid = command.definitions.toggle.transparency.uuid,
    action = function()
      require("ghc.action.toggle").toggle_transparency()
    end,
  })
  .implement({
    uuid = command.definitions.toggle.wrap.uuid,
    action = function()
      require("ghc.action.toggle").toggle_wrap()
    end,
  })
...
command
  .implement({
    ...
    action = function(arg)
      require("ghc.action.ux").reload_theme(arg)
    end,
  })
  .implement({
    uuid = command.definitions.ux.resume_last_widget.uuid,
    action = function()
      require("ghc.action.ux").resume_last_widget()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.win.close").close()
    end,
  })
  .implement({
    uuid = command.definitions.win.close_others.uuid,
    action = function()
      require("ghc.action.win.close").close_others()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.win.focus").focus_top()
    end,
  })
  .implement({
    uuid = command.definitions.win.focus_right.uuid,
    action = function()
      require("ghc.action.win.focus").focus_right()
    end,
  })
  .implement({
    uuid = command.definitions.win.focus_bottom.uuid,
    action = function()
      require("ghc.action.win.focus").focus_bottom()
    end,
  })
  .implement({
    uuid = command.definitions.win.focus_left.uuid,
    action = function()
      require("ghc.action.win.focus").focus_left()
    end,
  })
  .implement({
    uuid = command.definitions.win.focus_prev.uuid,
    action = function()
      require("ghc.action.win.focus").focus_prev()
    end,
  })
  .implement({
    uuid = command.definitions.win.focus_next.uuid,
    action = function()
      require("ghc.action.win.focus").focus_next()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.win.history").history()
    end,
  })
  .implement({
    uuid = command.definitions.win.history_backward.uuid,
    action = function()
      require("ghc.action.win.history").history_backward()
    end,
  })
  .implement({
    uuid = command.definitions.win.history_forward.uuid,
    action = function()
      require("ghc.action.win.history").history_forward()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.win.resize").resize_horizontal_minus()
    end,
  })
  .implement({
    uuid = command.definitions.win.resize_horizontal_plus.uuid,
    action = function()
      require("ghc.action.win.resize").resize_horizontal_plus()
    end,
  })
  .implement({
    uuid = command.definitions.win.resize_vertical_minus.uuid,
    action = function()
      require("ghc.action.win.resize").resize_vertical_minus()
    end,
  })
  .implement({
    uuid = command.definitions.win.resize_vertical_plus.uuid,
    action = function()
      require("ghc.action.win.resize").resize_vertical_plus()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.win.scroll").scroll_down()
    end,
  })
  .implement({
    uuid = command.definitions.win.scroll_up.uuid,
    action = function()
      require("ghc.action.win.scroll").scroll_up()
    end,
  })
...
command
  .implement({
    ...
    action = function()
      require("ghc.action.win.split").split_horizontal()
    end,
  })
  .implement({
    uuid = command.definitions.win.split_vertical.uuid,
    action = function()
      require("ghc.action.win.split").split_vertical()
    end,
  })
