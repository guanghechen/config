...
local M = {
  ...
  render = function()
    ...
    local flag_regex_enabled = ghc.context.session.search_flag_regex:get_snapshot() ---@type boolean
    local flag_case_sensitive_enabled = ghc.context.session.search_flag_case_sensitive:get_snapshot() ---@type boolean
