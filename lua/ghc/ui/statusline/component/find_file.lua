...
function M.renderer()
  ...
  ---@type boolean
  local enable_regex = context.repo.find_file_enable_regex:get_snapshot()

  ---@type boolean
  local enable_case_sensitive = context.repo.find_file_enable_case_sensitive:get_snapshot()
