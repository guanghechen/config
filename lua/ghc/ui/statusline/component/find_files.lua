...
---@type string
local fn_toggle_find_flag_gitignore = fml.G.register_anonymous_fn(function()
...
local M = {
  ...
  render = function()
    ...
    local hl_text = fml.nvimbar.btn(hl_text_scope, fn_toggle_find_scope)
      .. fml.nvimbar.btn(hl_text_flag_gitignore, fn_toggle_find_flag_gitignore)
    local width = vim.fn.strwidth(text_scope) + vim.fn.strwidth(text_flag_gitignore)
