...
local M = {
  ...
  render = function(context)
    ...
    local text_hl = fc.nvimbar.txt(text_count_error, "f_sl_diagnostics_error")
        .. fc.nvimbar.txt(text_count_warn, "f_sl_diagnostics_warn")
        .. fc.nvimbar.txt(text_count_hint, "f_sl_diagnostics_hint")
        .. fc.nvimbar.txt(text_count_info, "f_sl_diagnostics_info")
