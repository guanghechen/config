...
local function gen_hlgroup_map(params)
  ...
  local hlgroup_map = {
    ...
    f_tl_sidebar_blank = { fg = c.white, bg = t and "none" or c.black2 },
    f_tl_sidebar_text = { fg = c.blue, bg = t and "none" or c.black2 },
    f_tl_sidebar_split = { fg = c.line, bg = t and "none" or c.black2 },
