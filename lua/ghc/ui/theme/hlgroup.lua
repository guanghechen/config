---@class ghc.ui.theme.hlgroup.IGenHighlightConfigMapParams
---@field public scheme                 fml.types.ui.theme.IScheme
---@field public transparency           boolean

---@param params                        ghc.ui.theme.hlgroup.IGenHighlightConfigMapParams
...
local function gen_hlgroup_map(params)
  ...
  ---@type table<string, fml.types.ui.theme.IHighlightGroup>
  local hlgroup_map = {
    ------------------------------------------guanghechen-------------------------------------------
    ...
    ---statusline
    ghc_statusline_bg_text = { fg = t and "none" or c.statusline_bg, bg = t and "none" or c.statusline_bg },
    ghc_statusline_copilot_status = { fg = c.white, bg = t and "none" or c.statusline_bg },
    ghc_statusline_copilot_status_Normal = { fg = c.blue, bg = t and "none" or c.statusline_bg },
    ghc_statusline_copilot_status_Warning = { fg = c.yellow, bg = t and "none" or c.statusline_bg },
    ghc_statusline_copilot_status_InProgress = { fg = c.cyan, bg = t and "none" or c.statusline_bg },
    ghc_statusline_cwd_text = { fg = c.white, bg = t and "none" or c.statusline_bg },
    ghc_statusline_diagnostics_error = { fg = c.red, bg = t and "none" or c.statusline_bg },
    ghc_statusline_diagnostics_warn = { fg = c.yellow, bg = t and "none" or c.statusline_bg },
    ghc_statusline_diagnostics_hint = { fg = c.purple, bg = t and "none" or c.statusline_bg },
    ghc_statusline_diagnostics_info = { fg = c.green, bg = t and "none" or c.statusline_bg },
    ghc_statusline_fileformat_text = { fg = c.white, bg = t and "none" or c.statusline_bg },
    ghc_statusline_filepath_text = { fg = c.white, bg = t and "none" or c.statusline_bg },
    ghc_statusline_filetype_text = { fg = c.white, bg = t and "none" or c.statusline_bg },
    ghc_statusline_find_file_flag = { fg = c.white, bg = t and "none" or c.grey },
    ghc_statusline_find_file_flag_enabled = { fg = c.black, bg = c.nord_blue },
    ghc_statusline_find_file_flag_scope = { fg = c.black, bg = c.baby_pink },
    ghc_statusline_find_recent_flag = { fg = c.white, bg = t and "none" or c.grey },
    ghc_statusline_find_recent_flag_enabled = { fg = c.black, bg = c.nord_blue },
    ghc_statusline_find_recent_flag_scope = { fg = c.black, bg = c.baby_pink },
    ghc_statusline_git_text = { fg = c.white, bg = t and "none" or c.statusline_bg },
    ghc_statusline_lsp_text = { fg = c.white, bg = t and "none" or c.statusline_bg },
    ghc_statusline_mode_text_normal = { fg = c.nord_blue, bg = t and "none" or c.statusline_bg },
    ghc_statusline_mode_text_visual = { fg = c.cyan, bg = t and "none" or c.statusline_bg },
    ghc_statusline_mode_text_insert = { fg = c.dark_purple, bg = t and "none" or c.statusline_bg },
    ghc_statusline_mode_text_terminal = { fg = c.green, bg = t and "none" or c.statusline_bg },
    ghc_statusline_mode_text_nterminal = { fg = c.yellow, bg = t and "none" or c.statusline_bg },
    ghc_statusline_mode_text_replace = { fg = c.orange, bg = t and "none" or c.statusline_bg },
    ghc_statusline_mode_text_confirm = { fg = c.teal, bg = t and "none" or c.statusline_bg },
    ghc_statusline_mode_text_command = { fg = c.vibrant_green, bg = t and "none" or c.statusline_bg },
    ghc_statusline_mode_text_select = { fg = c.blue, bg = t and "none" or c.statusline_bg },
    ghc_statusline_noice_text_command = { fg = c.white, bg = t and "none" or c.statusline_bg },
    ghc_statusline_noice_text_mode = { fg = c.yellow, bg = t and "none" or c.statusline_bg },
    ghc_statusline_pos_text = { fg = c.white, bg = t and "none" or c.statusline_bg },
    ghc_statusline_readonly_text = { fg = c.orange, bg = t and "none" or c.statusline_bg },
    ghc_statusline_search_flag = { fg = c.white, bg = t and "none" or c.grey },
    ghc_statusline_search_flag_enabled = { fg = c.black, bg = c.nord_blue },
    ghc_statusline_search_flag_scope = { fg = c.black, bg = c.baby_pink },
    ghc_statusline_username_text = { fg = c.black, bg = c.cyan },
    ...
    ---lsp
    ["@lsp.type.class"] = { link = c.Structure },
    ["@lsp.type.decorator"] = { link = c.Function },
    ["@lsp.type.enum"] = { link = c.Type },
    ["@lsp.type.enumMember"] = { link = c.Constant },
    ["@lsp.type.function"] = { link = "@function" },
    ["@lsp.type.interface"] = { link = c.Structure },
    ["@lsp.type.macro"] = { link = "@macro" },
    ["@lsp.type.method"] = { link = "@function.method" },
    ["@lsp.type.namespace"] = { link = "@module" },
    ["@lsp.type.parameter"] = { link = "@variable.parameter" },
    ["@lsp.type.property"] = { link = "@property" },
    ["@lsp.type.struct"] = { link = c.Structure },
    ["@lsp.type.type"] = { link = "@type" },
    ["@lsp.type.typeParamater"] = { link = c.TypeDef },
    ...
    MasonHighlightBlockBold = { link = c.MasonHighlightBlock },
    MasonHeaderSecondary = { link = c.MasonHighlightBlock },
    ...
    TroubleSignError = { link = c.DiagnosticError },
    TroubleText = { fg = c.white },
    TroubleFile = { fg = c.yellow },
    TroubleFoldIcon = { link = c.Folded },
    TroubleNormal = { fg = c.white },
    TroubleLocation = { fg = c.red },
    TroubleIndent = { link = c.Comment },
