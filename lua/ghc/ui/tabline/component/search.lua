...
local M = {
  ...
  render = function(context, remain_width)
    ...
    local is_win_active = vim.bo[bufnr_cur].ft == fml.constant.FT_SEARCH_REPLACE
    local indicator = is_win_active and symbols.win_indicator_active or symbols.win_indicator

    local text = "󰍉 Search/Replace" ---@type string
    ...
    local hl_text = fml.nvimbar.txt(indicator, "f_wl_indicator")
      .. fml.nvimbar.txt(left_blank, "f_tl_search_blank")
