...
---@field public find_recent_enable_case_sensitive guanghechen.observable.Observable
...
local context = Viewmodel.new({
  ...
  :register("find_recent_enable_case_sensitive", Observable.new(false), true)
...
util_observable.watch_observables({
  ...
  context.find_recent_enable_case_sensitive,
