...
---@class ghc.action.search.files.context
local M = {}
...
function M.edit_config()
  ---@class ghc.action.search.files.IConfigData
  ...
  ---@type ghc.action.search.files.IConfigData
  local data = {
    keyword = s_keyword,
  ...
  local setting = fml.ux.Setting.new({
    ...
    validate = function(raw_data)
      ...
      ---@cast raw_data ghc.action.search.files.IConfigData
    ...
    on_confirm = function(raw_data)
      vim.schedule(function()
        ...
        ---@cast raw ghc.action.search.files.IConfigData
...
function M.get_search()
  if _search == nil then
    ...
    local keybindings = require("ghc.action.search.files.keybindings")
