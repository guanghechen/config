...
local statusline_items = {
  ...
  },
  {
    ...
    state = state.search.flag_gitignore,
  ...
  },
  {
    ...
    state = state.search.flag_case_sensitive,
  ...
  },
  {
    ...
    state = state.search.flag_replace,
...
---@class ghc.action.search.files.keybindings
local M = {}
