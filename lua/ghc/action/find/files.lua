local __module_name__ = "ghc.action.find" ---@type string
...
---@class ghc.action.find.files.actions
local actions = {
  ---@return nil
  edit_config = function()
    ---@class ghc.action.find.files.actions.IConfigData
    ---@field public exclude_patterns       string[]

    local f_exclude_patterns = state.find.excludes:snapshot() ---@type string

    ---@type ghc.action.find.files.actions.IConfigData
    local data = {
    ...
    local setting = fml.ux.Setting.new({
      ...
      validate = function(raw_data)
        ...
        ---@cast raw_data ghc.action.find.files.actions.IConfigData
      ...
      on_confirm = function(raw_data)
        vim.schedule(function()
          ...
          ---@cast raw ghc.action.find.files.actions.IConfigData
