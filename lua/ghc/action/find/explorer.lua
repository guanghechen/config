...
---@class ghc.action.find.explorer.IDirItem
---@field public items                  ghc.action.find.explorer.IFileItem[]
...
---@class ghc.action.find.explorer.IFileItem
...
local dir_datamap = {} ---@type table<string, ghc.action.find.explorer.IDirItem>
local file_datamap = {} ---@type table<string, ghc.action.find.explorer.IFileItem>

---@param dirpath                       string
---@param force                         boolean
---@return ghc.action.find.explorer.IDirItem
local function fetch_diritem(dirpath, force)
  local diritem = (not force) and dir_datamap[dirpath] or nil ---@type ghc.action.find.explorer.IDirItem|nil
  if diritem == nil then
    local items = {} ---@type ghc.action.find.explorer.IFileItem[]
    ...
    ---@type ghc.action.find.explorer.IDirItem
    diritem = {
      items = items,
  ...
  if _select == nil then
    ...
    local provider = {
      fetch_data = function(force)
        ...
        local diritem = fetch_diritem(dirpath, force) ---@type ghc.action.find.explorer.IDirItem
      ...
      fetch_preview_data = function(item)
        local fileitem = file_datamap[item.uuid] ---@type ghc.action.find.explorer.IFileItem|nil
        ...
        local diritem = dir_datamap[dirpath] ---@type ghc.action.find.explorer.IDirItem|nil
        if diritem == nil then
        ...
        elseif fileitem.type == "directory" then
          ...
          local c_diritem = fetch_diritem(fileitem.path, false) ---@type ghc.action.find.explorer.IDirItem
