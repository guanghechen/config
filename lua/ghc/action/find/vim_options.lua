...
---@class ghc.action.find.vim_options.IItemData
...
---@class ghc.action.find.vim_options.IItem : fml.t.ux.select.IItem
---@field public data                   ghc.action.find.vim_options.IItemData
...
local provider = {
  fetch_data = function()
    ...
    for name, info in pairs(vim.api.nvim_get_all_options_info()) do
      ...
      ---@type ghc.action.find.vim_options.IItemData
      local data = {
        name = name,
        scope = info.scope,
        type = info.type,
      ...
      ---@type ghc.action.find.vim_options.IItem
  ...
  render_item = function(item, match)
    local data = item.data ---@type ghc.action.find.vim_options.IItemData
