...
local config = {
  prettier_bin_path = dot.env.IS_WIN and era.path.normalize("node_modules/.bin/prettier.cmd")
...
local fns = {
  ...
  find_prettier_binpath = function(dirname)
    ...
    return binpath or era.lsp.locate_mason_bin_path("prettier") ---@type string
  end,
