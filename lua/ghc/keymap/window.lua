...
----- Resize window -----
vim.keymap.set("n", "<leader>wH", "<cmd>vertical resize -1<CR>", { noremap = true, silent = true, desc = "Window: Resize -3 vertically." })
vim.keymap.set("n", "<leader>wJ", "<cmd>resize -1<CR>", { noremap = true, silent = true, desc = "Window: Resize -3 horizontally." })
vim.keymap.set("n", "<leader>wK", "<cmd>resize +1<CR>", { noremap = true, silent = true, desc = "Window: Resize +3 horizontally." })
vim.keymap.set("n", "<leader>wL", "<cmd>vertical resize +1<CR>", { noremap = true, silent = true, desc = "Window: Resize +3 vertically." })
