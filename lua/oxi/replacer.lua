...
---@class oxi.replacer.replace_file_by_matches.IRawParams
...
---@class oxi.replacer.replace_file_advance_by_matches.IRawParams
---@field public filepath               string
---@field public flag_regex             boolean
---@field public search_pattern         string
---@field public replace_pattern        string
...
---@class oxi.replacer.replace_file_preview_advance_by_matches.IRawParams
---@field public filepath               string
---@field public search_pattern         string
---@field public replace_pattern        string
---@field public flag_regex             boolean
...
---@class oxi.replacer.replace_text_preview_by_matches.IRawParams
...
---@class oxi.replacer.replace_text_preview_advance_by_matches.IRawParams
---@field public text                   string
---@field public search_pattern         string
---@field public replace_pattern        string
---@field public flag_regex             boolean
...
---@class oxi.replacer.replace_file.IRawResult
---@field public success                boolean
---@field public error                  ?string

---@class oxi.replacer.replace_file_preview.IRawResult
---@field public text                   string

---@class oxi.replacer.replace_file_preview_advance.IRawResult
---@field public text                   string
---@field public matches                std.t.IMatchPoint[]

---@class oxi.replacer.replace_file_preview_advance_by_matches.IRawResult
---@field public text                   string
---@field public matches                std.t.IMatchPoint[]

---@class oxi.replacer.replace_text_preview.IRawResult
---@field public text                   string

---@class oxi.replacer.replace_text_preview_by_matches.IRawResult
---@field public text                   string

---@class oxi.replacer.replace_text_preview_advance.IRawResult
---@field public text                   string
---@field public matches                std.t.IMatchPoint[]

---@class oxi.replacer.replace_text_preview_advance_by_matches.IRawResult
---@field public text                   string
---@field public matches                std.t.IMatchPoint[]

---@class oxi.replacer.replace_file.IResult
---@field public success                boolean
---@field public error                  ?string

---@alias oxi.replacer.replace_file_by_matches.IResult
---| boolean

---@class oxi.replacer.replace_file_advance_by_matches.IResult
...
function M.replace_file_by_matches(params)
  ...
  ---@type oxi.replacer.replace_file_by_matches.IRawParams
  ...
  local nvim_tools = require("nvim_tools")
  local ok, data = oxi.fn.run_fun("replace_file_by_matches", nvim_tools.replace_file_by_matches, payload)
  ---@cast data                         oxi.replacer.replace_file_by_matches.IResult
...
function M.replace_file_advance_by_matches(params)
  ...
  ---@type oxi.replacer.replace_file_advance_by_matches.IRawParams
  local resolved_params = {
    filepath = filepath,
    search_pattern = search_pattern,
    replace_pattern = params.replace_pattern,
  ...
  local nvim_tools = require("nvim_tools")
  local ok, data =
    oxi.fn.run_fun("replace_file_advance_by_matches", nvim_tools.replace_file_advance_by_matches, payload)

  ---@cast data                         oxi.replacer.replace_file_advance_by_matches.IResult
...
function M.replace_file_preview_advance(params)
  ...
  if ok then
    ---@cast data                       oxi.replacer.replace_file_preview_advance.IRawResult
...
function M.replace_file_preview_advance_by_matches(params)
  ...
  ---@type oxi.replacer.replace_file_preview_advance_by_matches.IRawParams
  ...
  local nvim_tools = require("nvim_tools")
  local ok, data = oxi.fn.run_fun(
    "replace_file_preview_advance_by_matches",
    nvim_tools.replace_file_preview_advance_by_matches,
    payload
  )

  if ok then
    ---@cast data                       oxi.replacer.replace_file_preview_advance_by_matches.IRawResult
...
function M.replace_text_preview_by_matches(params)
  ...
  ---@type oxi.replacer.replace_text_preview_by_matches.IRawParams
  local payload_params = {
    text = params.text,
    search_pattern = search_pattern,
    replace_pattern = params.replace_pattern,
...
function M.replace_text_preview_advance(params)
  ...
  if ok then
    ---@cast data                       oxi.replacer.replace_text_preview_advance.IRawResult
...
function M.replace_text_preview_advance_by_matches(params)
  ...
  ---@type oxi.replacer.replace_text_preview_advance_by_matches.IRawParams
  local payload_params = {
    text = params.text,
    search_pattern = search_pattern,
    replace_pattern = params.replace_pattern,
  ...
  if ok then
    ---@cast data                       oxi.replacer.replace_text_preview_advance_by_matches.IRawResult
