...
---@class fml.ux.SimpleFileSelect : fml.ux.ISimpleFileSelect
---@field public get_file_select        fun(): fml.ux.IFileSelect
local M = {}
M.__index = M

---@class fml.ux.ISimpleFileSelect
---@field public change_dimension       fun(self: fml.ux.ISimpleFileSelect, dimension: fml.ux.search.IRawDimension): nil
---@field public change_input_title     fun(self: fml.ux.ISimpleFileSelect, title: string): nil
---@field public change_preview_title   fun(self: fml.ux.ISimpleFileSelect, title: string): nil
---@field public close                  fun(self: fml.ux.ISimpleFileSelect): nil
---@field public focus                  fun(self: fml.ux.ISimpleFileSelect): nil
---@field public get_file_select        fun(self: fml.ux.ISimpleFileSelect): fml.ux.IFileSelect
---@field public get_winnr_input        fun(self: fml.ux.ISimpleFileSelect): integer|nil
---@field public get_winnr_main         fun(self: fml.ux.ISimpleFileSelect): integer|nil
---@field public get_winnr_preview      fun(self: fml.ux.ISimpleFileSelect): integer|nil
---@field public mark_data_dirty        fun(self: fml.ux.ISimpleFileSelect): integer|nil
---@field public open                   fun(self: fml.ux.ISimpleFileSelect): nil

---@class fml.ux.simple_file_select.IData
---@field public cwd                    string
---@field public filepaths              string[]
---@field public present_filepath       ?string

---@class fml.ux.simple_file_select.IProvider
---@field public provide                fun(force: boolean): fml.ux.simple_file_select.IData
...
---@field public provider               fml.ux.simple_file_select.IProvider
...
function M.new(props)
  ...
  local simple_provider = props.provider ---@type fml.ux.simple_file_select.IProvider
  local title = props.title ---@type string

  local _file_select = nil ---@type fml.ux.IFileSelect|nil
    ...
    if _file_select == nil then
      ...
      local provider = {
        fetch_data = function(force)
          local raw_data = simple_provider.provide(force) ---@type fml.ux.simple_file_select.IData
...
function M:change_dimension(dimension)
  local file_select = self.get_file_select() ---@type fml.ux.IFileSelect
