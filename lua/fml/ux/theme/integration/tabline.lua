...
local function gen_hlgroup_map(context)
  ...
  ---@class fml.ux.theme.integration.tabline.hlgroups : table<string, eve.lib.collection.theme.IHlgroup>
  local hlgroup_map = {
    f_tl_bg = { fg = bg_tabline, bg = bg_tabline },
    f_tl_buf_item = { fg = c.bg4, bg = bg_buf_item },
    f_tl_buf_item_cur = { fg = c.bg4, bg = bg_buf_item_cur },
    f_tl_buf_indicator = { fg = c.blue, bg = bg_buf_item_cur, bold = true },
    ...
    f_tl_buf_ommitter = { fg = c.blue, bg = bg_tabline },
    f_tl_buf_ommitter_sep = { fg = c.bg4, bg = bg_tabline },
    f_tl_buf_sep = { fg = c.bg4, bg = bg_buf_item },
