...
---@class fml.dressing.select.IItem : era.m.picker.composer.list.IItem
---@field public data                   fml.dressing.select.IItemData

---@alias fml.dressing.select.IDataProvider
---| fun(items: any[], opts: fml.dressing.select.IOptions): era.m.picker.composer.list.IResetData, integer, era.m.picker.composer.list.IRenderResult|nil, era.m.picker.composer.list.IRenderPreview|nil
