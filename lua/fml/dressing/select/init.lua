...
---@class fml.dressing.select.IItem : era.picker.composer.list.IItem
---@field public data                   fml.dressing.select.IItemData

---@alias fml.dressing.select.IDataProvider
---| fun(items: any[], opts: fml.dressing.select.IOptions): era.picker.composer.list.IResetData, integer, era.picker.composer.list.IRenderResult|nil, era.picker.composer.list.IRenderPreview|nil
