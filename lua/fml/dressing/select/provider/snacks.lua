...
---@return integer
---@return era.picker.composer.list.IRenderResult|nil
---@return era.picker.composer.list.IRenderPreview|nil
local function snacks_provider(items, opts)
  ...
  for i = 1, #items do
    ...
    local text, highlights = generate_highlights(raw_text) ---@type string, stl.t.IHighlightInline[]
  ...
  local render_preview ---@type era.picker.composer.list.IRenderPreview|nil
