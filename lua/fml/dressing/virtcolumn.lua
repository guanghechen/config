...
local DISABLED_FILETYPES = {
  [std.filetype.BIGFILE] = true,
  [std.filetype.DAP_FLOAT] = true,
  [std.filetype.DAP_REPL] = true,
  [std.filetype.DAP_UI_BREAKPOINTS] = true,
  [std.filetype.DAP_UI_CONSOLE] = true,
  [std.filetype.DAP_UI_HOVER] = true,
  [std.filetype.DAP_UI_SCOPES] = true,
  [std.filetype.DAP_UI_STACKS] = true,
  [std.filetype.DAP_UI_WATCHES] = true,
  [std.filetype.DIFFVIEW_FILES] = true,
  [std.filetype.DIFFVIEW_FILE_HISTORY] = true,
  [std.filetype.FLASH_PROMPT] = true,
  [std.filetype.GITCOMMIT] = true,
  [std.filetype.IMAGE_VIEWER] = true,
  [std.filetype.LAZY] = true,
  [std.filetype.MASON] = true,
  [std.filetype.NEOTREE] = true,
  [std.filetype.NEOTREE_POPUP] = true,
  [std.filetype.NOTIFY] = true,
  [std.filetype.LSPINFO] = true,
  [std.filetype.PLENARY_TEST_POPUP] = true,
  [std.filetype.QUICKFIX] = true,
  [std.filetype.SELECT] = true,
  [std.filetype.STARTUPTIME] = true,
  [std.filetype.TERM] = true,
  [std.filetype.TERM_MASK] = true,
  [std.filetype.TEMP_VIEWER] = true,
  [std.filetype.UX_CMDLINE] = true,
  [std.filetype.UX_INPUT] = true,
  [std.filetype.UX_MESSAGE_HISTORY] = true,
  [std.filetype.UX_PICKER_FINDER] = true,
  [std.filetype.UX_PICKER_PREVIEW] = true,
  [std.filetype.UX_PICKER_RESULT] = false,
  [std.filetype.UX_POPUPMENU] = true,
  [std.filetype.UX_SEARCHER_FINDER] = true,
  [std.filetype.UX_SEARCHER_PREVIEW] = true,
  [std.filetype.UX_SEARCHER_RESULT] = false,
  [std.filetype.WINPICKER_MASK] = true,
  [std.filetype.WINSEP] = true,
}
