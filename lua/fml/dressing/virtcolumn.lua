...
local DISABLED_FILETYPES = {
  [ark.filetype.BIGFILE] = true,
  [ark.filetype.DAP_FLOAT] = true,
  [ark.filetype.DAP_REPL] = true,
  [ark.filetype.DAP_UI_BREAKPOINTS] = true,
  [ark.filetype.DAP_UI_CONSOLE] = true,
  [ark.filetype.DAP_UI_HOVER] = true,
  [ark.filetype.DAP_UI_SCOPES] = true,
  [ark.filetype.DAP_UI_STACKS] = true,
  [ark.filetype.DAP_UI_WATCHES] = true,
  [ark.filetype.DIFFVIEW_FILES] = true,
  [ark.filetype.DIFFVIEW_FILE_HISTORY] = true,
  [ark.filetype.EXPLORER] = true,
  [ark.filetype.FLASH_PROMPT] = true,
  [ark.filetype.GITCOMMIT] = true,
  [ark.filetype.IMAGE_VIEWER] = true,
  [ark.filetype.LAZY] = true,
  [ark.filetype.LSPINFO] = true,
  [ark.filetype.MASON] = true,
  [ark.filetype.NOTIFY] = true,
  [ark.filetype.QUICKFIX] = true,
  [ark.filetype.SELECT] = true,
  [ark.filetype.STARTUPTIME] = true,
  [ark.filetype.TERM] = true,
  [ark.filetype.TERM_MASK] = true,
  [ark.filetype.TEMP_VIEWER] = true,
  [ark.filetype.UX_CMDLINE] = true,
  [ark.filetype.UX_INPUT] = true,
  [ark.filetype.UX_MESSAGE_HISTORY] = true,
  [ark.filetype.UX_PICKER_FINDER] = true,
  [ark.filetype.UX_PICKER_PREVIEW] = true,
  [ark.filetype.UX_PICKER_RESULT] = false,
  [ark.filetype.UX_POPUPMENU] = true,
  [ark.filetype.UX_SEARCHER_FINDER] = true,
  [ark.filetype.UX_SEARCHER_PREVIEW] = true,
  [ark.filetype.UX_SEARCHER_RESULT] = false,
  [ark.filetype.WINPICKER_MASK] = true,
  [ark.filetype.WINSEP] = true,
}
...
vim.api.nvim_create_autocmd({
  ...
  group = ark.vim.fn.augroup("virtcolumn_refresh"),
  callback = function()
    refresh_debounced()
  end,
})
