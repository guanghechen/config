...
function M.attach_agent()
  require("era.m.ai.action").show_attach_picker()
end
...
function M.submit_buffer()
  ...
  require("era.m.ai.action").send_to_attached(text, true)
end
...
function M.send_buffer()
  ...
  require("era.m.ai.action").send_to_attached(text, false)
end
...
function M.send_file()
  ...
  if location then
    require("era.m.ai.action").send_to_attached(location, false)
  end
end

---@return nil
function M.select_prompt()
  require("era.m.ai.action").show_prompt_picker()
end
