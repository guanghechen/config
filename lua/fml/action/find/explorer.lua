...
---@class fml.action.find.explorer.IItem : dot.module.picker.composer.list.IItem
...
local state_cwd = ark.c.Observable.from_value(dot.path.cwd()) ---@type ark.c.Observable
...
---@param composer                      dot.module.picker.ListComposer
---@param bufnr                         integer
