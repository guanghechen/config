  ...
  if _select == nil then
    ...
    local provider = {
      ...
      fetch_preview_data = function(item)
        ...
        elseif fileitem.type == "directory" then
          ...
          for lnum, c_fileitem in ipairs(c_diritem.items) do
            ...
            local text_perm = eve.std.string.pad_start(c_fileitem.perm, c_diritem.perm_width, " ") .. sep_perm
            ...
            local text_size = eve.std.string.pad_start(c_fileitem.size, c_diritem.size_width, " ") .. sep_size
            ...
            if not eve.env.IS_WIN then
              ...
              local text_group = eve.std.string.pad_end(c_fileitem.group, c_diritem.group_width, " ") .. sep_group
            ...
            local text_date = eve.std.string.pad_end(c_fileitem.date, c_diritem.date_width, " ") .. sep_date
            ...
            local text_name = eve.std.string.pad_end(c_fileitem.name, c_diritem.name_width, " ") .. sep_name
      ...
      render_item = function(item, match)
        ...
        local text_icon = eve.std.string.pad_start(fileitem.icon, diritem.icon_width, " ") .. sep_icon ---@type string
        ...
        local text_name = eve.std.string.pad_end(filename, diritem.name_width + 1, " ") .. sep_name ---@type string
        local width_name = string.len(text_name) ---@type integer
        table.insert(highlights, {
          coll = width,
          colr = width + width_name,
        ...
        local sep_perm = string.rep(" ", 2) ---@type string
        local text_perm = eve.std.string.pad_start(fileitem.perm, diritem.perm_width, " ") .. sep_perm ---@type string
        local width_perm = string.len(text_perm) ---@type integer
        table.insert(highlights, {
          coll = width,
          colr = width + 1,
        ...
        local sep_size = string.rep(" ", 2) ---@type string
        local text_size = eve.std.string.pad_start(fileitem.size, diritem.size_width, " ") .. sep_size ---@type string
        local width_size = string.len(text_size) ---@type integer
        ...
        local sep_date = string.rep(" ", 2) ---@type string
        local text_date = eve.std.string.pad_end(fileitem.date, diritem.date_width, " ") .. sep_date ---@type string
        local width_date = string.len(text_date) ---@type integer
