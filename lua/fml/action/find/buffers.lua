...
local scopes = vim.list_slice(dot.context.select.find_buffer_scopes) ---@type era.e.FindBufferScope[]
...
local IGNORED_FILETYPES = {
  ...
  dot.filetype.UX_PICKER_PREVIEW,
  dot.filetype.UX_PICKER_RESULT,
  dot.filetype.UX_SEARCHER_FINDER,
  dot.filetype.UX_SEARCHER_PREVIEW,
  dot.filetype.UX_SEARCHER_RESULT,
  dot.filetype.WINSEP,
}
...
local function fetch_data()
  ...
  local scope = dot.context.select.find_buffer_scope:snapshot() ---@type era.e.FindBufferScope
