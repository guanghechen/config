...
local o_flag_case_sensitive = eve.context.select.find_file.flag_case_sensitive
...
picker = eve.ux.picker.FiletreeComposer.new({
  ...
  flags_append = {
    ...
    },
    {
      ...
      snapshot = function()
        local enabled = o_flag_textonly:snapshot() ---@type boolean
        return std.icon.symbols.flag_textonly, enabled and "picker_flag_blue" or "picker_flag_grey"
      end,
    },
  },
