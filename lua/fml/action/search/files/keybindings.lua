...
local statusline_items = {
  ...
  },
  {
    ...
    symbol = "",
    state = eve.context.select.search_file_scope,
  ...
  },
  {
    ...
    state = eve.context.select.search_file.flag_selected,
  ...
  },
  {
    ...
    state = eve.context.select.search_file.flag_exclude,
  ...
  },
  {
    ...
    state = eve.context.select.search_file.flag_gitignore,
  ...
  },
  {
    ...
    state = eve.context.select.search_file.flag_regex,
  ...
  },
  {
    ...
    state = eve.context.select.search_file.flag_case_sensitive,
  ...
  },
  {
    ...
    state = eve.context.search_file.flag_replace,
