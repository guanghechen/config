...
---@alias ux.treeview.ErrorCode "ProviderError"|"InvalidUpdate"|"MissingNode"|"Stale"|"Busy"|"Disposed"|"ResourceLimit"
...
---@field public list_text              ?"label"|"ancestry"
...
---@field public retry                  ?boolean Retry failed ordinary children slots during source preparation.
...
---@field public prepare_frame          ?fun(view: ux.treeview.View, frame: yoz.ux.treeview.Frame, first: integer, last: integer): stl.c.Future Resolves to a commit callback or false to retry; viewport is 0-based, half-open.
...
---@field public selection_purpose      ?string
...
---@class ux.treeview.IStateStatus
---@field public revisions              ux.treeview.IRevisions
---@field public locked                 boolean
---@field public selection_purpose      ?string
---@field public projection_error       ?ux.treeview.IError
