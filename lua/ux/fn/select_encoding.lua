---@class ux.fn.select_encoding.IItem : ux.picker.composer.list.IItem
---@field public data                   ux.fn.select_encoding.IItemData

---@class ux.fn.select_encoding.IItemData
---@field public title                  string
---@field public encoding               string

---@class ux.fn.select_encoding.IParams
---@field public present                string|nil
---@field public title                  string|nil
---@field public on_select              fun(encoding: string|nil): nil

---@class ux.fn.select_encoding.fileencodings
local fileencodings = {
...
local function fetch_data(present)
  local items = {} ---@type ux.fn.select_encoding.IItem[]
...
---@param params                        ux.fn.select_encoding.IParams
...
local function select_encoding(params)
  ...
  picker = ux.picker.ListComposer.new({
    ...
    on_confirm = function(composer, item)
      if item == nil then
        ...
        ---@cast item ux.fn.select_encoding.IItem
  ...
  local data = fetch_data(present) ---@type ux.picker.composer.list.IResetData
