...
function M.msg_changes(position)
  ...
  local component = {
    ...
    atomic = true,
    render = function()
      local text = dot.status.msg_changes:snapshot() ---@type string
      if text == "" then
        return "", "", true
      end
...
function M.msg_command(position)
  ...
  local component = {
    ...
    atomic = true,
    render = function()
      local text = dot.status.msg_command:snapshot() ---@type string
      if text == "" then
        return "", "", true
      end
...
function M.msg_lsp(position)
  ...
  local component = {
    ...
    atomic = true,
    render = function()
      local text = dot.status.msg_lsp:snapshot() ---@type string
      if text == "" then
        return "", "", true
      end
...
function M.msg_mode(position)
  ...
  local component = {
    ...
    atomic = true,
    render = function()
      local text = dot.status.msg_mode:snapshot() ---@type string
      if text == "" then
        return "", "", true
      end
