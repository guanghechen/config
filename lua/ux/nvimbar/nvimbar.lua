local __module_name__ = "ux.nvimbar" ---@type string

---@class ux.nvimbar.INvimbarPresetContext
---@field public winnr                  ?integer

---@alias ux.nvimbar.IGetNvimbarPresetContext
---| fun(): ux.nvimbar.INvimbarPresetContext|nil

---@class ux.nvimbar.INvimbarContext
---@field public winnr                  integer
...
---@field public mode                   dot.e.VimModeName
...
---@field public get_preset_context     ?ux.nvimbar.IGetNvimbarPresetContext
---@field public is_active              fun(context: ux.nvimbar.INvimbarContext): boolean
...
---@param preset_context                ux.nvimbar.INvimbarPresetContext
---@return ux.nvimbar.INvimbarContext|nil
local function build_context(preset_context)
  ...
  local mode, mode_name = dot.hlgroup.common.resolve_mode()
  ...
  ---@type ux.nvimbar.INvimbarContext
  local context = {
    winnr = winnr,
    bufnr = bufnr,
    cwd = cwd,
...
---@param props                         ux.nvimbar.INvimbarProps
...
function M.new(props)
  ...
  local value = std.Observable.from_value("") ---@type std.collection.IObservable

  ---@type ux.nvimbar.IGetNvimbarPresetContext
  local get_preset_context = props.get_preset_context
    or function()
      local winnr = vim.api.nvim_get_current_win() ---@type integer
      ---@type ux.nvimbar.INvimbarPresetContext
      return {
        winnr = winnr,
      }
    end

  local isactive = props.is_active ---@type fun(context: ux.nvimbar.INvimbarContext): boolean
...
function M:place(position, raw_component, priority)
  ...
  local components = self._components ---@type ux.nvimbar.IComponent[]
  local orders = self._orders ---@type integer[]
  local k = #components ---@type integer

  ---@type ux.nvimbar.IComponent
  local component = {
...
function M:__render__(force)
  local preset_context = self._get_preset_context() or {} ---@type ux.nvimbar.INvimbarPresetContext
  local context = build_context(preset_context) ---@type ux.nvimbar.INvimbarContext|nil
  if context == nil then
    return nil
  end
  ...
  for _, order in ipairs(orders) do
    hltexts[order] = ""
    local component = components[order] ---@type ux.nvimbar.IComponent
