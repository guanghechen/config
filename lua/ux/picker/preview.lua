...
local __module_name__ = "ux.picker.preview" ---@type string

---@alias ux.picker.preview.IDraw
---| fun(bufnr: integer, force: boolean): ux.picker.preview.IDrawResult

---@alias ux.picker.preview.IOnDrawed
---| fun(bufnr: integer): nil

---@class ux.picker.preview.IDrawResult
...
---@class ux.picker.preview.IWinOpts
...
---@class ux.picker.IPreviewProps
---@field public name                   string
---@field public draw                   ux.picker.preview.IDraw
---@field public keymaps                std.t.IKeymap[]
---@field public on_drawed              ?ux.picker.preview.IOnDrawed

---@class ux.picker.Preview
---@field public fullname               string
---@field public keymaps                std.t.IKeymap[]
---@field protected _disposed           boolean
---@field protected _bufnr              integer|nil
---@field protected _winnr              integer|nil
---@field protected _last_result        ux.picker.preview.IDrawResult|nil
---@field protected _scheduler_content  std.collection.Scheduler
local M = {}
M.__index = M

---@param props                         ux.picker.IPreviewProps
---@return ux.picker.Preview
function M.new(props)
  local name = props.name ---@type string
  local fullname = string.format("%s -> %s", name, __module_name__) ---@type string
  local draw = props.draw ---@type ux.picker.preview.IDraw
  local keymaps = props.keymaps ---@type std.t.IKeymap[]
  local on_drawed = props.on_drawed or std.fn.noop ---@type ux.picker.preview.IOnDrawed
  ...
  local scheduler_content = std.Scheduler.new({
    ...
    task = function()
      ...
      local ok, result = pcall(draw, bufnr, false) ---@type boolean, ux.picker.preview.IDrawResult
...
function M:create_buf()
  ...
  vim.bo[bufnr].filetype = std.filetype.UX_PICKER_PREVIEW
...
function M:create_win(winopts, dimension)
  ...
  local result = self._last_result ---@type ux.picker.preview.IDrawResult|nil
...
function M:__update_winopts__()
  local result = self._last_result ---@type ux.picker.preview.IDrawResult
  if result == nil then
    return self
  end
