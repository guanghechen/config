...
local __module_name__ = "ux.picker.result" ---@type string

---@alias ux.picker.result.IDraw
---| fun(bufnr: integer): ux.picker.result.IDrawResult

---@alias ux.picker.result.IIsSelected
---| fun(bufnr: integer, lnum: integer): boolean

---@alias ux.picker.result.IOnDrawed
---| fun(bufnr: integer): nil

---@class ux.picker.result.IDrawResult
---@field public lnum_current           integer|nil
---@field public lnum_present           integer|nil

---@class ux.picker.result.IFlagItemRaw
---@field public desc                   string
---@field public callback               fun(): nil
---@field public disabled               (fun(): boolean)|boolean|nil
---@field public snapshot               fun(): string, string

---@class ux.picker.result.IFlagItem
---@field public desc                   string
---@field public callback               string
---@field public disabled               fun(): boolean
---@field public snapshot               fun(): string, string

---@class ux.picker.result.IWinOpts
...
---@param props                         ux.picker.IResultProps
---@return ux.picker.Result
function M.new(props)
  ...
  if props.flags ~= nil and #props.flags > 0 then
    for _, flag in ipairs(props.flags) do
      ---@cast flag                     ux.picker.result.IFlagItemRaw
      ...
      ---@type ux.picker.result.IFlagItem
      local item = {
        desc = flag.desc,
  ...
  ---@type ux.nvimbar.Nvimbar
  local nvimbar = ux.nvimbar.Nvimbar
    .new({
  ...
  local scheduler_content = ark.c.Scheduler.new({
    ...
    task = function()
      ...
      local ok, result = pcall(draw, bufnr) ---@type boolean, ux.picker.result.IDrawResult
...
function M:dispose()
  ...
  local ok4, error4 = pcall(dot.win.close, winnr)
  local ok5, error5 = pcall(dot.buf.close, bufnr)
...
---@param winopts                       ux.picker.result.IWinOpts
...
function M:create_win(winopts, dimension)
  ...
  dot.win.set_type(winnr, dot.win.Types.PICKER_RESULT)
