...
local __module_name__ = "ux.picker.finder" ---@type string

---@class ux.picker.finder.IWinOpts
...
---@param props                         ux.picker.IFinderProps
...
---@param winopts                       ux.picker.finder.IWinOpts
