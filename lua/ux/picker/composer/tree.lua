...
local __module_name__ = "ux.picker.composer.tree" ---@type string

---@alias ux.picker.composer.tree.IOnAttached
---| fun(self: ux.picker.TreeComposer, rootuuid: string): nil

---@alias ux.picker.composer.tree.IOnClosed
---| fun(self: ux.picker.TreeComposer): nil

---@alias ux.picker.composer.tree.IOnConfirm
---| fun(self: ux.picker.TreeComposer, uuids: string[]|nil): nil

---@alias ux.picker.composer.tree.IOnDisposed
---| fun(): nil

---@alias ux.picker.composer.tree.IOnEnter
---| fun(self: ux.picker.TreeComposer, nodeuuid: string): boolean

---@alias ux.picker.composer.tree.IOnFocused
---| fun(self: ux.picker.TreeComposer): nil

---@alias ux.picker.composer.tree.IOnHidden
---| fun(self: ux.picker.TreeComposer): nil
---
---@alias ux.picker.composer.tree.IOnRefresh
---| fun(self: ux.picker.TreeComposer, force: boolean): nil

---@class ux.picker.composer.tree.actions
...
---@class ux.picker.ITreeComposerProps
...
---
---@field public on_attached            ?ux.picker.composer.tree.IOnAttached
---@field public on_closed              ?ux.picker.composer.tree.IOnClosed
---@field public on_confirm             ?ux.picker.composer.tree.IOnConfirm
---@field public on_disposed            ?ux.picker.composer.tree.IOnDisposed
---@field public on_enter               ?ux.picker.composer.tree.IOnEnter
---@field public on_focused             ?ux.picker.composer.tree.IOnFocused
---@field public on_hidden              ?ux.picker.composer.tree.IOnHidden
---@field public on_refresh             ?ux.picker.composer.tree.IOnRefresh

---@class ux.picker.TreeComposer
---@field public uuid                   string
...
---
---@field protected _on_attached        ux.picker.composer.tree.IOnAttached
...
---@param props                         ux.picker.ITreeComposerProps
---@return ux.picker.TreeComposer
function M.new(props)
  ...
  ---@type ux.picker.TreeView
  local treeview = ux.picker.TreeView.new({
    name = fullname,
    tree = tree,
  ...
  ---@type ux.picker.composer.tree.actions
  local actions = {
    attach_node = function()
      local nodeuuid = self:__retrieve_nodeuuid__() ---@type string|nil
      if nodeuuid ~= nil then
        local nodestate = treeview:retrieve(nodeuuid) ---@type ux.view.tree.INodeState|nil
    ...
    toggle_selection = function()
      ...
      for lnum = lnum_from, lnum_to, 1 do
        local nodeuuid = retriever:retrieve_uuid(lnum) ---@type string|nil
        if nodeuuid ~= nil then
          local childstate = treeview:retrieve(nodeuuid) ---@type ux.view.tree.INodeState|nil
...
function M:dispose()
  ...
  local on_dispose = self._on_disposed ---@type ux.picker.composer.tree.IOnDisposed
...
function M:__retrieve_lnum_parent__(nodeuuid)
  ...
  local nodestate = self._treeview:retrieve(nodeuuid) ---@type ux.view.tree.INodeState|nil
  if nodestate == nil then
    return nil
  end
