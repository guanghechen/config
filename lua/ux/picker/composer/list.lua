...
---| fun(self: ux.picker.ListComposer, bufnr: integer, itemmap: table<string, ux.picker.composer.list.IItem>, matches: dot.t.IScoredMatch[]): ux.picker.composer.list.IRenderResultData
