...
local __module_name__ = "ux.picker.composer.basic" ---@type string

---@alias ux.picker.composer.basic.PaneEnum
---| "finder"
---| "preview"
---| "result"

---@alias ux.picker.composer.basic.IOnCancel
---| fun(): nil

---@alias ux.picker.composer.basic.IOnClosed
---| fun(self: ux.picker.BasicComposer): nil

---@alias ux.picker.composer.basic.IOnDisposed
---| fun(): nil

---@alias ux.picker.composer.basic.IOnFocused
---| fun(self: ux.picker.BasicComposer): nil

---@alias ux.picker.composer.basic.IOnHidden
---| fun(self: ux.picker.BasicComposer): nil

---@alias ux.picker.composer.basic.IOnRefresh
---| fun(self: ux.picker.BasicComposer, force: boolean): nil

---@alias ux.picker.composer.basic.IOnResultRendered
---| fun(self: ux.picker.BasicComposer, bufnr: integer): nil

---@alias ux.picker.composer.basic.IOnPreviewRendered
---| fun(self: ux.picker.BasicComposer, bufnr: integer): nil

----------------------------------------------------------------------------------------------------

---@class ux.picker.composer.basic.borders
...
---@class ux.picker.composer.basic.highlights
---@field public finder                 string
---@field public result                 string
---@field public preview                string
...
---@class ux.picker.composer.IBasicProps
---@field public uuid                   ?string
---@field public name                   string
---@field public permanent              boolean
---
---@field public flags                  ?ux.picker.result.IFlagItemRaw[]
...
---@field public result_isselected      ?ux.picker.result.IIsSelected
---
---@field public render_preview         ?ux.picker.preview.IDraw
---@field public render_result          ux.picker.result.IDraw
---
---@field public on_cancel              ?ux.picker.composer.basic.IOnCancel
---@field public on_closed              ?ux.picker.composer.basic.IOnClosed
---@field public on_disposed            ?ux.picker.composer.basic.IOnDisposed
---@field public on_focused             ?ux.picker.composer.basic.IOnFocused
---@field public on_hidden              ?ux.picker.composer.basic.IOnHidden
---@field public on_refresh             ?ux.picker.composer.basic.IOnRefresh
---@field public on_preview_rendered    ?ux.picker.composer.basic.IOnPreviewRendered
---@field public on_result_rendered     ?ux.picker.composer.basic.IOnResultRendered

---@class ux.picker.BasicComposer : dot.t.IWidget
---@field public uuid                   string
...
---@field protected _pane_focused       ux.picker.composer.basic.PaneEnum
---@field protected _pane_last_focused  ux.picker.composer.basic.PaneEnum
...
---@field protected _on_disposed        ux.picker.composer.basic.IOnDisposed
---@field protected _on_focused         ux.picker.composer.basic.IOnFocused
---@field protected _on_hidden          ux.picker.composer.basic.IOnHidden
---@field protected _on_refresh         ux.picker.composer.basic.IOnRefresh
local M = {}
M.__index = M

---@param props                         ux.picker.composer.IBasicProps
---@return ux.picker.BasicComposer
function M.new(props)
  ...
  local flags = props.flags ---@type ux.picker.result.IFlagItemRaw[]
  local flags_start_index = props.flags_start_index == 0 and 0 or 1 ---@type 0|1
  local pane_focused = "finder" ---@type ux.picker.composer.basic.PaneEnum
  local pane_last_focused = "finder" ---@type ux.picker.composer.basic.PaneEnum
  ...
  local result_isselected = props.result_isselected ---@type ux.picker.result.IIsSelected|nil

  local render_preview = props.render_preview ---@type ux.picker.preview.IDraw|nil
  local render_result = props.render_result ---@type ux.picker.result.IDraw

  local on_cancel = props.on_cancel or ark.fn.noop ---@type ux.picker.composer.basic.IOnCancel
  local on_closed = props.on_closed or ark.fn.noop ---@type ux.picker.composer.basic.IOnClosed
  local on_disposed = props.on_disposed or ark.fn.noop ---@type ux.picker.composer.basic.IOnDisposed
  local on_focused = props.on_focused or ark.fn.noop ---@type ux.picker.composer.basic.IOnFocused
  local on_hidden = props.on_hidden or ark.fn.noop ---@type ux.picker.composer.basic.IOnHidden
  local on_refresh = props.on_refresh or ark.fn.noop ---@type ux.picker.composer.basic.IOnRefresh
  local on_preview_rendered = props.on_preview_rendered or ark.fn.noop ---@type ux.picker.composer.basic.IOnPreviewRendered
  local on_result_rendered = props.on_result_rendered or ark.fn.noop ---@type ux.picker.composer.basic.IOnResultRendered
  ...
  self._on_cancel = on_cancel ---@type ux.picker.composer.basic.IOnCancel
  self._on_closed = on_closed ---@type ux.picker.composer.basic.IOnClosed
  self._on_disposed = on_disposed ---@type ux.picker.composer.basic.IOnDisposed
  self._on_focused = on_focused ---@type ux.picker.composer.basic.IOnFocused
  self._on_hidden = on_hidden ---@type ux.picker.composer.basic.IOnHidden
  self._on_refresh = on_refresh ---@type ux.picker.composer.basic.IOnRefresh

  ---@type ux.picker.Finder
  local finder = ux.picker.Finder.new({
    name = name,
  ...
  ---@type ux.picker.Result
  local result = ux.picker.Result.new({
    uuid = uuid,
    name = name,
    draw = function(bufnr)
    ...
    ---@type ux.picker.result.IOnDrawed
  ...
  ---@type ux.picker.Preview|nil
  local preview = nil
  if render_preview ~= nil then
    preview = ux.picker.Preview.new({
      uuid = uuid,
      name = name,
      draw = render_preview,
      ...
      ---@type ux.picker.preview.IOnDrawed
      on_drawed = function(bufnr)
...
function M:dispose()
  ...
  local finder = self.finder ---@type ux.picker.Finder
  local result = self.result ---@type ux.picker.Result
  local preview = self.preview ---@type ux.picker.Preview|nil
  local on_disposed = self._on_disposed ---@type ux.picker.composer.basic.IOnDisposed
...
---@param pane                          ux.picker.composer.basic.PaneEnum|nil
---@return nil
function M:focus(pane)
  ...
  local pane_focused = self._pane_focused ---@type ux.picker.composer.basic.PaneEnum
...
function M:resize()
  ...
  if has_new_created then
    ...
    if not current_focused_valid then
      local pane_to_focus = self:__is_pane_valid__(self._pane_last_focused) and self._pane_last_focused or "finder" ---@type ux.picker.composer.basic.PaneEnum
...
function M:__create_wins__()
  ...
  ---@type ux.picker.result.IWinOpts
  ...
  if preview ~= nil and preview_dimension ~= nil and should_show_preview then
    ---@type ux.picker.preview.IWinOpts
...
---@protected
---@param pane_focused                  ux.picker.composer.basic.PaneEnum
---@return nil
...
---@param flags                         ux.picker.result.IFlagItemRaw[]
...
function M:__resolve_builtin_keymaps_finder__()
  ...
  local builtin_keymaps = {
    ...
    },
    {
      ...
      callback = function()
        if ark.env.IS_TMUX and not dot.state.status.tmux_zen_mode:snapshot() then
    ...
    },
    {
      ...
      callback = function()
        ...
        if preview_layout == "right" then
          local pane_focused = self._pane_last_focused == "result" and "result" or "finder" ---@type ux.picker.composer.basic.PaneEnum
