local __module_name__ = "ux.setting" ---@type string

---@class ux.ISetting
---@field public bufnr                  integer|nil
---@field public winnr                  integer|nil
---@field public open                   fun(self: ux.ISetting, params: ux.setting.IOpenParams): nil
...
---@class ux.Setting : ux.ISetting, ux.Textarea
local M = {}
M.__index = M
...
function M.new(props)
  ...
  local textarea = ux.Textarea.new({
    position = position,
    width = width,
    height = height,
    max_width = max_width,
