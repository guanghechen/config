local __module_name__ = "ux.retriever.list" ---@type string

---@class ux.retriever.IListRetrieverProps
---@field public name                   string

---@class ux.retriever.ListRetriever
...
---@param props                         ux.retriever.IListRetrieverProps
---@return ux.retriever.ListRetriever
