local __module_name__ = "ux.retriever.tree" ---@type string

---@class ux.retriever.ITreeRetrieverProps
---@field public name                   string

---@class ux.retriever.TreeRetriever
...
---@param props                         ux.retriever.ITreeRetrieverProps
---@return ux.retriever.TreeRetriever
