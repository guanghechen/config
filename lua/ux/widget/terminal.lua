...
---@class ux.widget.terminal.IToggleHardParams : dot.t.ITermCreateParams
...
local function __create_mask_buf_as_needed__()
  ...
  if bufnr == nil or not vim.api.nvim_buf_is_valid(bufnr) then
    ...
    vim.bo[bufnr].filetype = dot.filetype.TERM_MASK
...
local termline = ux.nvimbar.Nvimbar.new({
  name = "termline",
  comp_sep = "",
...
---@class ux.widget.terminal.IToggleAndFocusParams : dot.t.ITermCreateParams
---@field public selected_text          string|nil
---@field public autofocus              boolean|nil

---@param params                        ux.widget.terminal.IToggleAndFocusParams
---@return nil
