...
---@class ux.widget.notepad.IProps
...
---@param props                         ux.widget.notepad.IProps|nil
---@return ux.widget.Notepad
function M.new(props)
  ...
  local source = era.state.notepad.retrieve_source(source_name) ---@type era.t.INotepadSource
...
function M:__setup_nvimbar__()
  local widget = self
  self._nvimbar = ux.nvimbar.Nvimbar
    .new({
    ...
    :place("left", ux.nvimbar.component.notepad.items("f_wl", widget), 95)
    :place("left", ux.nvimbar.component.notepad.add_button("f_wl"), 100)
    :place("right", ux.nvimbar.component.notepad.source("f_wl", widget), 100)
end
