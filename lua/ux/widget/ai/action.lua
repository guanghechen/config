local __module_name__ = "ux.widget.ai.action" ---@type string
...
---@return ux.widget.ai.ISelectItem[]
...
---@param item                          ux.widget.ai.ISelectItem
---@return nil
...
function M.send_to_attached(text, submit)
  local picker = require("ux.widget.ai.picker")
...
---@param source                        ux.widget.ai.IAttachedSource
---@param text                          string
---@param submit                        boolean
---@return boolean
...
---@protected
---@param sources                       ux.widget.ai.IAttachedSource[]
---@param text                          string
---@param submit                        boolean
---@return nil
