local __module_name__ = "ux.widget.ai.tmux" ---@type string

local config = require("ux.widget.ai.config")
local proc = require("ux.widget.ai.proc")

---@class ux.widget.ai.tmux
local M = {}
...
---@param line                          string
---@return ux.widget.ai.ITmuxPaneInfo|nil
...
---@param tool_config                   ux.widget.ai.IToolConfig
---@param cwd                           string
---@return string
...
---@class ux.widget.ai.ITmuxCurrentInfo
---@field public session_name           string
---@field public window_name            string

---@return ux.widget.ai.ITmuxCurrentInfo|nil
...
---@return ux.widget.ai.ITmuxPaneInfo[]
function M.list_panes()
  ...
  local panes = {} ---@type ux.widget.ai.ITmuxPaneInfo[]
...
function M.find_running_agents()
  ...
  local sources = {} ---@type ux.widget.ai.ISource[]
