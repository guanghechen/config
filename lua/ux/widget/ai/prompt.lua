---@class ux.widget.ai.prompt.ICtx
...
---@param lines                         ux.widget.ai.IText
---@return string
...
---@param lines                         string[]
---@param hlname                        ?string
---@return ux.widget.ai.IText
local function plain_lines(lines, hlname)
  local result = {} ---@type ux.widget.ai.IText
  for _, line in ipairs(lines) do
...
local function get_highlighted_lines(bufnr, start_row, end_row)
  ...
  for i, line in ipairs(lines) do
    ...
    local text_line = {} ---@type ux.widget.ai.ITextLine
    local from = 0
...
---@return ux.widget.ai.prompt.ICtx
function M.get_ctx()
  ...
  local start_lnum, start_col, end_lnum, end_col = era.buf.retrieve_visual_range()
...
---@param ctx                           ux.widget.ai.prompt.ICtx
---@return ux.widget.ai.ITextLine|nil, string|nil
...
---@param ctx                           ux.widget.ai.prompt.ICtx
---@return ux.widget.ai.IText|nil, string|nil
...
local function get_diagnostics_lines(ctx)
  ...
  local lines = {} ---@type ux.widget.ai.IText
