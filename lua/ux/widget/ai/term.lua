local __module_name__ = "ux.widget.ai.term" ---@type string

---@class ux.widget.ai.term.IMeta
...
local _metamap = {} ---@type table<string, ux.widget.ai.term.IMeta>
local _winnr = nil ---@type integer|nil
local _current_uuid = nil ---@type string|nil

---@class ux.widget.ai.term
local M = {}
...
---@param uuid                          string
---@return ux.widget.ai.term.IMeta|nil
function M.get(uuid)
...
local function create_buf(termmeta)
  ...
  vim.bo[bufnr].filetype = std.filetype.AI_TERMINAL
...
---@class ux.widget.ai.term.IOpenParams
---@field public uuid                   string
---@field public agent                  ux.widget.ai.AgentName
---@field public cmd                    string[]|string
---@field public cwd                    string
...
---@param params                        ux.widget.ai.term.IOpenParams
---@return ux.widget.ai.term.IMeta
