---@class ux.widget.ai.config
local M = {}

---@type ux.widget.ai.AgentName[]
M.agents = { "claude", "codex", "copilot", "gemini" }

---@type table<ux.widget.ai.AgentName, string>
M.agent_labels = {
  claude = "claude",
  codex = "codex",
  copilot = "copilot",
...
---@type table<ux.widget.ai.AgentName, ux.widget.ai.IToolConfig>
M.tools = {
  claude = {
    cmd = "claude",
    args = function()
