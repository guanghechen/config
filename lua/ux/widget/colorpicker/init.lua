...
local Color = require("ux.widget.colorpicker.color")
local UI = require("ux.widget.colorpicker.ui")
local picker = require("ux.widget.colorpicker.picker")
...
---@field protected _saved_color        ux.widget.colorpicker.Color|nil
...
---@param props                         ux.widget.colorpicker.IProps|nil
---@return ux.widget.colorpicker.ColorPicker
...
---@protected
---@param source                        ux.widget.colorpicker.Color
---@return nil
...
function M:__create_win_as_needed__(bufnr)
  ...
  win_opts.zindex = era.win.resolve_zindex()
...
---@protected
---@param value                         integer
---@param point                         ux.widget.colorpicker.IPoint
---@return nil
