...
local mode = require("ux.widget.colorpicker.mode")
...
---@param name                          ux.widget.colorpicker.InputModeName|nil
---@return integer
...
---@param name                          ux.widget.colorpicker.OutputModeName|nil
---@return integer
...
---@class ux.widget.colorpicker.Color
...
---@return ux.widget.colorpicker.Color
function M.new()
...
function M:input()
  local name = eve.context.colorpicker.get_input_mode() ---@type ux.widget.colorpicker.InputModeName|nil
...
function M:output()
  local name = eve.context.colorpicker.get_output_mode() ---@type ux.widget.colorpicker.OutputModeName|nil
