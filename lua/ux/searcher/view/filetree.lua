...
---| fun(ctx: ux.searcher.view.filetree.IListviewRendererContext, node: std.collection.filetree.INode, nodestate: ux.searcher.view.filetree.IFileNodeState, lnum: integer): ux.view.tree.INodeRenderResult

---@alias ux.searcher.view.filetree.IListviewLocationRenderer
---| fun(ctx: ux.searcher.view.filetree.IListviewRendererContext, node: std.collection.filetree.INode, nodestate: ux.searcher.view.filetree.IFileNodeState, locationstate: ux.searcher.view.filetree.ILeafLocationState, lnum: integer): ux.view.tree.INodeRenderResult

---@alias ux.searcher.view.filetree.ITreeviewDirectoryRenderer
---| fun(ctx: ux.searcher.view.filetree.ITreeviewRendererContext, node: std.collection.filetree.INode, nodestate: ux.searcher.view.filetree.IDirectoryNodeState, lnum: integer, folded_depth: integer): ux.view.tree.INodeRenderResult

---@alias ux.searcher.view.filetree.ITreeviewFileRenderer
---| fun(ctx: ux.searcher.view.filetree.ITreeviewRendererContext, node: std.collection.filetree.INode, nodestate: ux.searcher.view.filetree.IFileNodeState, lnum: integer): ux.view.tree.INodeRenderResult

---@alias ux.searcher.view.filetree.ITreeviewLocationRenderer
---| fun(ctx: ux.searcher.view.filetree.ITreeviewRendererContext, node: std.collection.filetree.INode, nodestate: ux.searcher.view.filetree.IFileNodeState, locationstate: ux.searcher.view.filetree.ILeafLocationState, lnum: integer): ux.view.tree.INodeRenderResult
...
local function decode_preview_text(text)
  return text:gsub(std.icon.listchars.eol, "\n")
end
