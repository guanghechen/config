...
local __module_name__ = "ux.searcher.preview" ---@type string

---@alias ux.searcher.preview.IDraw
---| fun(bufnr: integer, force: boolean): ux.searcher.preview.IDrawResult

---@alias ux.searcher.preview.IOnDrawed
---| fun(bufnr: integer): nil

---@class ux.searcher.preview.IDrawResult
...
---@class ux.searcher.preview.IWinOpts
...
---@class ux.searcher.IPreviewProps
---@field public name                   string
---@field public draw                   ux.searcher.preview.IDraw
---@field public keymaps                std.t.IKeymap[]
---@field public on_drawed              ?ux.searcher.preview.IOnDrawed

---@class ux.searcher.Preview
---@field public fullname               string
---@field public keymaps                std.t.IKeymap[]
---@field protected _disposed           boolean
---@field protected _bufnr              integer|nil
---@field protected _winnr              integer|nil
---@field protected _last_result        ux.searcher.preview.IDrawResult|nil
---@field protected _scheduler_content  std.collection.Scheduler
local M = {}
M.__index = M

---@param props                         ux.searcher.IPreviewProps
---@return ux.searcher.Preview
function M.new(props)
  ...
  local scheduler_content = std.Scheduler.new({
    ...
    task = function()
      ...
      local ok, result = pcall(draw, bufnr, false) ---@type boolean, ux.searcher.preview.IDrawResult
...
---@param winopts                       ux.searcher.preview.IWinOpts
...
function M:create_win(winopts, dimension)
  ...
  local result = self._last_result ---@type ux.searcher.preview.IDrawResult|nil
...
function M:__update_winopts__()
  local result = self._last_result ---@type ux.searcher.preview.IDrawResult
  if result == nil then
    return self
  end
