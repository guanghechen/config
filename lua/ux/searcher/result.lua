...
local __module_name__ = "ux.searcher.result" ---@type string

---@alias ux.searcher.result.IDraw
---| fun(bufnr: integer): ux.searcher.result.IDrawResult

---@alias ux.searcher.result.IIsSelected
---| fun(bufnr: integer, lnum: integer): boolean

---@alias ux.searcher.result.IOnDrawed
---| fun(bufnr: integer): nil

---@class ux.searcher.result.IDrawResult
---@field public lnum_current           integer|nil
---@field public lnum_present           integer|nil

---@class ux.searcher.result.IFlagItemRaw
---@field public desc                   string
---@field public callback               fun(): nil
---@field public disabled               (fun(): boolean)|boolean|nil
---@field public snapshot               fun(): string, string

---@class ux.searcher.result.IFlagItem
---@field public desc                   string
---@field public callback               string
---@field public disabled               fun(): boolean
---@field public snapshot               fun(): string, string

---@class ux.searcher.result.IWinOpts
...
---@class ux.searcher.IResultProps
...
---@param props                         ux.searcher.IResultProps
...
function M.new(props)
  ...
  if props.flags ~= nil and #props.flags > 0 then
    for _, flag in ipairs(props.flags) do
      ---@cast flag                     ux.searcher.result.IFlagItemRaw
  ...
  local scheduler_content = ark.c.Scheduler.new({
    ...
    task = function()
      ...
      local ok, result = pcall(draw, bufnr) ---@type boolean, ux.searcher.result.IDrawResult
