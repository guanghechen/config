...
local __module_name__ = "ux.searcher.composer.basic" ---@type string

---@alias ux.searcher.composer.basic.PaneEnum
---| "finder"
---| "replacer"
---| "preview"
---| "result"

---@alias ux.searcher.composer.basic.IOnCancel
---| fun(): nil

---@alias ux.searcher.composer.basic.IOnClosed
---| fun(self: ux.searcher.BasicComposer): nil

---@alias ux.searcher.composer.basic.IOnDisposed
---| fun(): nil

---@alias ux.searcher.composer.basic.IOnFocused
---| fun(self: ux.searcher.BasicComposer): nil

---@alias ux.searcher.composer.basic.IOnHidden
---| fun(self: ux.searcher.BasicComposer): nil

---@alias ux.searcher.composer.basic.IOnRefresh
---| fun(self: ux.searcher.BasicComposer, force: boolean): nil

---@alias ux.searcher.composer.basic.IOnResultRendered
---| fun(self: ux.searcher.BasicComposer, bufnr: integer): nil

---@alias ux.searcher.composer.basic.IOnPreviewRendered
---| fun(self: ux.searcher.BasicComposer, bufnr: integer): nil

----------------------------------------------------------------------------------------------------

---@class ux.searcher.composer.basic.borders
...
---@class ux.searcher.composer.basic.highlights
---@field public finder                 string
---@field public replacer               string
---@field public result                 string
---@field public preview                string
...
---@class ux.searcher.composer.IBasicProps
...
---
---@field public render_preview         ?ux.searcher.preview.IDraw
---@field public render_result          ux.searcher.result.IDraw
---
---@field public on_cancel              ?ux.searcher.composer.basic.IOnCancel
---@field public on_closed              ?ux.searcher.composer.basic.IOnClosed
---@field public on_disposed            ?ux.searcher.composer.basic.IOnDisposed
---@field public on_focused             ?ux.searcher.composer.basic.IOnFocused
---@field public on_hidden              ?ux.searcher.composer.basic.IOnHidden
---@field public on_refresh             ?ux.searcher.composer.basic.IOnRefresh
...
---@field public replacer               ux.searcher.Finder|nil
---@field public result                 ux.searcher.Result
---@field public preview                ux.searcher.Preview|nil
---
---@field protected _result_number      boolean
---
---@field protected _disposed           boolean
---@field protected _pane_focused       ux.searcher.composer.basic.PaneEnum
---@field protected _pane_last_focused  ux.searcher.composer.basic.PaneEnum
...
---@field protected _on_disposed        ux.searcher.composer.basic.IOnDisposed
---@field protected _on_focused         ux.searcher.composer.basic.IOnFocused
---@field protected _on_hidden          ux.searcher.composer.basic.IOnHidden
---@field protected _on_refresh         ux.searcher.composer.basic.IOnRefresh
local M = {}
M.__index = M

---@param props                         ux.searcher.composer.IBasicProps
---@return ux.searcher.BasicComposer
function M.new(props)
  ...
  local flags = props.flags ---@type ux.searcher.result.IFlagItemRaw[]
  local flags_start_index = props.flags_start_index == 0 and 0 or 1 ---@type 0|1
  local pane_focused = "finder" ---@type ux.searcher.composer.basic.PaneEnum
  local pane_last_focused = "finder" ---@type ux.searcher.composer.basic.PaneEnum
  ...
  self._on_cancel = on_cancel ---@type ux.searcher.composer.basic.IOnCancel
  self._on_closed = on_closed ---@type ux.searcher.composer.basic.IOnClosed
  self._on_disposed = on_disposed ---@type ux.searcher.composer.basic.IOnDisposed
  self._on_focused = on_focused ---@type ux.searcher.composer.basic.IOnFocused
  self._on_hidden = on_hidden ---@type ux.searcher.composer.basic.IOnHidden
  self._on_refresh = on_refresh ---@type ux.searcher.composer.basic.IOnRefresh

  ---@type ux.searcher.Finder
  local finder = ux.searcher.Finder.new({
    name = name,
  ...
  ---@type ux.searcher.Finder|nil
  local replacer = nil
  if replace_pattern ~= nil then
    replacer = ux.searcher.Finder.new({
      name = name .. " (replacer)",
      ...
      prompt_sign = dot.icon.symbols.flag_replace,
      prompt_sign_hl = "f_pk_replacer_prompt",
    })
  end

  ---@type ux.searcher.Result
  local result = ux.searcher.Result.new({
    uuid = uuid,
    name = name,
    draw = function(bufnr)
    ...
    ---@type ux.searcher.result.IOnDrawed
  ...
  ---@type ux.searcher.Preview|nil
  local preview = nil
  if render_preview ~= nil then
    preview = ux.searcher.Preview.new({
      uuid = uuid,
      name = name,
      draw = render_preview,
      ...
      ---@type ux.searcher.preview.IOnDrawed
      on_drawed = function(bufnr)
...
function M:dispose()
  ...
  local finder = self.finder ---@type ux.searcher.Finder
  local replacer = self.replacer ---@type ux.searcher.Finder|nil
...
---@param pane                          ux.searcher.composer.basic.PaneEnum|nil
---@return nil
...
function M:resize()
  ...
  if has_new_created then
    ...
    if not current_focused_exists then
      ...
      local pane_to_focus = "finder" ---@type ux.searcher.composer.basic.PaneEnum
...
function M:__create_wins__()
  ...
  ---@type ux.searcher.result.IWinOpts
  ...
  if preview ~= nil and preview_dimension ~= nil and should_show_preview then
    ---@type ux.searcher.preview.IWinOpts
...
---@protected
---@param pane_focused                  ux.searcher.composer.basic.PaneEnum
---@return nil
    ...
    },
    {
      ...
      callback = function()
        ...
        if preview_layout == "right" then
          local pane_focused = self._pane_last_focused == "result" and "result" or "finder" ---@type ux.searcher.composer.basic.PaneEnum
