...
local __module_name__ = "ux.searcher.composer.filetree" ---@type string

---@alias ux.searcher.composer.filetree.IOnAttached
---| fun(self: ux.searcher.FiletreeComposer, rootpath: string): nil

---@alias ux.searcher.composer.filetree.IOnClosed
---| fun(self: ux.searcher.FiletreeComposer): nil

---@alias ux.searcher.composer.filetree.IOnConfirm
---| fun(self: ux.searcher.FiletreeComposer, selected_filepaths: string[]|nil): nil

---@alias ux.searcher.composer.filetree.IOnDisposed
---| fun(): nil

---@alias ux.searcher.composer.filetree.IOnFocused
---| fun(self: ux.searcher.FiletreeComposer): nil

---@alias ux.searcher.composer.filetree.IOnHidden
---| fun(self: ux.searcher.FiletreeComposer): nil
---
---@alias ux.searcher.composer.filetree.IOnRefresh
---| fun(self: ux.searcher.FiletreeComposer, force: boolean): nil

---@class ux.searcher.composer.filetree.actions
...
---@class ux.searcher.IFiletreeComposerProps
...
---@field public on_confirm             ?ux.searcher.composer.filetree.IOnConfirm
---@field public on_disposed            ?ux.searcher.composer.filetree.IOnDisposed
---@field public on_focused             ?ux.searcher.composer.filetree.IOnFocused
---@field public on_hidden              ?ux.searcher.composer.filetree.IOnHidden
---@field public on_refresh             ?ux.searcher.composer.filetree.IOnRefresh

---@class ux.searcher.FiletreeComposer
---@field public uuid                   string
...
---@field protected _filetree           era.Filetree
...
---
---@field protected _on_attached        ux.searcher.composer.filetree.IOnAttached
---@field protected _on_confirm         ux.searcher.composer.filetree.IOnConfirm|nil
---@field protected _on_disposed        ux.searcher.composer.filetree.IOnDisposed
---@field protected _observer_unsubs    ark.c.IUnsubscribable[]|nil
local M = {}
M.__index = M

---@param props                         ux.searcher.IFiletreeComposerProps
---@return ux.searcher.FiletreeComposer
function M.new(props)
  ...
  ---@type era.Filetree
  local filetree = era.Filetree.new({ name = fullname })

  ---@type ux.searcher.FiletreeView
  local treeview = ux.searcher.FiletreeView.new({
    name = fullname,
    tree = filetree,
  ...
  ---@type ux.searcher.composer.filetree.IOnRefresh
  ...
  ---@param node                        era.t.IFiletreeNode|nil
  ...
  ---@type ux.searcher.PlainfileView
  local plainfile = ux.searcher.PlainfileView.new({
    name = fullname,
  })
  ...
  local flags = {} ---@type ux.searcher.result.IFlagItemRaw[]
  do
  ...
  ---@type ux.searcher.composer.filetree.actions
  local actions = {
    ...
    attach_node = function()
      ...
      local leafnode = filetree:retrieve(leafuuid) ---@type era.t.IFiletreeNode|nil
    ...
    copy_node_filepath = function()
      local filenode = self:__retrieve_filenode__() ---@type era.t.IFiletreeNode|nil
    ...
    replace_all = function()
      ...
      local rootnode = rootuuid ~= nil and filetree:retrieve(rootuuid) or nil ---@type era.t.IFiletreeNode|nil
      ...
      for lnum = 1, lnum_total, 1 do
        ...
        if leafuuid ~= nil then
          local leafnode = filetree:retrieve(leafuuid) ---@type era.t.IFiletreeNode|nil
          local leafnodestate = treeview:retrieve(leafuuid) ---@type ux.searcher.view.filetree.INodeState|nil
          if leafnode ~= nil and leafnodestate ~= nil and leafnodestate.nodetype == "leaf" then
            ---@cast leafnode         era.t.IFiletreeNode
            ---@cast leafnodestate    ux.searcher.view.filetree.IFileNodeState
    ...
    replace_in_node = function()
      ...
      if nodestate.nodetype == "location" then
        ...
        local leafnode = filetree:retrieve(nodestate.leafuuid) ---@type era.t.IFiletreeNode|nil
        if leafnode == nil then
          ark.reporter.error({
            from = self.fullname,
        ...
        for i = st + 1, L, 1 do
          local location = locations[i] ---@type ux.searcher.view.filetree.ILeafLocationState
        ...
        local preview_locations = advance_result.locations ---@type era.t.IMatchLocation[]
        ...
        for i = st + 1, L, 1 do
          ...
          if treeview:isvisible(location.locationuuid) then
            ...
            local pl = preview_locations[nt] ---@type era.t.IMatchLocation
      ...
      local node = filetree:retrieve(nodeuuid) ---@type era.t.IFiletreeNode|nil
      if node == nil then
        ark.reporter.error({
          from = self.fullname,
          subject = "replace_in_node",
      ...
      if nodestate.nodetype == "leaf" then
        ---@cast nodestate              ux.searcher.view.filetree.IFileNodeState
    ...
    toggle_selection = function()
      ...
      for lnum = lnum_from, lnum_to, 1 do
        local nodeuuid = retriever:retrieve_uuid(lnum) ---@type string|nil
        if nodeuuid ~= nil then
          local childstate = treeview:retrieve(nodeuuid) ---@type ux.searcher.view.filetree.INodeState|nil
  ...
  local composer = ux.searcher.BasicComposer.new({
    uuid = searcher_uuid,
    name = fullname,
    permanent = permanent,
    ...
    render_result = function(bufnr)
      ...
      local ret = { lnum_current = lnum_current } ---@type ux.searcher.result.IDrawResult
      return ret
    end,

    ---@type ux.searcher.preview.IDraw|nil
    render_preview = preview
        and function(bufnr)
          ...
          if nodeuuid == nil then
            ...
            ---@type ux.searcher.preview.IDrawResult
            local result = {
              cursorline = true,
              number = true,
          ...
          if nodestate.nodetype == "container" then
            ...
            ---@cast nodestate          ux.searcher.view.filetree.IDirectoryNodeState
            ---@type ux.searcher.preview.IDrawResult
            local result = {
              cursorline = true,
              number = true,
          ...
          ---@cast nodestate            ux.searcher.view.filetree.IFileNodeState|ux.searcher.view.filetree.ILeafLocationState

          local leafnode = nodestate.nodetype == "location" and treeview:retrieve(nodestate.leafuuid) or nodestate
          ---@cast leafnode             ux.searcher.view.filetree.IFileNodeState

          local locations = leafnode and leafnode.locations or nil ---@type ux.searcher.view.filetree.ILeafLocationState[]|nil
          ...
          local location_current ---@type ux.searcher.view.filetree.ILeafLocationState
          if nodestate.nodetype == "location" then
            ---@cast nodestate          ux.searcher.view.filetree.ILeafLocationState
            location_current = nodestate
          else
            if locations ~= nil and #locations > 0 then
              location_current = locations[1] ---@type ux.searcher.view.filetree.ILeafLocationState
            end
          end

          ---@type ux.searcher.IPlainfileViewContext
...
function M:dispose()
  ...
  local on_dispose = self._on_disposed ---@type ux.searcher.composer.filetree.IOnDisposed
...
function M:attach(rootuuid)
  ...
  local node = self._filetree:retrieve(rootuuid) ---@type era.t.IFiletreeNode|nil
  if node == nil then
    ark.reporter.error({
  ...
  local filetree = self._filetree ---@type era.Filetree
  local treeview = self._treeview ---@type ux.searcher.FiletreeView
...
function M:reset_filepaths(rootpath, cwd, filepaths)
  ...
  local uuid_cwd = era.Filetree.uuid(cwd) ---@type string
...
---@param leafnodestate                 ux.searcher.view.filetree.IFileNodeState
---@return integer[]
...
function M:__search_internal__()
  ...
  ---@type ux.searcher.view.filetree.ISearchResult|nil
  ...
  local items = result.items ---@type ux.searcher.view.filetree.ISearchedItem[]
  local filematch_map = result.filematch_map ---@type table<string, ux.searcher.view.filetree.IResolvedFileMatch>
  ...
  do
    ...
    while i <= N do
      local item = items[i] ---@type ux.searcher.view.filetree.ISearchedItem
  ...
  local statemap = treeview.statemap ---@type table<string, ux.searcher.view.filetree.INodeState>
  ...
  do
    ...
    while i <= N do
      ...
      if leafnode == nil then
        ...
        local locations = leafnode.locations or {} ---@type ux.searcher.view.filetree.ILeafLocationState[]
        for k = i, j - 1, 1 do
          local item = items[k] ---@type ux.searcher.view.filetree.ISearchedItem

          ---@type ux.searcher.view.filetree.ILeafLocationState
          local location = {
            nodetype = "location",
            leafuuid = nodeuuid,
...
function M:__open_node__(nodeuuid)
  ...
  if self:__has_selected_node__() then
    local linecount = retriever:linecount() ---@type integer
    local last_nodestate = nil ---@type ux.searcher.view.filetree.IFileNodeState|nil
    local filepaths = {} ---@type string[]
    ...
    for lnum = 1, linecount, 1 do
      ...
      if uuid ~= nil then
        local isselected = treeview:isselected(uuid) ---@type boolean
        if isselected then
          local o = filetree:retrieve(uuid) ---@type era.t.IFiletreeNode|nil
          treeview:set_selected(uuid, false)
          if o ~= nil and o.data.filetype == "file" then
            filepaths[#filepaths + 1] = o.data.filepath

            local s = treeview:retrieve(nodeuuid) ---@type ux.searcher.view.filetree.INodeState|nil
            if s ~= nil then
              ---@cast s                      ux.searcher.view.filetree.IFileNodeState
              last_nodestate = s
            end
          end
        end
    ...
    if #filepaths > 0 then
      ---@cast last_nodestate             ux.searcher.view.filetree.IFileNodeState
      local locations = last_nodestate.locations
      local first_location = locations ~= nil and locations[1] or nil ---@type ux.searcher.view.filetree.ILeafLocationState|nil
...
---@param nodestate                     ux.searcher.view.filetree.IFileNodeState
---@return boolean
function M:__replace_file__(cwd, node, nodestate)
  local locations = nodestate.locations ---@type ux.searcher.view.filetree.ILeafLocationState[]|nil
  if locations == nil then
    return false
  end
  ...
  if succeed == true then
    ...
    for i = 1, L, 1 do
      ...
      if treeview:isvisible(location.locationuuid) then
        ...
        k = k + 1 ---@type integer
        locations[k] = location ---@type ux.searcher.view.filetree.ILeafLocationState
      end
    end
...
---@return ux.searcher.view.filetree.INodeState
function M:__retrieve__(nodeuuid)
  ---@type ux.searcher.view.filetree.INodeState|nil
...
function M:__retrieve_filenode__()
  ...
  local nodestate = self._treeview:retrieve(nodeuuid) ---@type ux.searcher.view.filetree.INodeState|nil
  if nodestate == nil then
    return
  end

  local fileuuid = nodestate.nodetype == "location" and nodestate.leafuuid or nodeuuid ---@type string
  local node = fileuuid ~= nil and self._filetree:retrieve(fileuuid) or nil ---@type era.t.IFiletreeNode|nil
  return node
end
...
function M:__retrieve_rootnode__()
  local rootuuid = self._uuid_root ---@type string
  local rootnode = self._filetree:retrieve(rootuuid) ---@type era.t.IFiletreeNode|nil
  return rootnode
end
