local __module_name__ = "ux.view.plainfile" ---@type string

---@class ux.view.plainfile.IData
---@field public filepath               string
---@field public filetype               string
---@field public lines                  string[]

---@class ux.view.IPlainfileProps
---@field public name                   string
---@field public nsnr                   ?integer

---@class ux.view.Plainfile
---@field public fullname               string
---@field public nsnr                   integer
---@field protected _disposed           boolean
---@field protected _last_bufnr         integer|nil
---@field protected _last_data          ux.view.plainfile.IData|nil
local M = {}
M.__index = M
