local __module_name__ = "ux.textarea" ---@type string
...
---@field public open                   fun(self: ux.ITextarea, params: ux.textarea.IOpenParams): nil
---@field public close                  fun(self: ux.ITextarea): nil

---@class ux.textarea.IOpenParams
...
---@param props                         ux.textarea.IProps
---@return ux.Textarea
...
function M:open(params)
  ...
  local height = ark.box.flat(params.height or self.height, restriction.rows) ---@type integer
  local rect = ark.box.measure(width, height, restriction) ---@type ark.box.IDimension
  ...
  if self._bufnr == nil or not vim.api.nvim_buf_is_valid(self._bufnr) then
    ...
    ark.nvim.bindkeys(self.keymaps, { bufnr = bufnr, noremap = true, silent = true })
