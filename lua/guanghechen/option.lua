...
vim.opt.foldexpr = "v:lua.require'guanghechen.core.action.fold'.foldexpr()"
...
vim.opt.statuscolumn = [[%!v:lua.require'guanghechen.core.action.ui_statuscolumn'.statuscolumn()]]
