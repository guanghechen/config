---@class guanghechen.command.find.vim_options.IItemData
...
---@class guanghechen.command.find.vim_options.IItem : t.fml.ux.select.IItem
---@field public data                   guanghechen.command.find.vim_options.IItemData
...
local provider = {
  fetch_data = function()
    ...
    for name, info in pairs(vim.api.nvim_get_all_options_info()) do
      ...
      ---@type guanghechen.command.find.vim_options.IItemData
      local data = {
        name = name,
        scope = info.scope,
        type = info.type,
      ...
      ---@type guanghechen.command.find.vim_options.IItem
  ...
  render_item = function(item, match)
    local data = item.data ---@type guanghechen.command.find.vim_options.IItemData
