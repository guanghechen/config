...
--[#]buffer-----------------------------------------------------------------------------------------
mk({ "n", "v" }, "<leader>b1", A.buffer.goto_buf1, "buffer: open buffer 1", true)
mk({ "n", "v" }, "<leader>b2", A.buffer.goto_buf2, "buffer: open buffer 2", true)
mk({ "n", "v" }, "<leader>b3", A.buffer.goto_buf3, "buffer: open buffer 3", true)
mk({ "n", "v" }, "<leader>b4", A.buffer.goto_buf4, "buffer: open buffer 4", true)
mk({ "n", "v" }, "<leader>b5", A.buffer.goto_buf5, "buffer: open buffer 5", true)
mk({ "n", "v" }, "<leader>b6", A.buffer.goto_buf6, "buffer: open buffer 6", true)
mk({ "n", "v" }, "<leader>b7", A.buffer.goto_buf7, "buffer: open buffer 7", true)
mk({ "n", "v" }, "<leader>b8", A.buffer.goto_buf8, "buffer: open buffer 8", true)
mk({ "n", "v" }, "<leader>b9", A.buffer.goto_buf9, "buffer: open buffer 9", true)
mk({ "n", "v" }, "<leader>b0", A.buffer.goto_buf10, "buffer: open buffer 10", true)
