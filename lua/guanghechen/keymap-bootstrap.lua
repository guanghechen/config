...
----- window -----
mk({ "i", "n", "v" }, "<C-a>h", fml.api.win.focus_left, "win: focus left", true, true)
mk({ "i", "n", "v" }, "<C-a>j", fml.api.win.focus_bottom, "win: focus bottom", true, true)
mk({ "i", "n", "v" }, "<C-a>k", fml.api.win.focus_top, "win: focus top", true, true)
mk({ "i", "n", "v" }, "<C-a>l", fml.api.win.focus_right, "win: focus right", true, true)
mk({ "i", "n", "v" }, "<M-h>", fml.api.win.focus_left, "win: focus left", true, true)
mk({ "i", "n", "v" }, "<M-j>", fml.api.win.focus_bottom, "win: focus bottom", true, true)
mk({ "i", "n", "v" }, "<M-k>", fml.api.win.focus_top, "win: focus top", true, true)
mk({ "i", "n", "v" }, "<M-l>", fml.api.win.focus_right, "win: focus right", true, true)
