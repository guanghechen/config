...
function M.renderer()
  ...
  local text_error = (count_error and count_error > 0) and (fml.ui.icons.diagnostics.Error .. " " .. count_error .. " ") or ""
  local text_warn = (count_warn and count_warn > 0) and (fml.ui.icons.diagnostics.Warning .. " " .. count_warn .. " ") or ""
  local text_hint = (count_hint and count_hint > 0) and (fml.ui.icons.diagnostics.Hint .. " " .. count_hint .. " ") or ""
  local text_info = (count_info and count_info > 0) and (fml.ui.icons.diagnostics.Information .. " " .. count_info .. " ") or ""
