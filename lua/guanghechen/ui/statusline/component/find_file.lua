...
function M.renderer()
  ...
  local enable_regex = ghc.context.replace.flag_regex:get_snapshot() ---@type boolean
  local enable_case_sensitive = ghc.context.replace.flag_case_sensitive:get_snapshot() ---@type boolean
